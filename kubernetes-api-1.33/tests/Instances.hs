...
genV1ResourceClaim n =
  V1ResourceClaim
    ...
    <*> arbitraryReducedMaybe n -- v1ResourceClaimRequest :: Maybe Text
...
instance Arbitrary V1alpha3AllocatedDeviceStatus where
  arbitrary = sized genV1alpha3AllocatedDeviceStatus

genV1alpha3AllocatedDeviceStatus :: Int -> Gen V1alpha3AllocatedDeviceStatus
genV1alpha3AllocatedDeviceStatus n =
  V1alpha3AllocatedDeviceStatus
    <$> arbitraryReducedMaybe n -- v1alpha3AllocatedDeviceStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybeValue n -- v1alpha3AllocatedDeviceStatusData :: Maybe A.Value
    <*> arbitrary -- v1alpha3AllocatedDeviceStatusDevice :: Text
    <*> arbitrary -- v1alpha3AllocatedDeviceStatusDriver :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3AllocatedDeviceStatusNetworkData :: Maybe V1alpha3NetworkDeviceData
    <*> arbitrary -- v1alpha3AllocatedDeviceStatusPool :: Text
  
instance Arbitrary V1alpha3AllocationResult where
  arbitrary = sized genV1alpha3AllocationResult

genV1alpha3AllocationResult :: Int -> Gen V1alpha3AllocationResult
genV1alpha3AllocationResult n =
  V1alpha3AllocationResult
    <$> arbitraryReducedMaybe n -- v1alpha3AllocationResultDevices :: Maybe V1alpha3DeviceAllocationResult
    <*> arbitraryReducedMaybe n -- v1alpha3AllocationResultNodeSelector :: Maybe V1NodeSelector
  
instance Arbitrary V1alpha3BasicDevice where
  arbitrary = sized genV1alpha3BasicDevice

genV1alpha3BasicDevice :: Int -> Gen V1alpha3BasicDevice
genV1alpha3BasicDevice n =
  V1alpha3BasicDevice
    <$> arbitraryReducedMaybe n -- v1alpha3BasicDeviceAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1alpha3BasicDeviceAttributes :: Maybe (Map.Map String V1alpha3DeviceAttribute)
    <*> arbitraryReducedMaybe n -- v1alpha3BasicDeviceCapacity :: Maybe (Map.Map String Quantity)
    <*> arbitraryReducedMaybe n -- v1alpha3BasicDeviceConsumesCounters :: Maybe [V1alpha3DeviceCounterConsumption]
    <*> arbitraryReducedMaybe n -- v1alpha3BasicDeviceNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3BasicDeviceNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1alpha3BasicDeviceTaints :: Maybe [V1alpha3DeviceTaint]
...
instance Arbitrary V1alpha3Counter where
  arbitrary = sized genV1alpha3Counter

genV1alpha3Counter :: Int -> Gen V1alpha3Counter
genV1alpha3Counter n =
  V1alpha3Counter
    <$> arbitraryReduced n -- v1alpha3CounterValue :: Quantity
  
instance Arbitrary V1alpha3CounterSet where
  arbitrary = sized genV1alpha3CounterSet

genV1alpha3CounterSet :: Int -> Gen V1alpha3CounterSet
genV1alpha3CounterSet n =
  V1alpha3CounterSet
    <$> arbitraryReduced n -- v1alpha3CounterSetCounters :: (Map.Map String V1alpha3Counter)
    <*> arbitrary -- v1alpha3CounterSetName :: Text
  
instance Arbitrary V1alpha3Device where
  arbitrary = sized genV1alpha3Device

genV1alpha3Device :: Int -> Gen V1alpha3Device
genV1alpha3Device n =
  V1alpha3Device
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceBasic :: Maybe V1alpha3BasicDevice
    <*> arbitrary -- v1alpha3DeviceName :: Text
  
instance Arbitrary V1alpha3DeviceAllocationConfiguration where
  arbitrary = sized genV1alpha3DeviceAllocationConfiguration

genV1alpha3DeviceAllocationConfiguration :: Int -> Gen V1alpha3DeviceAllocationConfiguration
genV1alpha3DeviceAllocationConfiguration n =
  V1alpha3DeviceAllocationConfiguration
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceAllocationConfigurationOpaque :: Maybe V1alpha3OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceAllocationConfigurationRequests :: Maybe [Text]
    <*> arbitrary -- v1alpha3DeviceAllocationConfigurationSource :: Text
  
instance Arbitrary V1alpha3DeviceAllocationResult where
  arbitrary = sized genV1alpha3DeviceAllocationResult

genV1alpha3DeviceAllocationResult :: Int -> Gen V1alpha3DeviceAllocationResult
genV1alpha3DeviceAllocationResult n =
  V1alpha3DeviceAllocationResult
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceAllocationResultConfig :: Maybe [V1alpha3DeviceAllocationConfiguration]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceAllocationResultResults :: Maybe [V1alpha3DeviceRequestAllocationResult]
  
instance Arbitrary V1alpha3DeviceAttribute where
  arbitrary = sized genV1alpha3DeviceAttribute

genV1alpha3DeviceAttribute :: Int -> Gen V1alpha3DeviceAttribute
genV1alpha3DeviceAttribute n =
  V1alpha3DeviceAttribute
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceAttributeBool :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceAttributeInt :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceAttributeString :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceAttributeVersion :: Maybe Text
  
instance Arbitrary V1alpha3DeviceClaim where
  arbitrary = sized genV1alpha3DeviceClaim

genV1alpha3DeviceClaim :: Int -> Gen V1alpha3DeviceClaim
genV1alpha3DeviceClaim n =
  V1alpha3DeviceClaim
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceClaimConfig :: Maybe [V1alpha3DeviceClaimConfiguration]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClaimConstraints :: Maybe [V1alpha3DeviceConstraint]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClaimRequests :: Maybe [V1alpha3DeviceRequest]
  
instance Arbitrary V1alpha3DeviceClaimConfiguration where
  arbitrary = sized genV1alpha3DeviceClaimConfiguration

genV1alpha3DeviceClaimConfiguration :: Int -> Gen V1alpha3DeviceClaimConfiguration
genV1alpha3DeviceClaimConfiguration n =
  V1alpha3DeviceClaimConfiguration
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceClaimConfigurationOpaque :: Maybe V1alpha3OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClaimConfigurationRequests :: Maybe [Text]
  
instance Arbitrary V1alpha3DeviceClass where
  arbitrary = sized genV1alpha3DeviceClass

genV1alpha3DeviceClass :: Int -> Gen V1alpha3DeviceClass
genV1alpha3DeviceClass n =
  V1alpha3DeviceClass
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceClassApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClassKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClassMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3DeviceClassSpec :: V1alpha3DeviceClassSpec
  
instance Arbitrary V1alpha3DeviceClassConfiguration where
  arbitrary = sized genV1alpha3DeviceClassConfiguration

genV1alpha3DeviceClassConfiguration :: Int -> Gen V1alpha3DeviceClassConfiguration
genV1alpha3DeviceClassConfiguration n =
  V1alpha3DeviceClassConfiguration
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceClassConfigurationOpaque :: Maybe V1alpha3OpaqueDeviceConfiguration
  
instance Arbitrary V1alpha3DeviceClassList where
  arbitrary = sized genV1alpha3DeviceClassList

genV1alpha3DeviceClassList :: Int -> Gen V1alpha3DeviceClassList
genV1alpha3DeviceClassList n =
  V1alpha3DeviceClassList
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceClassListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3DeviceClassListItems :: [V1alpha3DeviceClass]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClassListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClassListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3DeviceClassSpec where
  arbitrary = sized genV1alpha3DeviceClassSpec

genV1alpha3DeviceClassSpec :: Int -> Gen V1alpha3DeviceClassSpec
genV1alpha3DeviceClassSpec n =
  V1alpha3DeviceClassSpec
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceClassSpecConfig :: Maybe [V1alpha3DeviceClassConfiguration]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClassSpecSelectors :: Maybe [V1alpha3DeviceSelector]
  
instance Arbitrary V1alpha3DeviceConstraint where
  arbitrary = sized genV1alpha3DeviceConstraint

genV1alpha3DeviceConstraint :: Int -> Gen V1alpha3DeviceConstraint
genV1alpha3DeviceConstraint n =
  V1alpha3DeviceConstraint
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceConstraintMatchAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceConstraintRequests :: Maybe [Text]
  
instance Arbitrary V1alpha3DeviceCounterConsumption where
  arbitrary = sized genV1alpha3DeviceCounterConsumption

genV1alpha3DeviceCounterConsumption :: Int -> Gen V1alpha3DeviceCounterConsumption
genV1alpha3DeviceCounterConsumption n =
  V1alpha3DeviceCounterConsumption
    <$> arbitrary -- v1alpha3DeviceCounterConsumptionCounterSet :: Text
    <*> arbitraryReduced n -- v1alpha3DeviceCounterConsumptionCounters :: (Map.Map String V1alpha3Counter)
  
instance Arbitrary V1alpha3DeviceRequest where
  arbitrary = sized genV1alpha3DeviceRequest

genV1alpha3DeviceRequest :: Int -> Gen V1alpha3DeviceRequest
genV1alpha3DeviceRequest n =
  V1alpha3DeviceRequest
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceRequestAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestDeviceClassName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestFirstAvailable :: Maybe [V1alpha3DeviceSubRequest]
    <*> arbitrary -- v1alpha3DeviceRequestName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestSelectors :: Maybe [V1alpha3DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestTolerations :: Maybe [V1alpha3DeviceToleration]
  
instance Arbitrary V1alpha3DeviceRequestAllocationResult where
  arbitrary = sized genV1alpha3DeviceRequestAllocationResult

genV1alpha3DeviceRequestAllocationResult :: Int -> Gen V1alpha3DeviceRequestAllocationResult
genV1alpha3DeviceRequestAllocationResult n =
  V1alpha3DeviceRequestAllocationResult
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceRequestAllocationResultAdminAccess :: Maybe Bool
    <*> arbitrary -- v1alpha3DeviceRequestAllocationResultDevice :: Text
    <*> arbitrary -- v1alpha3DeviceRequestAllocationResultDriver :: Text
    <*> arbitrary -- v1alpha3DeviceRequestAllocationResultPool :: Text
    <*> arbitrary -- v1alpha3DeviceRequestAllocationResultRequest :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceRequestAllocationResultTolerations :: Maybe [V1alpha3DeviceToleration]
...
instance Arbitrary V1alpha3DeviceSubRequest where
  arbitrary = sized genV1alpha3DeviceSubRequest

genV1alpha3DeviceSubRequest :: Int -> Gen V1alpha3DeviceSubRequest
genV1alpha3DeviceSubRequest n =
  V1alpha3DeviceSubRequest
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceSubRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceSubRequestCount :: Maybe Integer
    <*> arbitrary -- v1alpha3DeviceSubRequestDeviceClassName :: Text
    <*> arbitrary -- v1alpha3DeviceSubRequestName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceSubRequestSelectors :: Maybe [V1alpha3DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceSubRequestTolerations :: Maybe [V1alpha3DeviceToleration]
...
instance Arbitrary V1alpha3DeviceToleration where
  arbitrary = sized genV1alpha3DeviceToleration

genV1alpha3DeviceToleration :: Int -> Gen V1alpha3DeviceToleration
genV1alpha3DeviceToleration n =
  V1alpha3DeviceToleration
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceTolerationEffect :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTolerationKey :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTolerationOperator :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTolerationTolerationSeconds :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTolerationValue :: Maybe Text
  
instance Arbitrary V1alpha3NetworkDeviceData where
  arbitrary = sized genV1alpha3NetworkDeviceData

genV1alpha3NetworkDeviceData :: Int -> Gen V1alpha3NetworkDeviceData
genV1alpha3NetworkDeviceData n =
  V1alpha3NetworkDeviceData
    <$> arbitraryReducedMaybe n -- v1alpha3NetworkDeviceDataHardwareAddress :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3NetworkDeviceDataInterfaceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3NetworkDeviceDataIps :: Maybe [Text]
  
instance Arbitrary V1alpha3OpaqueDeviceConfiguration where
  arbitrary = sized genV1alpha3OpaqueDeviceConfiguration

genV1alpha3OpaqueDeviceConfiguration :: Int -> Gen V1alpha3OpaqueDeviceConfiguration
genV1alpha3OpaqueDeviceConfiguration n =
  V1alpha3OpaqueDeviceConfiguration
    <$> arbitrary -- v1alpha3OpaqueDeviceConfigurationDriver :: Text
    <*> arbitraryReduced n -- v1alpha3OpaqueDeviceConfigurationParameters :: A.Value
  
instance Arbitrary V1alpha3ResourceClaim where
  arbitrary = sized genV1alpha3ResourceClaim

genV1alpha3ResourceClaim :: Int -> Gen V1alpha3ResourceClaim
genV1alpha3ResourceClaim n =
  V1alpha3ResourceClaim
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3ResourceClaimSpec :: V1alpha3ResourceClaimSpec
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimStatus :: Maybe V1alpha3ResourceClaimStatus
  
instance Arbitrary V1alpha3ResourceClaimConsumerReference where
  arbitrary = sized genV1alpha3ResourceClaimConsumerReference

genV1alpha3ResourceClaimConsumerReference :: Int -> Gen V1alpha3ResourceClaimConsumerReference
genV1alpha3ResourceClaimConsumerReference n =
  V1alpha3ResourceClaimConsumerReference
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimConsumerReferenceApiGroup :: Maybe Text
    <*> arbitrary -- v1alpha3ResourceClaimConsumerReferenceName :: Text
    <*> arbitrary -- v1alpha3ResourceClaimConsumerReferenceResource :: Text
    <*> arbitrary -- v1alpha3ResourceClaimConsumerReferenceUid :: Text
  
instance Arbitrary V1alpha3ResourceClaimList where
  arbitrary = sized genV1alpha3ResourceClaimList

genV1alpha3ResourceClaimList :: Int -> Gen V1alpha3ResourceClaimList
genV1alpha3ResourceClaimList n =
  V1alpha3ResourceClaimList
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3ResourceClaimListItems :: [V1alpha3ResourceClaim]
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3ResourceClaimSpec where
  arbitrary = sized genV1alpha3ResourceClaimSpec

genV1alpha3ResourceClaimSpec :: Int -> Gen V1alpha3ResourceClaimSpec
genV1alpha3ResourceClaimSpec n =
  V1alpha3ResourceClaimSpec
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimSpecDevices :: Maybe V1alpha3DeviceClaim
  
instance Arbitrary V1alpha3ResourceClaimStatus where
  arbitrary = sized genV1alpha3ResourceClaimStatus

genV1alpha3ResourceClaimStatus :: Int -> Gen V1alpha3ResourceClaimStatus
genV1alpha3ResourceClaimStatus n =
  V1alpha3ResourceClaimStatus
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimStatusAllocation :: Maybe V1alpha3AllocationResult
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimStatusDevices :: Maybe [V1alpha3AllocatedDeviceStatus]
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimStatusReservedFor :: Maybe [V1alpha3ResourceClaimConsumerReference]
  
instance Arbitrary V1alpha3ResourceClaimTemplate where
  arbitrary = sized genV1alpha3ResourceClaimTemplate

genV1alpha3ResourceClaimTemplate :: Int -> Gen V1alpha3ResourceClaimTemplate
genV1alpha3ResourceClaimTemplate n =
  V1alpha3ResourceClaimTemplate
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3ResourceClaimTemplateSpec :: V1alpha3ResourceClaimTemplateSpec
  
instance Arbitrary V1alpha3ResourceClaimTemplateList where
  arbitrary = sized genV1alpha3ResourceClaimTemplateList

genV1alpha3ResourceClaimTemplateList :: Int -> Gen V1alpha3ResourceClaimTemplateList
genV1alpha3ResourceClaimTemplateList n =
  V1alpha3ResourceClaimTemplateList
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3ResourceClaimTemplateListItems :: [V1alpha3ResourceClaimTemplate]
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3ResourceClaimTemplateSpec where
  arbitrary = sized genV1alpha3ResourceClaimTemplateSpec

genV1alpha3ResourceClaimTemplateSpec :: Int -> Gen V1alpha3ResourceClaimTemplateSpec
genV1alpha3ResourceClaimTemplateSpec n =
  V1alpha3ResourceClaimTemplateSpec
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimTemplateSpecMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3ResourceClaimTemplateSpecSpec :: V1alpha3ResourceClaimSpec
  
instance Arbitrary V1alpha3ResourcePool where
  arbitrary = sized genV1alpha3ResourcePool

genV1alpha3ResourcePool :: Int -> Gen V1alpha3ResourcePool
genV1alpha3ResourcePool n =
  V1alpha3ResourcePool
    <$> arbitrary -- v1alpha3ResourcePoolGeneration :: Integer
    <*> arbitrary -- v1alpha3ResourcePoolName :: Text
    <*> arbitrary -- v1alpha3ResourcePoolResourceSliceCount :: Integer
  
instance Arbitrary V1alpha3ResourceSlice where
  arbitrary = sized genV1alpha3ResourceSlice

genV1alpha3ResourceSlice :: Int -> Gen V1alpha3ResourceSlice
genV1alpha3ResourceSlice n =
  V1alpha3ResourceSlice
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceSliceApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3ResourceSliceSpec :: V1alpha3ResourceSliceSpec
  
instance Arbitrary V1alpha3ResourceSliceList where
  arbitrary = sized genV1alpha3ResourceSliceList

genV1alpha3ResourceSliceList :: Int -> Gen V1alpha3ResourceSliceList
genV1alpha3ResourceSliceList n =
  V1alpha3ResourceSliceList
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceSliceListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3ResourceSliceListItems :: [V1alpha3ResourceSlice]
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3ResourceSliceSpec where
  arbitrary = sized genV1alpha3ResourceSliceSpec

genV1alpha3ResourceSliceSpec :: Int -> Gen V1alpha3ResourceSliceSpec
genV1alpha3ResourceSliceSpec n =
  V1alpha3ResourceSliceSpec
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceSliceSpecAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceSpecDevices :: Maybe [V1alpha3Device]
    <*> arbitrary -- v1alpha3ResourceSliceSpecDriver :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceSpecNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceSpecNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceSpecPerDeviceNodeSelection :: Maybe Bool
    <*> arbitraryReduced n -- v1alpha3ResourceSliceSpecPool :: V1alpha3ResourcePool
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceSliceSpecSharedCounters :: Maybe [V1alpha3CounterSet]
