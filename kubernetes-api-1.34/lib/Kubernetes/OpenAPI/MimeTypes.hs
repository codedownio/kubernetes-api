...
data MimeApplyPatchcbor = MimeApplyPatchcbor deriving (P.Typeable)

-- | @application/apply-patch+cbor@
instance MimeType MimeApplyPatchcbor where
  mimeType _ = Just $ P.fromString "application/apply-patch+cbor"
-- instance MimeRender MimeApplyPatchcbor T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeApplyPatchcbor T.Text where mimeUnrender _ = undefined
...
data MimeCborSeq = MimeCborSeq deriving (P.Typeable)

-- | @application/cbor-seq@
instance MimeType MimeCborSeq where
  mimeType _ = Just $ P.fromString "application/cbor-seq"
-- instance MimeRender MimeCborSeq T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeCborSeq T.Text where mimeUnrender _ = undefined
