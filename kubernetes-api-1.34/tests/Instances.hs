...
instance Arbitrary V1alpha1PodCertificateRequest where
  arbitrary = sized genV1alpha1PodCertificateRequest

genV1alpha1PodCertificateRequest :: Int -> Gen V1alpha1PodCertificateRequest
genV1alpha1PodCertificateRequest n =
  V1alpha1PodCertificateRequest
    <$> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha1PodCertificateRequestSpec :: V1alpha1PodCertificateRequestSpec
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestStatus :: Maybe V1alpha1PodCertificateRequestStatus
  
instance Arbitrary V1alpha1PodCertificateRequestList where
  arbitrary = sized genV1alpha1PodCertificateRequestList

genV1alpha1PodCertificateRequestList :: Int -> Gen V1alpha1PodCertificateRequestList
genV1alpha1PodCertificateRequestList n =
  V1alpha1PodCertificateRequestList
    <$> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1PodCertificateRequestListItems :: [V1alpha1PodCertificateRequest]
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha1PodCertificateRequestSpec where
  arbitrary = sized genV1alpha1PodCertificateRequestSpec

genV1alpha1PodCertificateRequestSpec :: Int -> Gen V1alpha1PodCertificateRequestSpec
genV1alpha1PodCertificateRequestSpec n =
  V1alpha1PodCertificateRequestSpec
    <$> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestSpecMaxExpirationSeconds :: Maybe Int
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecNodeName :: Text
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecNodeUid :: Text
    <*> arbitraryReduced n -- v1alpha1PodCertificateRequestSpecPkixPublicKey :: ByteArray
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecPodName :: Text
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecPodUid :: Text
    <*> arbitraryReduced n -- v1alpha1PodCertificateRequestSpecProofOfPossession :: ByteArray
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecServiceAccountName :: Text
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecServiceAccountUid :: Text
    <*> arbitrary -- v1alpha1PodCertificateRequestSpecSignerName :: Text
  
instance Arbitrary V1alpha1PodCertificateRequestStatus where
  arbitrary = sized genV1alpha1PodCertificateRequestStatus

genV1alpha1PodCertificateRequestStatus :: Int -> Gen V1alpha1PodCertificateRequestStatus
genV1alpha1PodCertificateRequestStatus n =
  V1alpha1PodCertificateRequestStatus
    <$> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestStatusBeginRefreshAt :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestStatusCertificateChain :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestStatusNotAfter :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1alpha1PodCertificateRequestStatusNotBefore :: Maybe DateTime
...
instance Arbitrary V1alpha3CELDeviceSelector where
  arbitrary = sized genV1alpha3CELDeviceSelector

genV1alpha3CELDeviceSelector :: Int -> Gen V1alpha3CELDeviceSelector
genV1alpha3CELDeviceSelector n =
  V1alpha3CELDeviceSelector
    <$> arbitrary -- v1alpha3CELDeviceSelectorExpression :: Text
  
instance Arbitrary V1alpha3DeviceSelector where
  arbitrary = sized genV1alpha3DeviceSelector

genV1alpha3DeviceSelector :: Int -> Gen V1alpha3DeviceSelector
genV1alpha3DeviceSelector n =
  V1alpha3DeviceSelector
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceSelectorCel :: Maybe V1alpha3CELDeviceSelector
...
genV1alpha3DeviceTaintSelector n =
  V1alpha3DeviceTaintSelector
    ...
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintSelectorDeviceClassName :: Maybe Text
    ...
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintSelectorSelectors :: Maybe [V1alpha3DeviceSelector]
