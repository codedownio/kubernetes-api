...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PodCertificateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PodCertificateRequestList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PodCertificateRequestSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PodCertificateRequestStatus)
