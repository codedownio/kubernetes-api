...
{-|
Module : Kubernetes.OpenAPI.API.CoordinationV1alpha1
-}
...
module Kubernetes.OpenAPI.API.CoordinationV1alpha1 where
...
-- 
createNamespacedLeaseCandidate
  :: (Consumes CreateNamespacedLeaseCandidate contentType, MimeRender contentType V1alpha1LeaseCandidate)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1alpha1LeaseCandidate -- ^ "body"
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest CreateNamespacedLeaseCandidate contentType V1alpha1LeaseCandidate accept
createNamespacedLeaseCandidate _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateNamespacedLeaseCandidate 
instance HasBodyParam CreateNamespacedLeaseCandidate V1alpha1LeaseCandidate 
...
deleteCollectionNamespacedLeaseCandidate _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteNamespacedLeaseCandidate _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | @GET \/apis\/coordination.k8s.io\/v1alpha1\/@
-- 
...
getAPIResources  _ =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha1/"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listLeaseCandidateForAllNamespaces
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListLeaseCandidateForAllNamespaces MimeNoContent V1alpha1LeaseCandidateList accept
listLeaseCandidateForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha1/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listNamespacedLeaseCandidate
  :: Accept accept -- ^ request accept ('MimeType')
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ListNamespacedLeaseCandidate MimeNoContent V1alpha1LeaseCandidateList accept
listNamespacedLeaseCandidate  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchNamespacedLeaseCandidate
  ...
  -> Name -- ^ "name" -  name of the LeaseCandidate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedLeaseCandidate contentType V1alpha1LeaseCandidate accept
patchNamespacedLeaseCandidate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readNamespacedLeaseCandidate
  ...
  -> Name -- ^ "name" -  name of the LeaseCandidate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedLeaseCandidate MimeNoContent V1alpha1LeaseCandidate accept
readNamespacedLeaseCandidate  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- 
replaceNamespacedLeaseCandidate
  :: (Consumes ReplaceNamespacedLeaseCandidate contentType, MimeRender contentType V1alpha1LeaseCandidate)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1alpha1LeaseCandidate -- ^ "body"
  -> Name -- ^ "name" -  name of the LeaseCandidate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedLeaseCandidate contentType V1alpha1LeaseCandidate accept
replaceNamespacedLeaseCandidate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/coordination.k8s.io/v1alpha1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedLeaseCandidate 
instance HasBodyParam ReplaceNamespacedLeaseCandidate V1alpha1LeaseCandidate 
