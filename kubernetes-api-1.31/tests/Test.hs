...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1LeaseCandidate)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1LeaseCandidateList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1LeaseCandidateSpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3PodSchedulingContext)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3PodSchedulingContextList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3PodSchedulingContextSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3PodSchedulingContextStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3ResourceClaimSchedulingStatus)
