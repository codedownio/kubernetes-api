...
instance Arbitrary V1alpha1LeaseCandidate where
  arbitrary = sized genV1alpha1LeaseCandidate

genV1alpha1LeaseCandidate :: Int -> Gen V1alpha1LeaseCandidate
genV1alpha1LeaseCandidate n =
  V1alpha1LeaseCandidate
    <$> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateSpec :: Maybe V1alpha1LeaseCandidateSpec
  
instance Arbitrary V1alpha1LeaseCandidateList where
  arbitrary = sized genV1alpha1LeaseCandidateList

genV1alpha1LeaseCandidateList :: Int -> Gen V1alpha1LeaseCandidateList
genV1alpha1LeaseCandidateList n =
  V1alpha1LeaseCandidateList
    <$> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1LeaseCandidateListItems :: [V1alpha1LeaseCandidate]
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha1LeaseCandidateSpec where
  arbitrary = sized genV1alpha1LeaseCandidateSpec

genV1alpha1LeaseCandidateSpec :: Int -> Gen V1alpha1LeaseCandidateSpec
genV1alpha1LeaseCandidateSpec n =
  V1alpha1LeaseCandidateSpec
    <$> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateSpecBinaryVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateSpecEmulationVersion :: Maybe Text
    <*> arbitrary -- v1alpha1LeaseCandidateSpecLeaseName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateSpecPingTime :: Maybe DateTime
    <*> arbitrary -- v1alpha1LeaseCandidateSpecPreferredStrategies :: [Text]
    <*> arbitraryReducedMaybe n -- v1alpha1LeaseCandidateSpecRenewTime :: Maybe DateTime
...
genV1alpha3AllocationResult n =
  V1alpha3AllocationResult
    <$> arbitraryReducedMaybe n -- v1alpha3AllocationResultController :: Maybe Text
...
genV1alpha3DeviceClassSpec n =
  V1alpha3DeviceClassSpec
    ...
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceClassSpecSuitableNodes :: Maybe V1NodeSelector
...
instance Arbitrary V1alpha3PodSchedulingContext where
  arbitrary = sized genV1alpha3PodSchedulingContext

genV1alpha3PodSchedulingContext :: Int -> Gen V1alpha3PodSchedulingContext
genV1alpha3PodSchedulingContext n =
  V1alpha3PodSchedulingContext
    <$> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3PodSchedulingContextSpec :: V1alpha3PodSchedulingContextSpec
    <*> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextStatus :: Maybe V1alpha3PodSchedulingContextStatus
  
instance Arbitrary V1alpha3PodSchedulingContextList where
  arbitrary = sized genV1alpha3PodSchedulingContextList

genV1alpha3PodSchedulingContextList :: Int -> Gen V1alpha3PodSchedulingContextList
genV1alpha3PodSchedulingContextList n =
  V1alpha3PodSchedulingContextList
    <$> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3PodSchedulingContextListItems :: [V1alpha3PodSchedulingContext]
    <*> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3PodSchedulingContextSpec where
  arbitrary = sized genV1alpha3PodSchedulingContextSpec

genV1alpha3PodSchedulingContextSpec :: Int -> Gen V1alpha3PodSchedulingContextSpec
genV1alpha3PodSchedulingContextSpec n =
  V1alpha3PodSchedulingContextSpec
    <$> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextSpecPotentialNodes :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextSpecSelectedNode :: Maybe Text
  
instance Arbitrary V1alpha3PodSchedulingContextStatus where
  arbitrary = sized genV1alpha3PodSchedulingContextStatus

genV1alpha3PodSchedulingContextStatus :: Int -> Gen V1alpha3PodSchedulingContextStatus
genV1alpha3PodSchedulingContextStatus n =
  V1alpha3PodSchedulingContextStatus
    <$> arbitraryReducedMaybe n -- v1alpha3PodSchedulingContextStatusResourceClaims :: Maybe [V1alpha3ResourceClaimSchedulingStatus]
...
instance Arbitrary V1alpha3ResourceClaimSchedulingStatus where
  arbitrary = sized genV1alpha3ResourceClaimSchedulingStatus

genV1alpha3ResourceClaimSchedulingStatus :: Int -> Gen V1alpha3ResourceClaimSchedulingStatus
genV1alpha3ResourceClaimSchedulingStatus n =
  V1alpha3ResourceClaimSchedulingStatus
    <$> arbitrary -- v1alpha3ResourceClaimSchedulingStatusName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimSchedulingStatusUnsuitableNodes :: Maybe [Text]
...
genV1alpha3ResourceClaimSpec n =
  V1alpha3ResourceClaimSpec
    <$> arbitraryReducedMaybe n -- v1alpha3ResourceClaimSpecController :: Maybe Text
...
genV1alpha3ResourceClaimStatus n =
  V1alpha3ResourceClaimStatus
    ...
    <*> arbitraryReducedMaybe n -- v1alpha3ResourceClaimStatusDeallocationRequested :: Maybe Bool
