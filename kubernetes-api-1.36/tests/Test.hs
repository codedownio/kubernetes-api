...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy CoreV1ResourceClaim)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy ResourceV1ResourceClaim)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1AllocatedDeviceStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1AllocationResult)
      propMimeEq MimeJSON (Proxy :: Proxy V1AppArmorProfile)
      propMimeEq MimeJSON (Proxy :: Proxy V1ApplyConfiguration)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1CELDeviceSelector)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1CapacityRequestPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy V1CapacityRequestPolicyRange)
      propMimeEq MimeJSON (Proxy :: Proxy V1CapacityRequirements)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ContainerExtendedResourceRequest)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ContainerRestartRule)
      propMimeEq MimeJSON (Proxy :: Proxy V1ContainerRestartRuleOnExitCodes)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1Counter)
      propMimeEq MimeJSON (Proxy :: Proxy V1CounterSet)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1Device)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceAllocationConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceAllocationResult)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceAttribute)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceCapacity)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceClaim)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceClaimConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceClass)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceClassConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceClassList)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceClassSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceConstraint)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceCounterConsumption)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceRequestAllocationResult)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceSelector)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceSubRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceTaint)
      propMimeEq MimeJSON (Proxy :: Proxy V1DeviceToleration)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ExactDeviceRequest)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1FileKeySelector)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ImageVolumeStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1JSONPatch)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1MutatingAdmissionPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy V1MutatingAdmissionPolicyBinding)
      propMimeEq MimeJSON (Proxy :: Proxy V1MutatingAdmissionPolicyBindingList)
      propMimeEq MimeJSON (Proxy :: Proxy V1MutatingAdmissionPolicyBindingSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1MutatingAdmissionPolicyList)
      propMimeEq MimeJSON (Proxy :: Proxy V1MutatingAdmissionPolicySpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1Mutation)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1NetworkDeviceData)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1NodeAllocatableResourceClaimStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1NodeAllocatableResourceMapping)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1OpaqueDeviceConfiguration)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1PodCertificateProjection)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1PodExtendedResourceClaimStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1PodSchedulingGroup)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimConsumerReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimList)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimTemplate)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimTemplateList)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceClaimTemplateSpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourcePool)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceSlice)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceSliceList)
      propMimeEq MimeJSON (Proxy :: Proxy V1ResourceSliceSpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1ShardInfo)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1VolumeAttributesClass)
      propMimeEq MimeJSON (Proxy :: Proxy V1VolumeAttributesClassList)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1VolumeStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2GangSchedulingPolicy)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroup)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupResourceClaim)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupResourceClaimStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupSchedulingConstraints)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupSchedulingPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupTemplate)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2PodGroupTemplateReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2TopologyConstraint)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2TypedLocalObjectReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2Workload)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2WorkloadList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2WorkloadPodGroupTemplateReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha2WorkloadSpec)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3DeviceTaintRuleStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3DeviceTaintSelector)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3PoolStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3ResourcePoolStatusRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3ResourcePoolStatusRequestList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3ResourcePoolStatusRequestSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha3ResourcePoolStatusRequestStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1AllocatedDeviceStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1AllocationResult)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1ApplyConfiguration)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1BasicDevice)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CELDeviceSelector)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CapacityRequestPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CapacityRequestPolicyRange)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1CapacityRequirements)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1JSONPatch)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingAdmissionPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingAdmissionPolicyBinding)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingAdmissionPolicyBindingList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingAdmissionPolicyBindingSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingAdmissionPolicyList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1MutatingAdmissionPolicySpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1Mutation)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1NamedRuleWithOperations)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1NetworkDeviceData)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1NodeAllocatableResourceMapping)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1PodCertificateRequest)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1PodCertificateRequestList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1PodCertificateRequestSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1PodCertificateRequestStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1StorageVersionMigration)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1StorageVersionMigrationList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1StorageVersionMigrationSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta1StorageVersionMigrationStatus)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2CapacityRequestPolicy)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2CapacityRequestPolicyRange)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2CapacityRequirements)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2DeviceTaintRule)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2DeviceTaintRuleList)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2DeviceTaintRuleSpec)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2DeviceTaintRuleStatus)
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2DeviceTaintSelector)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1beta2NodeAllocatableResourceMapping)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V2APIGroupDiscovery)
      propMimeEq MimeJSON (Proxy :: Proxy V2APIGroupDiscoveryList)
      propMimeEq MimeJSON (Proxy :: Proxy V2APIResourceDiscovery)
      propMimeEq MimeJSON (Proxy :: Proxy V2APISubresourceDiscovery)
      propMimeEq MimeJSON (Proxy :: Proxy V2APIVersionDiscovery)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V2beta1APIGroupDiscovery)
      propMimeEq MimeJSON (Proxy :: Proxy V2beta1APIGroupDiscoveryList)
      propMimeEq MimeJSON (Proxy :: Proxy V2beta1APIResourceDiscovery)
      propMimeEq MimeJSON (Proxy :: Proxy V2beta1APISubresourceDiscovery)
      propMimeEq MimeJSON (Proxy :: Proxy V2beta1APIVersionDiscovery)
