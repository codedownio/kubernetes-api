...
genAuthenticationV1TokenRequest n =
  AuthenticationV1TokenRequest
    ...
    <*> arbitraryReducedMaybe n -- authenticationV1TokenRequestSpec :: Maybe V1TokenRequestSpec
...
instance Arbitrary CoreV1ResourceClaim where
  arbitrary = sized genCoreV1ResourceClaim

genCoreV1ResourceClaim :: Int -> Gen CoreV1ResourceClaim
genCoreV1ResourceClaim n =
  CoreV1ResourceClaim
    <$> arbitrary -- coreV1ResourceClaimName :: Text
    <*> arbitraryReducedMaybe n -- coreV1ResourceClaimRequest :: Maybe Text
...
instance Arbitrary ResourceV1ResourceClaim where
  arbitrary = sized genResourceV1ResourceClaim

genResourceV1ResourceClaim :: Int -> Gen ResourceV1ResourceClaim
genResourceV1ResourceClaim n =
  ResourceV1ResourceClaim
    <$> arbitraryReducedMaybe n -- resourceV1ResourceClaimApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- resourceV1ResourceClaimKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- resourceV1ResourceClaimMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- resourceV1ResourceClaimSpec :: V1ResourceClaimSpec
    <*> arbitraryReducedMaybe n -- resourceV1ResourceClaimStatus :: Maybe V1ResourceClaimStatus
...
instance Arbitrary V1AllocatedDeviceStatus where
  arbitrary = sized genV1AllocatedDeviceStatus

genV1AllocatedDeviceStatus :: Int -> Gen V1AllocatedDeviceStatus
genV1AllocatedDeviceStatus n =
  V1AllocatedDeviceStatus
    <$> arbitraryReducedMaybe n -- v1AllocatedDeviceStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybeValue n -- v1AllocatedDeviceStatusData :: Maybe A.Value
    <*> arbitrary -- v1AllocatedDeviceStatusDevice :: Text
    <*> arbitrary -- v1AllocatedDeviceStatusDriver :: Text
    <*> arbitraryReducedMaybe n -- v1AllocatedDeviceStatusNetworkData :: Maybe V1NetworkDeviceData
    <*> arbitrary -- v1AllocatedDeviceStatusPool :: Text
    <*> arbitraryReducedMaybe n -- v1AllocatedDeviceStatusShareId :: Maybe Text
  
instance Arbitrary V1AllocationResult where
  arbitrary = sized genV1AllocationResult

genV1AllocationResult :: Int -> Gen V1AllocationResult
genV1AllocationResult n =
  V1AllocationResult
    <$> arbitraryReducedMaybe n -- v1AllocationResultAllocationTimestamp :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1AllocationResultDevices :: Maybe V1DeviceAllocationResult
    <*> arbitraryReducedMaybe n -- v1AllocationResultNodeSelector :: Maybe V1NodeSelector
...
instance Arbitrary V1ApplyConfiguration where
  arbitrary = sized genV1ApplyConfiguration

genV1ApplyConfiguration :: Int -> Gen V1ApplyConfiguration
genV1ApplyConfiguration n =
  V1ApplyConfiguration
    <$> arbitraryReducedMaybe n -- v1ApplyConfigurationExpression :: Maybe Text
...
instance Arbitrary V1CELDeviceSelector where
  arbitrary = sized genV1CELDeviceSelector

genV1CELDeviceSelector :: Int -> Gen V1CELDeviceSelector
genV1CELDeviceSelector n =
  V1CELDeviceSelector
    <$> arbitrary -- v1CELDeviceSelectorExpression :: Text
...
genV1CSIDriverSpec n =
  V1CSIDriverSpec
    ...
    <*> arbitraryReducedMaybe n -- v1CSIDriverSpecNodeAllocatableUpdatePeriodSeconds :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1CSIDriverSpecPodInfoOnMount :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1CSIDriverSpecPreventPodSchedulingIfMissing :: Maybe Bool
    ...
    <*> arbitraryReducedMaybe n -- v1CSIDriverSpecServiceAccountTokenInSecrets :: Maybe Bool
...
instance Arbitrary V1CapacityRequestPolicy where
  arbitrary = sized genV1CapacityRequestPolicy

genV1CapacityRequestPolicy :: Int -> Gen V1CapacityRequestPolicy
genV1CapacityRequestPolicy n =
  V1CapacityRequestPolicy
    <$> arbitraryReducedMaybe n -- v1CapacityRequestPolicyDefault :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1CapacityRequestPolicyValidRange :: Maybe V1CapacityRequestPolicyRange
    <*> arbitraryReducedMaybe n -- v1CapacityRequestPolicyValidValues :: Maybe [Quantity]
  
instance Arbitrary V1CapacityRequestPolicyRange where
  arbitrary = sized genV1CapacityRequestPolicyRange

genV1CapacityRequestPolicyRange :: Int -> Gen V1CapacityRequestPolicyRange
genV1CapacityRequestPolicyRange n =
  V1CapacityRequestPolicyRange
    <$> arbitraryReducedMaybe n -- v1CapacityRequestPolicyRangeMax :: Maybe Quantity
    <*> arbitraryReduced n -- v1CapacityRequestPolicyRangeMin :: Quantity
    <*> arbitraryReducedMaybe n -- v1CapacityRequestPolicyRangeStep :: Maybe Quantity
  
instance Arbitrary V1CapacityRequirements where
  arbitrary = sized genV1CapacityRequirements

genV1CapacityRequirements :: Int -> Gen V1CapacityRequirements
genV1CapacityRequirements n =
  V1CapacityRequirements
    <$> arbitraryReducedMaybe n -- v1CapacityRequirementsRequests :: Maybe (Map.Map String Quantity)
...
genV1Container n =
  V1Container
    ...
    <*> arbitraryReducedMaybe n -- v1ContainerRestartPolicyRules :: Maybe [V1ContainerRestartRule]
...
instance Arbitrary V1ContainerExtendedResourceRequest where
  arbitrary = sized genV1ContainerExtendedResourceRequest

genV1ContainerExtendedResourceRequest :: Int -> Gen V1ContainerExtendedResourceRequest
genV1ContainerExtendedResourceRequest n =
  V1ContainerExtendedResourceRequest
    <$> arbitrary -- v1ContainerExtendedResourceRequestContainerName :: Text
    <*> arbitrary -- v1ContainerExtendedResourceRequestRequestName :: Text
    <*> arbitrary -- v1ContainerExtendedResourceRequestResourceName :: Text
...
instance Arbitrary V1ContainerRestartRule where
  arbitrary = sized genV1ContainerRestartRule

genV1ContainerRestartRule :: Int -> Gen V1ContainerRestartRule
genV1ContainerRestartRule n =
  V1ContainerRestartRule
    <$> arbitrary -- v1ContainerRestartRuleAction :: Text
    <*> arbitraryReducedMaybe n -- v1ContainerRestartRuleExitCodes :: Maybe V1ContainerRestartRuleOnExitCodes
  
instance Arbitrary V1ContainerRestartRuleOnExitCodes where
  arbitrary = sized genV1ContainerRestartRuleOnExitCodes

genV1ContainerRestartRuleOnExitCodes :: Int -> Gen V1ContainerRestartRuleOnExitCodes
genV1ContainerRestartRuleOnExitCodes n =
  V1ContainerRestartRuleOnExitCodes
    <$> arbitrary -- v1ContainerRestartRuleOnExitCodesOperator :: Text
    <*> arbitraryReducedMaybe n -- v1ContainerRestartRuleOnExitCodesValues :: Maybe [Int]
...
genV1ContainerStatus n =
  V1ContainerStatus
    ...
    <*> arbitraryReducedMaybe n -- v1ContainerStatusAllocatedResourcesStatus :: Maybe [V1ResourceStatus]
    ...
    <*> arbitraryReducedMaybe n -- v1ContainerStatusStopSignal :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ContainerStatusUser :: Maybe V1ContainerUser
    <*> arbitraryReducedMaybe n -- v1ContainerStatusVolumeMounts :: Maybe [V1VolumeMountStatus]
  
instance Arbitrary V1ContainerUser where
  arbitrary = sized genV1ContainerUser

genV1ContainerUser :: Int -> Gen V1ContainerUser
genV1ContainerUser n =
  V1ContainerUser
    <$> arbitraryReducedMaybe n -- v1ContainerUserLinux :: Maybe V1LinuxContainerUser
...
instance Arbitrary V1Counter where
  arbitrary = sized genV1Counter

genV1Counter :: Int -> Gen V1Counter
genV1Counter n =
  V1Counter
    <$> arbitraryReduced n -- v1CounterValue :: Quantity
  
instance Arbitrary V1CounterSet where
  arbitrary = sized genV1CounterSet

genV1CounterSet :: Int -> Gen V1CounterSet
genV1CounterSet n =
  V1CounterSet
    <$> arbitraryReduced n -- v1CounterSetCounters :: (Map.Map String V1Counter)
    <*> arbitrary -- v1CounterSetName :: Text
...
genV1CronJob n =
  V1CronJob
    ...
    <*> arbitraryReduced n -- v1CronJobSpec :: V1CronJobSpec
...
genV1CustomResourceDefinitionCondition n =
  V1CustomResourceDefinitionCondition
    ...
    <*> arbitraryReducedMaybe n -- v1CustomResourceDefinitionConditionObservedGeneration :: Maybe Integer
...
genV1CustomResourceDefinitionStatus n =
  V1CustomResourceDefinitionStatus
    ...
    <*> arbitraryReducedMaybe n -- v1CustomResourceDefinitionStatusObservedGeneration :: Maybe Integer
...
genV1DeleteOptions n =
  V1DeleteOptions
    ...
    <*> arbitraryReducedMaybe n -- v1DeleteOptionsIgnoreStoreReadErrorWithClusterBreakingPotential :: Maybe Bool
...
genV1DeploymentStatus n =
  V1DeploymentStatus
    ...
    <*> arbitraryReducedMaybe n -- v1DeploymentStatusTerminatingReplicas :: Maybe Int
...
instance Arbitrary V1Device where
  arbitrary = sized genV1Device

genV1Device :: Int -> Gen V1Device
genV1Device n =
  V1Device
    <$> arbitraryReducedMaybe n -- v1DeviceAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1DeviceAllowMultipleAllocations :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1DeviceAttributes :: Maybe (Map.Map String V1DeviceAttribute)
    <*> arbitraryReducedMaybe n -- v1DeviceBindingConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1DeviceBindingFailureConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1DeviceBindsToNode :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1DeviceCapacity :: Maybe (Map.Map String V1DeviceCapacity)
    <*> arbitraryReducedMaybe n -- v1DeviceConsumesCounters :: Maybe [V1DeviceCounterConsumption]
    <*> arbitrary -- v1DeviceName :: Text
    <*> arbitraryReducedMaybe n -- v1DeviceNodeAllocatableResourceMappings :: Maybe (Map.Map String V1NodeAllocatableResourceMapping)
    <*> arbitraryReducedMaybe n -- v1DeviceNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1DeviceTaints :: Maybe [V1DeviceTaint]
  
instance Arbitrary V1DeviceAllocationConfiguration where
  arbitrary = sized genV1DeviceAllocationConfiguration

genV1DeviceAllocationConfiguration :: Int -> Gen V1DeviceAllocationConfiguration
genV1DeviceAllocationConfiguration n =
  V1DeviceAllocationConfiguration
    <$> arbitraryReducedMaybe n -- v1DeviceAllocationConfigurationOpaque :: Maybe V1OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1DeviceAllocationConfigurationRequests :: Maybe [Text]
    <*> arbitrary -- v1DeviceAllocationConfigurationSource :: Text
  
instance Arbitrary V1DeviceAllocationResult where
  arbitrary = sized genV1DeviceAllocationResult

genV1DeviceAllocationResult :: Int -> Gen V1DeviceAllocationResult
genV1DeviceAllocationResult n =
  V1DeviceAllocationResult
    <$> arbitraryReducedMaybe n -- v1DeviceAllocationResultConfig :: Maybe [V1DeviceAllocationConfiguration]
    <*> arbitraryReducedMaybe n -- v1DeviceAllocationResultResults :: Maybe [V1DeviceRequestAllocationResult]
  
instance Arbitrary V1DeviceAttribute where
  arbitrary = sized genV1DeviceAttribute

genV1DeviceAttribute :: Int -> Gen V1DeviceAttribute
genV1DeviceAttribute n =
  V1DeviceAttribute
    <$> arbitraryReducedMaybe n -- v1DeviceAttributeBool :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeBools :: Maybe [Bool]
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeInt :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeInts :: Maybe [Integer]
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeString :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeStrings :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceAttributeVersions :: Maybe [Text]
  
instance Arbitrary V1DeviceCapacity where
  arbitrary = sized genV1DeviceCapacity

genV1DeviceCapacity :: Int -> Gen V1DeviceCapacity
genV1DeviceCapacity n =
  V1DeviceCapacity
    <$> arbitraryReducedMaybe n -- v1DeviceCapacityRequestPolicy :: Maybe V1CapacityRequestPolicy
    <*> arbitraryReduced n -- v1DeviceCapacityValue :: Quantity
  
instance Arbitrary V1DeviceClaim where
  arbitrary = sized genV1DeviceClaim

genV1DeviceClaim :: Int -> Gen V1DeviceClaim
genV1DeviceClaim n =
  V1DeviceClaim
    <$> arbitraryReducedMaybe n -- v1DeviceClaimConfig :: Maybe [V1DeviceClaimConfiguration]
    <*> arbitraryReducedMaybe n -- v1DeviceClaimConstraints :: Maybe [V1DeviceConstraint]
    <*> arbitraryReducedMaybe n -- v1DeviceClaimRequests :: Maybe [V1DeviceRequest]
  
instance Arbitrary V1DeviceClaimConfiguration where
  arbitrary = sized genV1DeviceClaimConfiguration

genV1DeviceClaimConfiguration :: Int -> Gen V1DeviceClaimConfiguration
genV1DeviceClaimConfiguration n =
  V1DeviceClaimConfiguration
    <$> arbitraryReducedMaybe n -- v1DeviceClaimConfigurationOpaque :: Maybe V1OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1DeviceClaimConfigurationRequests :: Maybe [Text]
  
instance Arbitrary V1DeviceClass where
  arbitrary = sized genV1DeviceClass

genV1DeviceClass :: Int -> Gen V1DeviceClass
genV1DeviceClass n =
  V1DeviceClass
    <$> arbitraryReducedMaybe n -- v1DeviceClassApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceClassKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceClassMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1DeviceClassSpec :: V1DeviceClassSpec
  
instance Arbitrary V1DeviceClassConfiguration where
  arbitrary = sized genV1DeviceClassConfiguration

genV1DeviceClassConfiguration :: Int -> Gen V1DeviceClassConfiguration
genV1DeviceClassConfiguration n =
  V1DeviceClassConfiguration
    <$> arbitraryReducedMaybe n -- v1DeviceClassConfigurationOpaque :: Maybe V1OpaqueDeviceConfiguration
  
instance Arbitrary V1DeviceClassList where
  arbitrary = sized genV1DeviceClassList

genV1DeviceClassList :: Int -> Gen V1DeviceClassList
genV1DeviceClassList n =
  V1DeviceClassList
    <$> arbitraryReducedMaybe n -- v1DeviceClassListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1DeviceClassListItems :: [V1DeviceClass]
    <*> arbitraryReducedMaybe n -- v1DeviceClassListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceClassListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1DeviceClassSpec where
  arbitrary = sized genV1DeviceClassSpec

genV1DeviceClassSpec :: Int -> Gen V1DeviceClassSpec
genV1DeviceClassSpec n =
  V1DeviceClassSpec
    <$> arbitraryReducedMaybe n -- v1DeviceClassSpecConfig :: Maybe [V1DeviceClassConfiguration]
    <*> arbitraryReducedMaybe n -- v1DeviceClassSpecExtendedResourceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceClassSpecSelectors :: Maybe [V1DeviceSelector]
  
instance Arbitrary V1DeviceConstraint where
  arbitrary = sized genV1DeviceConstraint

genV1DeviceConstraint :: Int -> Gen V1DeviceConstraint
genV1DeviceConstraint n =
  V1DeviceConstraint
    <$> arbitraryReducedMaybe n -- v1DeviceConstraintDistinctAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceConstraintMatchAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceConstraintRequests :: Maybe [Text]
  
instance Arbitrary V1DeviceCounterConsumption where
  arbitrary = sized genV1DeviceCounterConsumption

genV1DeviceCounterConsumption :: Int -> Gen V1DeviceCounterConsumption
genV1DeviceCounterConsumption n =
  V1DeviceCounterConsumption
    <$> arbitrary -- v1DeviceCounterConsumptionCounterSet :: Text
    <*> arbitraryReduced n -- v1DeviceCounterConsumptionCounters :: (Map.Map String V1Counter)
  
instance Arbitrary V1DeviceRequest where
  arbitrary = sized genV1DeviceRequest

genV1DeviceRequest :: Int -> Gen V1DeviceRequest
genV1DeviceRequest n =
  V1DeviceRequest
    <$> arbitraryReducedMaybe n -- v1DeviceRequestExactly :: Maybe V1ExactDeviceRequest
    <*> arbitraryReducedMaybe n -- v1DeviceRequestFirstAvailable :: Maybe [V1DeviceSubRequest]
    <*> arbitrary -- v1DeviceRequestName :: Text
  
instance Arbitrary V1DeviceRequestAllocationResult where
  arbitrary = sized genV1DeviceRequestAllocationResult

genV1DeviceRequestAllocationResult :: Int -> Gen V1DeviceRequestAllocationResult
genV1DeviceRequestAllocationResult n =
  V1DeviceRequestAllocationResult
    <$> arbitraryReducedMaybe n -- v1DeviceRequestAllocationResultAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1DeviceRequestAllocationResultBindingConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1DeviceRequestAllocationResultBindingFailureConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1DeviceRequestAllocationResultConsumedCapacity :: Maybe (Map.Map String Quantity)
    <*> arbitrary -- v1DeviceRequestAllocationResultDevice :: Text
    <*> arbitrary -- v1DeviceRequestAllocationResultDriver :: Text
    <*> arbitrary -- v1DeviceRequestAllocationResultPool :: Text
    <*> arbitrary -- v1DeviceRequestAllocationResultRequest :: Text
    <*> arbitraryReducedMaybe n -- v1DeviceRequestAllocationResultShareId :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceRequestAllocationResultTolerations :: Maybe [V1DeviceToleration]
  
instance Arbitrary V1DeviceSelector where
  arbitrary = sized genV1DeviceSelector

genV1DeviceSelector :: Int -> Gen V1DeviceSelector
genV1DeviceSelector n =
  V1DeviceSelector
    <$> arbitraryReducedMaybe n -- v1DeviceSelectorCel :: Maybe V1CELDeviceSelector
  
instance Arbitrary V1DeviceSubRequest where
  arbitrary = sized genV1DeviceSubRequest

genV1DeviceSubRequest :: Int -> Gen V1DeviceSubRequest
genV1DeviceSubRequest n =
  V1DeviceSubRequest
    <$> arbitraryReducedMaybe n -- v1DeviceSubRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceSubRequestCapacity :: Maybe V1CapacityRequirements
    <*> arbitraryReducedMaybe n -- v1DeviceSubRequestCount :: Maybe Integer
    <*> arbitrary -- v1DeviceSubRequestDeviceClassName :: Text
    <*> arbitrary -- v1DeviceSubRequestName :: Text
    <*> arbitraryReducedMaybe n -- v1DeviceSubRequestSelectors :: Maybe [V1DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1DeviceSubRequestTolerations :: Maybe [V1DeviceToleration]
  
instance Arbitrary V1DeviceTaint where
  arbitrary = sized genV1DeviceTaint

genV1DeviceTaint :: Int -> Gen V1DeviceTaint
genV1DeviceTaint n =
  V1DeviceTaint
    <$> arbitrary -- v1DeviceTaintEffect :: Text
    <*> arbitrary -- v1DeviceTaintKey :: Text
    <*> arbitraryReducedMaybe n -- v1DeviceTaintTimeAdded :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1DeviceTaintValue :: Maybe Text
  
instance Arbitrary V1DeviceToleration where
  arbitrary = sized genV1DeviceToleration

genV1DeviceToleration :: Int -> Gen V1DeviceToleration
genV1DeviceToleration n =
  V1DeviceToleration
    <$> arbitraryReducedMaybe n -- v1DeviceTolerationEffect :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceTolerationKey :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceTolerationOperator :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1DeviceTolerationTolerationSeconds :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1DeviceTolerationValue :: Maybe Text
...
genV1EndpointHints n =
  V1EndpointHints
    <$> arbitraryReducedMaybe n -- v1EndpointHintsForNodes :: Maybe [V1ForNode]
...
genV1EndpointSlice n =
  V1EndpointSlice
    ...
    <*> arbitraryReducedMaybe n -- v1EndpointSliceEndpoints :: Maybe [V1Endpoint]
...
genV1EnvVarSource n =
  V1EnvVarSource
    ...
    <*> arbitraryReducedMaybe n -- v1EnvVarSourceFileKeyRef :: Maybe V1FileKeySelector
...
genV1EphemeralContainer n =
  V1EphemeralContainer
    ...
    <*> arbitraryReducedMaybe n -- v1EphemeralContainerRestartPolicyRules :: Maybe [V1ContainerRestartRule]
...
instance Arbitrary V1ExactDeviceRequest where
  arbitrary = sized genV1ExactDeviceRequest

genV1ExactDeviceRequest :: Int -> Gen V1ExactDeviceRequest
genV1ExactDeviceRequest n =
  V1ExactDeviceRequest
    <$> arbitraryReducedMaybe n -- v1ExactDeviceRequestAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1ExactDeviceRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ExactDeviceRequestCapacity :: Maybe V1CapacityRequirements
    <*> arbitraryReducedMaybe n -- v1ExactDeviceRequestCount :: Maybe Integer
    <*> arbitrary -- v1ExactDeviceRequestDeviceClassName :: Text
    <*> arbitraryReducedMaybe n -- v1ExactDeviceRequestSelectors :: Maybe [V1DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1ExactDeviceRequestTolerations :: Maybe [V1DeviceToleration]
...
instance Arbitrary V1FieldSelectorAttributes where
  arbitrary = sized genV1FieldSelectorAttributes

genV1FieldSelectorAttributes :: Int -> Gen V1FieldSelectorAttributes
genV1FieldSelectorAttributes n =
  V1FieldSelectorAttributes
    <$> arbitraryReducedMaybe n -- v1FieldSelectorAttributesRawSelector :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1FieldSelectorAttributesRequirements :: Maybe [V1FieldSelectorRequirement]
  
instance Arbitrary V1FieldSelectorRequirement where
  arbitrary = sized genV1FieldSelectorRequirement

genV1FieldSelectorRequirement :: Int -> Gen V1FieldSelectorRequirement
genV1FieldSelectorRequirement n =
  V1FieldSelectorRequirement
    <$> arbitrary -- v1FieldSelectorRequirementKey :: Text
    <*> arbitrary -- v1FieldSelectorRequirementOperator :: Text
    <*> arbitraryReducedMaybe n -- v1FieldSelectorRequirementValues :: Maybe [Text]
  
instance Arbitrary V1FileKeySelector where
  arbitrary = sized genV1FileKeySelector

genV1FileKeySelector :: Int -> Gen V1FileKeySelector
genV1FileKeySelector n =
  V1FileKeySelector
    <$> arbitrary -- v1FileKeySelectorKey :: Text
    <*> arbitraryReducedMaybe n -- v1FileKeySelectorOptional :: Maybe Bool
    <*> arbitrary -- v1FileKeySelectorPath :: Text
    <*> arbitrary -- v1FileKeySelectorVolumeName :: Text
...
instance Arbitrary V1ForNode where
  arbitrary = sized genV1ForNode

genV1ForNode :: Int -> Gen V1ForNode
genV1ForNode n =
  V1ForNode
    <$> arbitrary -- v1ForNodeName :: Text
...
instance Arbitrary V1GroupResource where
  arbitrary = sized genV1GroupResource

genV1GroupResource :: Int -> Gen V1GroupResource
genV1GroupResource n =
  V1GroupResource
    <$> arbitrary -- v1GroupResourceGroup :: Text
    <*> arbitrary -- v1GroupResourceResource :: Text
...
genV1HorizontalPodAutoscaler n =
  V1HorizontalPodAutoscaler
    ...
    <*> arbitraryReduced n -- v1HorizontalPodAutoscalerSpec :: V1HorizontalPodAutoscalerSpec
...
instance Arbitrary V1IPAddress where
  arbitrary = sized genV1IPAddress

genV1IPAddress :: Int -> Gen V1IPAddress
genV1IPAddress n =
  V1IPAddress
    <$> arbitraryReducedMaybe n -- v1IPAddressApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1IPAddressKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1IPAddressMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1IPAddressSpec :: V1IPAddressSpec
  
instance Arbitrary V1IPAddressList where
  arbitrary = sized genV1IPAddressList

genV1IPAddressList :: Int -> Gen V1IPAddressList
genV1IPAddressList n =
  V1IPAddressList
    <$> arbitraryReducedMaybe n -- v1IPAddressListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1IPAddressListItems :: [V1IPAddress]
    <*> arbitraryReducedMaybe n -- v1IPAddressListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1IPAddressListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1IPAddressSpec where
  arbitrary = sized genV1IPAddressSpec

genV1IPAddressSpec :: Int -> Gen V1IPAddressSpec
genV1IPAddressSpec n =
  V1IPAddressSpec
    <$> arbitraryReduced n -- v1IPAddressSpecParentRef :: V1ParentReference
...
instance Arbitrary V1ImageVolumeSource where
  arbitrary = sized genV1ImageVolumeSource

genV1ImageVolumeSource :: Int -> Gen V1ImageVolumeSource
genV1ImageVolumeSource n =
  V1ImageVolumeSource
    <$> arbitraryReducedMaybe n -- v1ImageVolumeSourcePullPolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ImageVolumeSourceReference :: Maybe Text
  
instance Arbitrary V1ImageVolumeStatus where
  arbitrary = sized genV1ImageVolumeStatus

genV1ImageVolumeStatus :: Int -> Gen V1ImageVolumeStatus
genV1ImageVolumeStatus n =
  V1ImageVolumeStatus
    <$> arbitrary -- v1ImageVolumeStatusImageRef :: Text
...
instance Arbitrary V1JSONPatch where
  arbitrary = sized genV1JSONPatch

genV1JSONPatch :: Int -> Gen V1JSONPatch
genV1JSONPatch n =
  V1JSONPatch
    <$> arbitraryReducedMaybe n -- v1JSONPatchExpression :: Maybe Text
...
instance Arbitrary V1LabelSelectorAttributes where
  arbitrary = sized genV1LabelSelectorAttributes

genV1LabelSelectorAttributes :: Int -> Gen V1LabelSelectorAttributes
genV1LabelSelectorAttributes n =
  V1LabelSelectorAttributes
    <$> arbitraryReducedMaybe n -- v1LabelSelectorAttributesRawSelector :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1LabelSelectorAttributesRequirements :: Maybe [V1LabelSelectorRequirement]
...
genV1LeaseSpec n =
  V1LeaseSpec
    ...
    <*> arbitraryReducedMaybe n -- v1LeaseSpecPreferredHolder :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1LeaseSpecRenewTime :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1LeaseSpecStrategy :: Maybe Text
...
genV1Lifecycle n =
  V1Lifecycle
    ...
    <*> arbitraryReducedMaybe n -- v1LifecycleStopSignal :: Maybe Text
...
instance Arbitrary V1LinuxContainerUser where
  arbitrary = sized genV1LinuxContainerUser

genV1LinuxContainerUser :: Int -> Gen V1LinuxContainerUser
genV1LinuxContainerUser n =
  V1LinuxContainerUser
    <$> arbitrary -- v1LinuxContainerUserGid :: Integer
    <*> arbitraryReducedMaybe n -- v1LinuxContainerUserSupplementalGroups :: Maybe [Integer]
    <*> arbitrary -- v1LinuxContainerUserUid :: Integer
...
genV1ListMeta n =
  V1ListMeta
    ...
    <*> arbitraryReducedMaybe n -- v1ListMetaShardInfo :: Maybe V1ShardInfo
...
instance Arbitrary V1MutatingAdmissionPolicy where
  arbitrary = sized genV1MutatingAdmissionPolicy

genV1MutatingAdmissionPolicy :: Int -> Gen V1MutatingAdmissionPolicy
genV1MutatingAdmissionPolicy n =
  V1MutatingAdmissionPolicy
    <$> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpec :: Maybe V1MutatingAdmissionPolicySpec
  
instance Arbitrary V1MutatingAdmissionPolicyBinding where
  arbitrary = sized genV1MutatingAdmissionPolicyBinding

genV1MutatingAdmissionPolicyBinding :: Int -> Gen V1MutatingAdmissionPolicyBinding
genV1MutatingAdmissionPolicyBinding n =
  V1MutatingAdmissionPolicyBinding
    <$> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingSpec :: Maybe V1MutatingAdmissionPolicyBindingSpec
  
instance Arbitrary V1MutatingAdmissionPolicyBindingList where
  arbitrary = sized genV1MutatingAdmissionPolicyBindingList

genV1MutatingAdmissionPolicyBindingList :: Int -> Gen V1MutatingAdmissionPolicyBindingList
genV1MutatingAdmissionPolicyBindingList n =
  V1MutatingAdmissionPolicyBindingList
    <$> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1MutatingAdmissionPolicyBindingListItems :: [V1MutatingAdmissionPolicyBinding]
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1MutatingAdmissionPolicyBindingSpec where
  arbitrary = sized genV1MutatingAdmissionPolicyBindingSpec

genV1MutatingAdmissionPolicyBindingSpec :: Int -> Gen V1MutatingAdmissionPolicyBindingSpec
genV1MutatingAdmissionPolicyBindingSpec n =
  V1MutatingAdmissionPolicyBindingSpec
    <$> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingSpecMatchResources :: Maybe V1MatchResources
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingSpecParamRef :: Maybe V1ParamRef
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyBindingSpecPolicyName :: Maybe Text
  
instance Arbitrary V1MutatingAdmissionPolicyList where
  arbitrary = sized genV1MutatingAdmissionPolicyList

genV1MutatingAdmissionPolicyList :: Int -> Gen V1MutatingAdmissionPolicyList
genV1MutatingAdmissionPolicyList n =
  V1MutatingAdmissionPolicyList
    <$> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1MutatingAdmissionPolicyListItems :: [V1MutatingAdmissionPolicy]
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicyListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1MutatingAdmissionPolicySpec where
  arbitrary = sized genV1MutatingAdmissionPolicySpec

genV1MutatingAdmissionPolicySpec :: Int -> Gen V1MutatingAdmissionPolicySpec
genV1MutatingAdmissionPolicySpec n =
  V1MutatingAdmissionPolicySpec
    <$> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecFailurePolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecMatchConditions :: Maybe [V1MatchCondition]
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecMatchConstraints :: Maybe V1MatchResources
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecMutations :: Maybe [V1Mutation]
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecParamKind :: Maybe V1ParamKind
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecReinvocationPolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1MutatingAdmissionPolicySpecVariables :: Maybe [V1Variable]
...
instance Arbitrary V1Mutation where
  arbitrary = sized genV1Mutation

genV1Mutation :: Int -> Gen V1Mutation
genV1Mutation n =
  V1Mutation
    <$> arbitraryReducedMaybe n -- v1MutationApplyConfiguration :: Maybe V1ApplyConfiguration
    <*> arbitraryReducedMaybe n -- v1MutationJsonPatch :: Maybe V1JSONPatch
    <*> arbitrary -- v1MutationPatchType :: Text
...
instance Arbitrary V1NetworkDeviceData where
  arbitrary = sized genV1NetworkDeviceData

genV1NetworkDeviceData :: Int -> Gen V1NetworkDeviceData
genV1NetworkDeviceData n =
  V1NetworkDeviceData
    <$> arbitraryReducedMaybe n -- v1NetworkDeviceDataHardwareAddress :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1NetworkDeviceDataInterfaceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1NetworkDeviceDataIps :: Maybe [Text]
...
genV1NetworkPolicySpec n =
  V1NetworkPolicySpec
    ...
    <*> arbitraryReducedMaybe n -- v1NetworkPolicySpecPodSelector :: Maybe V1LabelSelector
...
instance Arbitrary V1NodeAllocatableResourceClaimStatus where
  arbitrary = sized genV1NodeAllocatableResourceClaimStatus

genV1NodeAllocatableResourceClaimStatus :: Int -> Gen V1NodeAllocatableResourceClaimStatus
genV1NodeAllocatableResourceClaimStatus n =
  V1NodeAllocatableResourceClaimStatus
    <$> arbitraryReducedMaybe n -- v1NodeAllocatableResourceClaimStatusContainers :: Maybe [Text]
    <*> arbitrary -- v1NodeAllocatableResourceClaimStatusResourceClaimName :: Text
    <*> arbitraryReduced n -- v1NodeAllocatableResourceClaimStatusResources :: (Map.Map String Quantity)
  
instance Arbitrary V1NodeAllocatableResourceMapping where
  arbitrary = sized genV1NodeAllocatableResourceMapping

genV1NodeAllocatableResourceMapping :: Int -> Gen V1NodeAllocatableResourceMapping
genV1NodeAllocatableResourceMapping n =
  V1NodeAllocatableResourceMapping
    <$> arbitraryReducedMaybe n -- v1NodeAllocatableResourceMappingAllocationMultiplier :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1NodeAllocatableResourceMappingCapacityKey :: Maybe Text
...
instance Arbitrary V1NodeFeatures where
  arbitrary = sized genV1NodeFeatures

genV1NodeFeatures :: Int -> Gen V1NodeFeatures
genV1NodeFeatures n =
  V1NodeFeatures
    <$> arbitraryReducedMaybe n -- v1NodeFeaturesSupplementalGroupsPolicy :: Maybe Bool
...
genV1NodeRuntimeHandlerFeatures n =
  V1NodeRuntimeHandlerFeatures
    ...
    <*> arbitraryReducedMaybe n -- v1NodeRuntimeHandlerFeaturesUserNamespaces :: Maybe Bool
...
genV1NodeStatus n =
  V1NodeStatus
    ...
    <*> arbitraryReducedMaybe n -- v1NodeStatusDeclaredFeatures :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1NodeStatusFeatures :: Maybe V1NodeFeatures
...
instance Arbitrary V1NodeSwapStatus where
  arbitrary = sized genV1NodeSwapStatus

genV1NodeSwapStatus :: Int -> Gen V1NodeSwapStatus
genV1NodeSwapStatus n =
  V1NodeSwapStatus
    <$> arbitraryReducedMaybe n -- v1NodeSwapStatusCapacity :: Maybe Integer
...
genV1NodeSystemInfo n =
  V1NodeSystemInfo
    ...
    <*> arbitraryReducedMaybe n -- v1NodeSystemInfoSwap :: Maybe V1NodeSwapStatus
...
instance Arbitrary V1OpaqueDeviceConfiguration where
  arbitrary = sized genV1OpaqueDeviceConfiguration

genV1OpaqueDeviceConfiguration :: Int -> Gen V1OpaqueDeviceConfiguration
genV1OpaqueDeviceConfiguration n =
  V1OpaqueDeviceConfiguration
    <$> arbitrary -- v1OpaqueDeviceConfigurationDriver :: Text
    <*> arbitraryReduced n -- v1OpaqueDeviceConfigurationParameters :: A.Value
...
instance Arbitrary V1ParentReference where
  arbitrary = sized genV1ParentReference

genV1ParentReference :: Int -> Gen V1ParentReference
genV1ParentReference n =
  V1ParentReference
    <$> arbitraryReducedMaybe n -- v1ParentReferenceGroup :: Maybe Text
    <*> arbitrary -- v1ParentReferenceName :: Text
    <*> arbitraryReducedMaybe n -- v1ParentReferenceNamespace :: Maybe Text
    <*> arbitrary -- v1ParentReferenceResource :: Text
...
instance Arbitrary V1PodCertificateProjection where
  arbitrary = sized genV1PodCertificateProjection

genV1PodCertificateProjection :: Int -> Gen V1PodCertificateProjection
genV1PodCertificateProjection n =
  V1PodCertificateProjection
    <$> arbitraryReducedMaybe n -- v1PodCertificateProjectionCertificateChainPath :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1PodCertificateProjectionCredentialBundlePath :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1PodCertificateProjectionKeyPath :: Maybe Text
    <*> arbitrary -- v1PodCertificateProjectionKeyType :: Text
    <*> arbitraryReducedMaybe n -- v1PodCertificateProjectionMaxExpirationSeconds :: Maybe Int
    <*> arbitrary -- v1PodCertificateProjectionSignerName :: Text
    <*> arbitraryReducedMaybe n -- v1PodCertificateProjectionUserAnnotations :: Maybe (Map.Map String Text)
...
genV1PodCondition n =
  V1PodCondition
    ...
    <*> arbitraryReducedMaybe n -- v1PodConditionObservedGeneration :: Maybe Integer
...
genV1PodDisruptionBudgetStatus n =
  V1PodDisruptionBudgetStatus
    ...
    <*> arbitraryReducedMaybe n -- v1PodDisruptionBudgetStatusCurrentHealthy :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1PodDisruptionBudgetStatusDesiredHealthy :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1PodDisruptionBudgetStatusDisruptedPods :: Maybe (Map.Map String DateTime)
    <*> arbitraryReducedMaybe n -- v1PodDisruptionBudgetStatusDisruptionsAllowed :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1PodDisruptionBudgetStatusExpectedPods :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1PodDisruptionBudgetStatusObservedGeneration :: Maybe Integer
  
instance Arbitrary V1PodExtendedResourceClaimStatus where
  arbitrary = sized genV1PodExtendedResourceClaimStatus

genV1PodExtendedResourceClaimStatus :: Int -> Gen V1PodExtendedResourceClaimStatus
genV1PodExtendedResourceClaimStatus n =
  V1PodExtendedResourceClaimStatus
    <$> arbitraryReduced n -- v1PodExtendedResourceClaimStatusRequestMappings :: [V1ContainerExtendedResourceRequest]
    <*> arbitrary -- v1PodExtendedResourceClaimStatusResourceClaimName :: Text
...
genV1PodFailurePolicyOnPodConditionsPattern n =
  V1PodFailurePolicyOnPodConditionsPattern
    <$> arbitraryReducedMaybe n -- v1PodFailurePolicyOnPodConditionsPatternStatus :: Maybe Text
...
genV1PodResourceClaim n =
  V1PodResourceClaim
    ...
    <*> arbitraryReducedMaybe n -- v1PodResourceClaimResourceClaimName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1PodResourceClaimResourceClaimTemplateName :: Maybe Text
...
instance Arbitrary V1PodSchedulingGroup where
  arbitrary = sized genV1PodSchedulingGroup

genV1PodSchedulingGroup :: Int -> Gen V1PodSchedulingGroup
genV1PodSchedulingGroup n =
  V1PodSchedulingGroup
    <$> arbitraryReducedMaybe n -- v1PodSchedulingGroupPodGroupName :: Maybe Text
...
genV1PodSecurityContext n =
  V1PodSecurityContext
    ...
    <*> arbitraryReducedMaybe n -- v1PodSecurityContextSeLinuxChangePolicy :: Maybe Text
    ...
    <*> arbitraryReducedMaybe n -- v1PodSecurityContextSupplementalGroupsPolicy :: Maybe Text
...
genV1PodSpec n =
  V1PodSpec
    ...
    <*> arbitraryReducedMaybe n -- v1PodSpecHostnameOverride :: Maybe Text
    ...
    <*> arbitraryReducedMaybe n -- v1PodSpecResources :: Maybe V1ResourceRequirements
    ...
    <*> arbitraryReducedMaybe n -- v1PodSpecSchedulingGroup :: Maybe V1PodSchedulingGroup
...
genV1PodStatus n =
  V1PodStatus
    <$> arbitraryReducedMaybe n -- v1PodStatusAllocatedResources :: Maybe (Map.Map String Quantity)
    ...
    <*> arbitraryReducedMaybe n -- v1PodStatusExtendedResourceClaimStatus :: Maybe V1PodExtendedResourceClaimStatus
    ...
    <*> arbitraryReducedMaybe n -- v1PodStatusNodeAllocatableResourceClaimStatuses :: Maybe [V1NodeAllocatableResourceClaimStatus]
    <*> arbitraryReducedMaybe n -- v1PodStatusNominatedNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1PodStatusObservedGeneration :: Maybe Integer
    ...
    <*> arbitraryReducedMaybe n -- v1PodStatusResources :: Maybe V1ResourceRequirements
...
genV1PriorityClass n =
  V1PriorityClass
    ...
    <*> arbitraryReducedMaybe n -- v1PriorityClassValue :: Maybe Int
...
genV1ReplicaSetStatus n =
  V1ReplicaSetStatus
    ...
    <*> arbitraryReducedMaybe n -- v1ReplicaSetStatusTerminatingReplicas :: Maybe Int
...
genV1ResourceAttributes n =
  V1ResourceAttributes
    <$> arbitraryReducedMaybe n -- v1ResourceAttributesFieldSelector :: Maybe V1FieldSelectorAttributes
    <*> arbitraryReducedMaybe n -- v1ResourceAttributesGroup :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceAttributesLabelSelector :: Maybe V1LabelSelectorAttributes
...
instance Arbitrary V1ResourceClaimConsumerReference where
  arbitrary = sized genV1ResourceClaimConsumerReference

genV1ResourceClaimConsumerReference :: Int -> Gen V1ResourceClaimConsumerReference
genV1ResourceClaimConsumerReference n =
  V1ResourceClaimConsumerReference
    <$> arbitraryReducedMaybe n -- v1ResourceClaimConsumerReferenceApiGroup :: Maybe Text
    <*> arbitrary -- v1ResourceClaimConsumerReferenceName :: Text
    <*> arbitrary -- v1ResourceClaimConsumerReferenceResource :: Text
    <*> arbitrary -- v1ResourceClaimConsumerReferenceUid :: Text
  
instance Arbitrary V1ResourceClaimList where
  arbitrary = sized genV1ResourceClaimList

genV1ResourceClaimList :: Int -> Gen V1ResourceClaimList
genV1ResourceClaimList n =
  V1ResourceClaimList
    <$> arbitraryReducedMaybe n -- v1ResourceClaimListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1ResourceClaimListItems :: [ResourceV1ResourceClaim]
    <*> arbitraryReducedMaybe n -- v1ResourceClaimListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceClaimListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1ResourceClaimSpec where
  arbitrary = sized genV1ResourceClaimSpec

genV1ResourceClaimSpec :: Int -> Gen V1ResourceClaimSpec
genV1ResourceClaimSpec n =
  V1ResourceClaimSpec
    <$> arbitraryReducedMaybe n -- v1ResourceClaimSpecDevices :: Maybe V1DeviceClaim
  
instance Arbitrary V1ResourceClaimStatus where
  arbitrary = sized genV1ResourceClaimStatus

genV1ResourceClaimStatus :: Int -> Gen V1ResourceClaimStatus
genV1ResourceClaimStatus n =
  V1ResourceClaimStatus
    <$> arbitraryReducedMaybe n -- v1ResourceClaimStatusAllocation :: Maybe V1AllocationResult
    <*> arbitraryReducedMaybe n -- v1ResourceClaimStatusDevices :: Maybe [V1AllocatedDeviceStatus]
    <*> arbitraryReducedMaybe n -- v1ResourceClaimStatusReservedFor :: Maybe [V1ResourceClaimConsumerReference]
  
instance Arbitrary V1ResourceClaimTemplate where
  arbitrary = sized genV1ResourceClaimTemplate

genV1ResourceClaimTemplate :: Int -> Gen V1ResourceClaimTemplate
genV1ResourceClaimTemplate n =
  V1ResourceClaimTemplate
    <$> arbitraryReducedMaybe n -- v1ResourceClaimTemplateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceClaimTemplateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceClaimTemplateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1ResourceClaimTemplateSpec :: V1ResourceClaimTemplateSpec
  
instance Arbitrary V1ResourceClaimTemplateList where
  arbitrary = sized genV1ResourceClaimTemplateList

genV1ResourceClaimTemplateList :: Int -> Gen V1ResourceClaimTemplateList
genV1ResourceClaimTemplateList n =
  V1ResourceClaimTemplateList
    <$> arbitraryReducedMaybe n -- v1ResourceClaimTemplateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1ResourceClaimTemplateListItems :: [V1ResourceClaimTemplate]
    <*> arbitraryReducedMaybe n -- v1ResourceClaimTemplateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceClaimTemplateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1ResourceClaimTemplateSpec where
  arbitrary = sized genV1ResourceClaimTemplateSpec

genV1ResourceClaimTemplateSpec :: Int -> Gen V1ResourceClaimTemplateSpec
genV1ResourceClaimTemplateSpec n =
  V1ResourceClaimTemplateSpec
    <$> arbitraryReducedMaybe n -- v1ResourceClaimTemplateSpecMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1ResourceClaimTemplateSpecSpec :: V1ResourceClaimSpec
...
instance Arbitrary V1ResourceHealth where
  arbitrary = sized genV1ResourceHealth

genV1ResourceHealth :: Int -> Gen V1ResourceHealth
genV1ResourceHealth n =
  V1ResourceHealth
    <$> arbitraryReducedMaybe n -- v1ResourceHealthHealth :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceHealthMessage :: Maybe Text
    <*> arbitrary -- v1ResourceHealthResourceId :: Text
...
instance Arbitrary V1ResourcePool where
  arbitrary = sized genV1ResourcePool

genV1ResourcePool :: Int -> Gen V1ResourcePool
genV1ResourcePool n =
  V1ResourcePool
    <$> arbitrary -- v1ResourcePoolGeneration :: Integer
    <*> arbitrary -- v1ResourcePoolName :: Text
    <*> arbitrary -- v1ResourcePoolResourceSliceCount :: Integer
...
genV1ResourceRequirements n =
  V1ResourceRequirements
    <$> arbitraryReducedMaybe n -- v1ResourceRequirementsClaims :: Maybe [CoreV1ResourceClaim]
...
instance Arbitrary V1ResourceSlice where
  arbitrary = sized genV1ResourceSlice

genV1ResourceSlice :: Int -> Gen V1ResourceSlice
genV1ResourceSlice n =
  V1ResourceSlice
    <$> arbitraryReducedMaybe n -- v1ResourceSliceApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceSliceKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceSliceMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1ResourceSliceSpec :: V1ResourceSliceSpec
  
instance Arbitrary V1ResourceSliceList where
  arbitrary = sized genV1ResourceSliceList

genV1ResourceSliceList :: Int -> Gen V1ResourceSliceList
genV1ResourceSliceList n =
  V1ResourceSliceList
    <$> arbitraryReducedMaybe n -- v1ResourceSliceListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1ResourceSliceListItems :: [V1ResourceSlice]
    <*> arbitraryReducedMaybe n -- v1ResourceSliceListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceSliceListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1ResourceSliceSpec where
  arbitrary = sized genV1ResourceSliceSpec

genV1ResourceSliceSpec :: Int -> Gen V1ResourceSliceSpec
genV1ResourceSliceSpec n =
  V1ResourceSliceSpec
    <$> arbitraryReducedMaybe n -- v1ResourceSliceSpecAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1ResourceSliceSpecDevices :: Maybe [V1Device]
    <*> arbitrary -- v1ResourceSliceSpecDriver :: Text
    <*> arbitraryReducedMaybe n -- v1ResourceSliceSpecNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ResourceSliceSpecNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1ResourceSliceSpecPerDeviceNodeSelection :: Maybe Bool
    <*> arbitraryReduced n -- v1ResourceSliceSpecPool :: V1ResourcePool
    <*> arbitraryReducedMaybe n -- v1ResourceSliceSpecSharedCounters :: Maybe [V1CounterSet]
  
instance Arbitrary V1ResourceStatus where
  arbitrary = sized genV1ResourceStatus

genV1ResourceStatus :: Int -> Gen V1ResourceStatus
genV1ResourceStatus n =
  V1ResourceStatus
    <$> arbitrary -- v1ResourceStatusName :: Text
    <*> arbitraryReducedMaybe n -- v1ResourceStatusResources :: Maybe [V1ResourceHealth]
...
genV1RoleRef n =
  V1RoleRef
    <$> arbitraryReducedMaybe n -- v1RoleRefApiGroup :: Maybe Text
...
instance Arbitrary V1ServiceCIDR where
  arbitrary = sized genV1ServiceCIDR

genV1ServiceCIDR :: Int -> Gen V1ServiceCIDR
genV1ServiceCIDR n =
  V1ServiceCIDR
    <$> arbitraryReducedMaybe n -- v1ServiceCIDRApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ServiceCIDRKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ServiceCIDRMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1ServiceCIDRSpec :: Maybe V1ServiceCIDRSpec
    <*> arbitraryReducedMaybe n -- v1ServiceCIDRStatus :: Maybe V1ServiceCIDRStatus
  
instance Arbitrary V1ServiceCIDRList where
  arbitrary = sized genV1ServiceCIDRList

genV1ServiceCIDRList :: Int -> Gen V1ServiceCIDRList
genV1ServiceCIDRList n =
  V1ServiceCIDRList
    <$> arbitraryReducedMaybe n -- v1ServiceCIDRListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1ServiceCIDRListItems :: [V1ServiceCIDR]
    <*> arbitraryReducedMaybe n -- v1ServiceCIDRListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1ServiceCIDRListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1ServiceCIDRSpec where
  arbitrary = sized genV1ServiceCIDRSpec

genV1ServiceCIDRSpec :: Int -> Gen V1ServiceCIDRSpec
genV1ServiceCIDRSpec n =
  V1ServiceCIDRSpec
    <$> arbitraryReducedMaybe n -- v1ServiceCIDRSpecCidrs :: Maybe [Text]
  
instance Arbitrary V1ServiceCIDRStatus where
  arbitrary = sized genV1ServiceCIDRStatus

genV1ServiceCIDRStatus :: Int -> Gen V1ServiceCIDRStatus
genV1ServiceCIDRStatus n =
  V1ServiceCIDRStatus
    <$> arbitraryReducedMaybe n -- v1ServiceCIDRStatusConditions :: Maybe [V1Condition]
...
instance Arbitrary V1ShardInfo where
  arbitrary = sized genV1ShardInfo

genV1ShardInfo :: Int -> Gen V1ShardInfo
genV1ShardInfo n =
  V1ShardInfo
    <$> arbitrary -- v1ShardInfoSelector :: Text
...
genV1StatefulSetSpec n =
  V1StatefulSetSpec
    ...
    <*> arbitraryReducedMaybe n -- v1StatefulSetSpecServiceName :: Maybe Text
...
genV1TokenRequestSpec n =
  V1TokenRequestSpec
    <$> arbitraryReducedMaybe n -- v1TokenRequestSpecAudiences :: Maybe [Text]
...
genV1TokenRequestStatus n =
  V1TokenRequestStatus
    <$> arbitraryReducedMaybe n -- v1TokenRequestStatusExpirationTimestamp :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1TokenRequestStatusToken :: Maybe Text
...
genV1TokenReviewSpec n =
  V1TokenReviewSpec
    ...
    <*> arbitrary -- v1TokenReviewSpecToken :: Text
...
genV1ValidatingAdmissionPolicyBinding n =
  V1ValidatingAdmissionPolicyBinding
    ...
    <*> arbitraryReduced n -- v1ValidatingAdmissionPolicyBindingSpec :: V1ValidatingAdmissionPolicyBindingSpec
...
genV1ValidatingAdmissionPolicyBindingSpec n =
  V1ValidatingAdmissionPolicyBindingSpec
    ...
    <*> arbitrary -- v1ValidatingAdmissionPolicyBindingSpecPolicyName :: Text
    <*> arbitrary -- v1ValidatingAdmissionPolicyBindingSpecValidationActions :: [Text]
...
genV1Volume n =
  V1Volume
    ...
    <*> arbitraryReducedMaybe n -- v1VolumeImage :: Maybe V1ImageVolumeSource
...
instance Arbitrary V1VolumeAttributesClass where
  arbitrary = sized genV1VolumeAttributesClass

genV1VolumeAttributesClass :: Int -> Gen V1VolumeAttributesClass
genV1VolumeAttributesClass n =
  V1VolumeAttributesClass
    <$> arbitraryReducedMaybe n -- v1VolumeAttributesClassApiVersion :: Maybe Text
    <*> arbitrary -- v1VolumeAttributesClassDriverName :: Text
    <*> arbitraryReducedMaybe n -- v1VolumeAttributesClassKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1VolumeAttributesClassMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1VolumeAttributesClassParameters :: Maybe (Map.Map String Text)
  
instance Arbitrary V1VolumeAttributesClassList where
  arbitrary = sized genV1VolumeAttributesClassList

genV1VolumeAttributesClassList :: Int -> Gen V1VolumeAttributesClassList
genV1VolumeAttributesClassList n =
  V1VolumeAttributesClassList
    <$> arbitraryReducedMaybe n -- v1VolumeAttributesClassListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1VolumeAttributesClassListItems :: [V1VolumeAttributesClass]
    <*> arbitraryReducedMaybe n -- v1VolumeAttributesClassListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1VolumeAttributesClassListMetadata :: Maybe V1ListMeta
...
genV1VolumeError n =
  V1VolumeError
    <$> arbitraryReducedMaybe n -- v1VolumeErrorErrorCode :: Maybe Int
...
genV1VolumeMountStatus n =
  V1VolumeMountStatus
    ...
    <*> arbitraryReducedMaybe n -- v1VolumeMountStatusVolumeStatus :: Maybe V1VolumeStatus
...
genV1VolumeProjection n =
  V1VolumeProjection
    ...
    <*> arbitraryReducedMaybe n -- v1VolumeProjectionPodCertificate :: Maybe V1PodCertificateProjection
...
instance Arbitrary V1VolumeStatus where
  arbitrary = sized genV1VolumeStatus

genV1VolumeStatus :: Int -> Gen V1VolumeStatus
genV1VolumeStatus n =
  V1VolumeStatus
    <$> arbitraryReducedMaybe n -- v1VolumeStatusImage :: Maybe V1ImageVolumeStatus
...
instance Arbitrary V1alpha1ApplyConfiguration where
  arbitrary = sized genV1alpha1ApplyConfiguration

genV1alpha1ApplyConfiguration :: Int -> Gen V1alpha1ApplyConfiguration
genV1alpha1ApplyConfiguration n =
  V1alpha1ApplyConfiguration
    <$> arbitraryReducedMaybe n -- v1alpha1ApplyConfigurationExpression :: Maybe Text
...
instance Arbitrary V1alpha1JSONPatch where
  arbitrary = sized genV1alpha1JSONPatch

genV1alpha1JSONPatch :: Int -> Gen V1alpha1JSONPatch
genV1alpha1JSONPatch n =
  V1alpha1JSONPatch
    <$> arbitraryReducedMaybe n -- v1alpha1JSONPatchExpression :: Maybe Text
...
instance Arbitrary V1alpha1MutatingAdmissionPolicy where
  arbitrary = sized genV1alpha1MutatingAdmissionPolicy

genV1alpha1MutatingAdmissionPolicy :: Int -> Gen V1alpha1MutatingAdmissionPolicy
genV1alpha1MutatingAdmissionPolicy n =
  V1alpha1MutatingAdmissionPolicy
    <$> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpec :: Maybe V1alpha1MutatingAdmissionPolicySpec
  
instance Arbitrary V1alpha1MutatingAdmissionPolicyBinding where
  arbitrary = sized genV1alpha1MutatingAdmissionPolicyBinding

genV1alpha1MutatingAdmissionPolicyBinding :: Int -> Gen V1alpha1MutatingAdmissionPolicyBinding
genV1alpha1MutatingAdmissionPolicyBinding n =
  V1alpha1MutatingAdmissionPolicyBinding
    <$> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingSpec :: Maybe V1alpha1MutatingAdmissionPolicyBindingSpec
  
instance Arbitrary V1alpha1MutatingAdmissionPolicyBindingList where
  arbitrary = sized genV1alpha1MutatingAdmissionPolicyBindingList

genV1alpha1MutatingAdmissionPolicyBindingList :: Int -> Gen V1alpha1MutatingAdmissionPolicyBindingList
genV1alpha1MutatingAdmissionPolicyBindingList n =
  V1alpha1MutatingAdmissionPolicyBindingList
    <$> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1MutatingAdmissionPolicyBindingListItems :: [V1alpha1MutatingAdmissionPolicyBinding]
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha1MutatingAdmissionPolicyBindingSpec where
  arbitrary = sized genV1alpha1MutatingAdmissionPolicyBindingSpec

genV1alpha1MutatingAdmissionPolicyBindingSpec :: Int -> Gen V1alpha1MutatingAdmissionPolicyBindingSpec
genV1alpha1MutatingAdmissionPolicyBindingSpec n =
  V1alpha1MutatingAdmissionPolicyBindingSpec
    <$> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingSpecMatchResources :: Maybe V1alpha1MatchResources
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingSpecParamRef :: Maybe V1alpha1ParamRef
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyBindingSpecPolicyName :: Maybe Text
  
instance Arbitrary V1alpha1MutatingAdmissionPolicyList where
  arbitrary = sized genV1alpha1MutatingAdmissionPolicyList

genV1alpha1MutatingAdmissionPolicyList :: Int -> Gen V1alpha1MutatingAdmissionPolicyList
genV1alpha1MutatingAdmissionPolicyList n =
  V1alpha1MutatingAdmissionPolicyList
    <$> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1MutatingAdmissionPolicyListItems :: [V1alpha1MutatingAdmissionPolicy]
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicyListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha1MutatingAdmissionPolicySpec where
  arbitrary = sized genV1alpha1MutatingAdmissionPolicySpec

genV1alpha1MutatingAdmissionPolicySpec :: Int -> Gen V1alpha1MutatingAdmissionPolicySpec
genV1alpha1MutatingAdmissionPolicySpec n =
  V1alpha1MutatingAdmissionPolicySpec
    <$> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecFailurePolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecMatchConditions :: Maybe [V1alpha1MatchCondition]
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecMatchConstraints :: Maybe V1alpha1MatchResources
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecMutations :: Maybe [V1alpha1Mutation]
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecParamKind :: Maybe V1alpha1ParamKind
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecReinvocationPolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1MutatingAdmissionPolicySpecVariables :: Maybe [V1alpha1Variable]
  
instance Arbitrary V1alpha1Mutation where
  arbitrary = sized genV1alpha1Mutation

genV1alpha1Mutation :: Int -> Gen V1alpha1Mutation
genV1alpha1Mutation n =
  V1alpha1Mutation
    <$> arbitraryReducedMaybe n -- v1alpha1MutationApplyConfiguration :: Maybe V1alpha1ApplyConfiguration
    <*> arbitraryReducedMaybe n -- v1alpha1MutationJsonPatch :: Maybe V1alpha1JSONPatch
    <*> arbitrary -- v1alpha1MutationPatchType :: Text
...
genV1alpha1ServerStorageVersion n =
  V1alpha1ServerStorageVersion
    <$> arbitrary -- v1alpha1ServerStorageVersionApiServerId :: Text
    <*> arbitrary -- v1alpha1ServerStorageVersionDecodableVersions :: [Text]
    <*> arbitrary -- v1alpha1ServerStorageVersionEncodingVersion :: Text
...
genV1alpha1StorageVersion n =
  V1alpha1StorageVersion
    ...
    <*> arbitraryReduced n -- v1alpha1StorageVersionMetadata :: V1ObjectMeta
    <*> arbitraryReducedMaybeValue n -- v1alpha1StorageVersionSpec :: Maybe A.Value
    <*> arbitraryReducedMaybe n -- v1alpha1StorageVersionStatus :: Maybe V1alpha1StorageVersionStatus
...
instance Arbitrary V1alpha2GangSchedulingPolicy where
  arbitrary = sized genV1alpha2GangSchedulingPolicy

genV1alpha2GangSchedulingPolicy :: Int -> Gen V1alpha2GangSchedulingPolicy
genV1alpha2GangSchedulingPolicy n =
  V1alpha2GangSchedulingPolicy
    <$> arbitrary -- v1alpha2GangSchedulingPolicyMinCount :: Int
  
instance Arbitrary V1alpha2LeaseCandidate where
  arbitrary = sized genV1alpha2LeaseCandidate

genV1alpha2LeaseCandidate :: Int -> Gen V1alpha2LeaseCandidate
genV1alpha2LeaseCandidate n =
  V1alpha2LeaseCandidate
    <$> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha2LeaseCandidateSpec :: V1alpha2LeaseCandidateSpec
  
instance Arbitrary V1alpha2LeaseCandidateList where
  arbitrary = sized genV1alpha2LeaseCandidateList

genV1alpha2LeaseCandidateList :: Int -> Gen V1alpha2LeaseCandidateList
genV1alpha2LeaseCandidateList n =
  V1alpha2LeaseCandidateList
    <$> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2LeaseCandidateListItems :: [V1alpha2LeaseCandidate]
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha2LeaseCandidateSpec where
  arbitrary = sized genV1alpha2LeaseCandidateSpec

genV1alpha2LeaseCandidateSpec :: Int -> Gen V1alpha2LeaseCandidateSpec
genV1alpha2LeaseCandidateSpec n =
  V1alpha2LeaseCandidateSpec
    <$> arbitrary -- v1alpha2LeaseCandidateSpecBinaryVersion :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateSpecEmulationVersion :: Maybe Text
    <*> arbitrary -- v1alpha2LeaseCandidateSpecLeaseName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateSpecPingTime :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateSpecRenewTime :: Maybe DateTime
    <*> arbitrary -- v1alpha2LeaseCandidateSpecStrategy :: Text
  
instance Arbitrary V1alpha2PodGroup where
  arbitrary = sized genV1alpha2PodGroup

genV1alpha2PodGroup :: Int -> Gen V1alpha2PodGroup
genV1alpha2PodGroup n =
  V1alpha2PodGroup
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha2PodGroupSpec :: V1alpha2PodGroupSpec
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupStatus :: Maybe V1alpha2PodGroupStatus
  
instance Arbitrary V1alpha2PodGroupList where
  arbitrary = sized genV1alpha2PodGroupList

genV1alpha2PodGroupList :: Int -> Gen V1alpha2PodGroupList
genV1alpha2PodGroupList n =
  V1alpha2PodGroupList
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2PodGroupListItems :: [V1alpha2PodGroup]
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha2PodGroupResourceClaim where
  arbitrary = sized genV1alpha2PodGroupResourceClaim

genV1alpha2PodGroupResourceClaim :: Int -> Gen V1alpha2PodGroupResourceClaim
genV1alpha2PodGroupResourceClaim n =
  V1alpha2PodGroupResourceClaim
    <$> arbitrary -- v1alpha2PodGroupResourceClaimName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupResourceClaimResourceClaimName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupResourceClaimResourceClaimTemplateName :: Maybe Text
  
instance Arbitrary V1alpha2PodGroupResourceClaimStatus where
  arbitrary = sized genV1alpha2PodGroupResourceClaimStatus

genV1alpha2PodGroupResourceClaimStatus :: Int -> Gen V1alpha2PodGroupResourceClaimStatus
genV1alpha2PodGroupResourceClaimStatus n =
  V1alpha2PodGroupResourceClaimStatus
    <$> arbitrary -- v1alpha2PodGroupResourceClaimStatusName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupResourceClaimStatusResourceClaimName :: Maybe Text
  
instance Arbitrary V1alpha2PodGroupSchedulingConstraints where
  arbitrary = sized genV1alpha2PodGroupSchedulingConstraints

genV1alpha2PodGroupSchedulingConstraints :: Int -> Gen V1alpha2PodGroupSchedulingConstraints
genV1alpha2PodGroupSchedulingConstraints n =
  V1alpha2PodGroupSchedulingConstraints
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupSchedulingConstraintsTopology :: Maybe [V1alpha2TopologyConstraint]
  
instance Arbitrary V1alpha2PodGroupSchedulingPolicy where
  arbitrary = sized genV1alpha2PodGroupSchedulingPolicy

genV1alpha2PodGroupSchedulingPolicy :: Int -> Gen V1alpha2PodGroupSchedulingPolicy
genV1alpha2PodGroupSchedulingPolicy n =
  V1alpha2PodGroupSchedulingPolicy
    <$> arbitraryReducedMaybeValue n -- v1alpha2PodGroupSchedulingPolicyBasic :: Maybe A.Value
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupSchedulingPolicyGang :: Maybe V1alpha2GangSchedulingPolicy
  
instance Arbitrary V1alpha2PodGroupSpec where
  arbitrary = sized genV1alpha2PodGroupSpec

genV1alpha2PodGroupSpec :: Int -> Gen V1alpha2PodGroupSpec
genV1alpha2PodGroupSpec n =
  V1alpha2PodGroupSpec
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupSpecDisruptionMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupSpecPodGroupTemplateRef :: Maybe V1alpha2PodGroupTemplateReference
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupSpecPriority :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupSpecPriorityClassName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupSpecResourceClaims :: Maybe [V1alpha2PodGroupResourceClaim]
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupSpecSchedulingConstraints :: Maybe V1alpha2PodGroupSchedulingConstraints
    <*> arbitraryReduced n -- v1alpha2PodGroupSpecSchedulingPolicy :: V1alpha2PodGroupSchedulingPolicy
  
instance Arbitrary V1alpha2PodGroupStatus where
  arbitrary = sized genV1alpha2PodGroupStatus

genV1alpha2PodGroupStatus :: Int -> Gen V1alpha2PodGroupStatus
genV1alpha2PodGroupStatus n =
  V1alpha2PodGroupStatus
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupStatusResourceClaimStatuses :: Maybe [V1alpha2PodGroupResourceClaimStatus]
  
instance Arbitrary V1alpha2PodGroupTemplate where
  arbitrary = sized genV1alpha2PodGroupTemplate

genV1alpha2PodGroupTemplate :: Int -> Gen V1alpha2PodGroupTemplate
genV1alpha2PodGroupTemplate n =
  V1alpha2PodGroupTemplate
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupTemplateDisruptionMode :: Maybe Text
    <*> arbitrary -- v1alpha2PodGroupTemplateName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupTemplatePriority :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupTemplatePriorityClassName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupTemplateResourceClaims :: Maybe [V1alpha2PodGroupResourceClaim]
    <*> arbitraryReducedMaybe n -- v1alpha2PodGroupTemplateSchedulingConstraints :: Maybe V1alpha2PodGroupSchedulingConstraints
    <*> arbitraryReduced n -- v1alpha2PodGroupTemplateSchedulingPolicy :: V1alpha2PodGroupSchedulingPolicy
  
instance Arbitrary V1alpha2PodGroupTemplateReference where
  arbitrary = sized genV1alpha2PodGroupTemplateReference

genV1alpha2PodGroupTemplateReference :: Int -> Gen V1alpha2PodGroupTemplateReference
genV1alpha2PodGroupTemplateReference n =
  V1alpha2PodGroupTemplateReference
    <$> arbitraryReducedMaybe n -- v1alpha2PodGroupTemplateReferenceWorkload :: Maybe V1alpha2WorkloadPodGroupTemplateReference
  
instance Arbitrary V1alpha2TopologyConstraint where
  arbitrary = sized genV1alpha2TopologyConstraint

genV1alpha2TopologyConstraint :: Int -> Gen V1alpha2TopologyConstraint
genV1alpha2TopologyConstraint n =
  V1alpha2TopologyConstraint
    <$> arbitrary -- v1alpha2TopologyConstraintKey :: Text
  
instance Arbitrary V1alpha2TypedLocalObjectReference where
  arbitrary = sized genV1alpha2TypedLocalObjectReference

genV1alpha2TypedLocalObjectReference :: Int -> Gen V1alpha2TypedLocalObjectReference
genV1alpha2TypedLocalObjectReference n =
  V1alpha2TypedLocalObjectReference
    <$> arbitraryReducedMaybe n -- v1alpha2TypedLocalObjectReferenceApiGroup :: Maybe Text
    <*> arbitrary -- v1alpha2TypedLocalObjectReferenceKind :: Text
    <*> arbitrary -- v1alpha2TypedLocalObjectReferenceName :: Text
  
instance Arbitrary V1alpha2Workload where
  arbitrary = sized genV1alpha2Workload

genV1alpha2Workload :: Int -> Gen V1alpha2Workload
genV1alpha2Workload n =
  V1alpha2Workload
    <$> arbitraryReducedMaybe n -- v1alpha2WorkloadApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2WorkloadKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2WorkloadMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha2WorkloadSpec :: V1alpha2WorkloadSpec
  
instance Arbitrary V1alpha2WorkloadList where
  arbitrary = sized genV1alpha2WorkloadList

genV1alpha2WorkloadList :: Int -> Gen V1alpha2WorkloadList
genV1alpha2WorkloadList n =
  V1alpha2WorkloadList
    <$> arbitraryReducedMaybe n -- v1alpha2WorkloadListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha2WorkloadListItems :: [V1alpha2Workload]
    <*> arbitraryReducedMaybe n -- v1alpha2WorkloadListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha2WorkloadListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha2WorkloadPodGroupTemplateReference where
  arbitrary = sized genV1alpha2WorkloadPodGroupTemplateReference

genV1alpha2WorkloadPodGroupTemplateReference :: Int -> Gen V1alpha2WorkloadPodGroupTemplateReference
genV1alpha2WorkloadPodGroupTemplateReference n =
  V1alpha2WorkloadPodGroupTemplateReference
    <$> arbitrary -- v1alpha2WorkloadPodGroupTemplateReferencePodGroupTemplateName :: Text
    <*> arbitrary -- v1alpha2WorkloadPodGroupTemplateReferenceWorkloadName :: Text
  
instance Arbitrary V1alpha2WorkloadSpec where
  arbitrary = sized genV1alpha2WorkloadSpec

genV1alpha2WorkloadSpec :: Int -> Gen V1alpha2WorkloadSpec
genV1alpha2WorkloadSpec n =
  V1alpha2WorkloadSpec
    <$> arbitraryReducedMaybe n -- v1alpha2WorkloadSpecControllerRef :: Maybe V1alpha2TypedLocalObjectReference
    <*> arbitraryReduced n -- v1alpha2WorkloadSpecPodGroupTemplates :: [V1alpha2PodGroupTemplate]
  
instance Arbitrary V1alpha3DeviceTaint where
  arbitrary = sized genV1alpha3DeviceTaint

genV1alpha3DeviceTaint :: Int -> Gen V1alpha3DeviceTaint
genV1alpha3DeviceTaint n =
  V1alpha3DeviceTaint
    <$> arbitrary -- v1alpha3DeviceTaintEffect :: Text
    <*> arbitrary -- v1alpha3DeviceTaintKey :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintTimeAdded :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintValue :: Maybe Text
  
instance Arbitrary V1alpha3DeviceTaintRule where
  arbitrary = sized genV1alpha3DeviceTaintRule

genV1alpha3DeviceTaintRule :: Int -> Gen V1alpha3DeviceTaintRule
genV1alpha3DeviceTaintRule n =
  V1alpha3DeviceTaintRule
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3DeviceTaintRuleSpec :: V1alpha3DeviceTaintRuleSpec
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleStatus :: Maybe V1alpha3DeviceTaintRuleStatus
  
instance Arbitrary V1alpha3DeviceTaintRuleList where
  arbitrary = sized genV1alpha3DeviceTaintRuleList

genV1alpha3DeviceTaintRuleList :: Int -> Gen V1alpha3DeviceTaintRuleList
genV1alpha3DeviceTaintRuleList n =
  V1alpha3DeviceTaintRuleList
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3DeviceTaintRuleListItems :: [V1alpha3DeviceTaintRule]
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3DeviceTaintRuleSpec where
  arbitrary = sized genV1alpha3DeviceTaintRuleSpec

genV1alpha3DeviceTaintRuleSpec :: Int -> Gen V1alpha3DeviceTaintRuleSpec
genV1alpha3DeviceTaintRuleSpec n =
  V1alpha3DeviceTaintRuleSpec
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleSpecDeviceSelector :: Maybe V1alpha3DeviceTaintSelector
    <*> arbitraryReduced n -- v1alpha3DeviceTaintRuleSpecTaint :: V1alpha3DeviceTaint
  
instance Arbitrary V1alpha3DeviceTaintRuleStatus where
  arbitrary = sized genV1alpha3DeviceTaintRuleStatus

genV1alpha3DeviceTaintRuleStatus :: Int -> Gen V1alpha3DeviceTaintRuleStatus
genV1alpha3DeviceTaintRuleStatus n =
  V1alpha3DeviceTaintRuleStatus
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceTaintRuleStatusConditions :: Maybe [V1Condition]
  
instance Arbitrary V1alpha3DeviceTaintSelector where
  arbitrary = sized genV1alpha3DeviceTaintSelector

genV1alpha3DeviceTaintSelector :: Int -> Gen V1alpha3DeviceTaintSelector
genV1alpha3DeviceTaintSelector n =
  V1alpha3DeviceTaintSelector
    <$> arbitraryReducedMaybe n -- v1alpha3DeviceTaintSelectorDevice :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintSelectorDriver :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3DeviceTaintSelectorPool :: Maybe Text
  
instance Arbitrary V1alpha3PoolStatus where
  arbitrary = sized genV1alpha3PoolStatus

genV1alpha3PoolStatus :: Int -> Gen V1alpha3PoolStatus
genV1alpha3PoolStatus n =
  V1alpha3PoolStatus
    <$> arbitraryReducedMaybe n -- v1alpha3PoolStatusAllocatedDevices :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha3PoolStatusAvailableDevices :: Maybe Int
    <*> arbitrary -- v1alpha3PoolStatusDriver :: Text
    <*> arbitrary -- v1alpha3PoolStatusGeneration :: Integer
    <*> arbitraryReducedMaybe n -- v1alpha3PoolStatusNodeName :: Maybe Text
    <*> arbitrary -- v1alpha3PoolStatusPoolName :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3PoolStatusResourceSliceCount :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha3PoolStatusTotalDevices :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha3PoolStatusUnavailableDevices :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha3PoolStatusValidationError :: Maybe Text
  
instance Arbitrary V1alpha3ResourcePoolStatusRequest where
  arbitrary = sized genV1alpha3ResourcePoolStatusRequest

genV1alpha3ResourcePoolStatusRequest :: Int -> Gen V1alpha3ResourcePoolStatusRequest
genV1alpha3ResourcePoolStatusRequest n =
  V1alpha3ResourcePoolStatusRequest
    <$> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestKind :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3ResourcePoolStatusRequestMetadata :: V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha3ResourcePoolStatusRequestSpec :: V1alpha3ResourcePoolStatusRequestSpec
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestStatus :: Maybe V1alpha3ResourcePoolStatusRequestStatus
  
instance Arbitrary V1alpha3ResourcePoolStatusRequestList where
  arbitrary = sized genV1alpha3ResourcePoolStatusRequestList

genV1alpha3ResourcePoolStatusRequestList :: Int -> Gen V1alpha3ResourcePoolStatusRequestList
genV1alpha3ResourcePoolStatusRequestList n =
  V1alpha3ResourcePoolStatusRequestList
    <$> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha3ResourcePoolStatusRequestListItems :: [V1alpha3ResourcePoolStatusRequest]
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha3ResourcePoolStatusRequestSpec where
  arbitrary = sized genV1alpha3ResourcePoolStatusRequestSpec

genV1alpha3ResourcePoolStatusRequestSpec :: Int -> Gen V1alpha3ResourcePoolStatusRequestSpec
genV1alpha3ResourcePoolStatusRequestSpec n =
  V1alpha3ResourcePoolStatusRequestSpec
    <$> arbitrary -- v1alpha3ResourcePoolStatusRequestSpecDriver :: Text
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestSpecLimit :: Maybe Int
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestSpecPoolName :: Maybe Text
  
instance Arbitrary V1alpha3ResourcePoolStatusRequestStatus where
  arbitrary = sized genV1alpha3ResourcePoolStatusRequestStatus

genV1alpha3ResourcePoolStatusRequestStatus :: Int -> Gen V1alpha3ResourcePoolStatusRequestStatus
genV1alpha3ResourcePoolStatusRequestStatus n =
  V1alpha3ResourcePoolStatusRequestStatus
    <$> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestStatusConditions :: Maybe [V1Condition]
    <*> arbitrary -- v1alpha3ResourcePoolStatusRequestStatusPoolCount :: Int
    <*> arbitraryReducedMaybe n -- v1alpha3ResourcePoolStatusRequestStatusPools :: Maybe [V1alpha3PoolStatus]
  
instance Arbitrary V1beta1AllocatedDeviceStatus where
  arbitrary = sized genV1beta1AllocatedDeviceStatus

genV1beta1AllocatedDeviceStatus :: Int -> Gen V1beta1AllocatedDeviceStatus
genV1beta1AllocatedDeviceStatus n =
  V1beta1AllocatedDeviceStatus
    <$> arbitraryReducedMaybe n -- v1beta1AllocatedDeviceStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybeValue n -- v1beta1AllocatedDeviceStatusData :: Maybe A.Value
    <*> arbitrary -- v1beta1AllocatedDeviceStatusDevice :: Text
    <*> arbitrary -- v1beta1AllocatedDeviceStatusDriver :: Text
    <*> arbitraryReducedMaybe n -- v1beta1AllocatedDeviceStatusNetworkData :: Maybe V1beta1NetworkDeviceData
    <*> arbitrary -- v1beta1AllocatedDeviceStatusPool :: Text
    <*> arbitraryReducedMaybe n -- v1beta1AllocatedDeviceStatusShareId :: Maybe Text
  
instance Arbitrary V1beta1AllocationResult where
  arbitrary = sized genV1beta1AllocationResult

genV1beta1AllocationResult :: Int -> Gen V1beta1AllocationResult
genV1beta1AllocationResult n =
  V1beta1AllocationResult
    <$> arbitraryReducedMaybe n -- v1beta1AllocationResultAllocationTimestamp :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta1AllocationResultDevices :: Maybe V1beta1DeviceAllocationResult
    <*> arbitraryReducedMaybe n -- v1beta1AllocationResultNodeSelector :: Maybe V1NodeSelector
  
instance Arbitrary V1beta1ApplyConfiguration where
  arbitrary = sized genV1beta1ApplyConfiguration

genV1beta1ApplyConfiguration :: Int -> Gen V1beta1ApplyConfiguration
genV1beta1ApplyConfiguration n =
  V1beta1ApplyConfiguration
    <$> arbitraryReducedMaybe n -- v1beta1ApplyConfigurationExpression :: Maybe Text
  
instance Arbitrary V1beta1BasicDevice where
  arbitrary = sized genV1beta1BasicDevice

genV1beta1BasicDevice :: Int -> Gen V1beta1BasicDevice
genV1beta1BasicDevice n =
  V1beta1BasicDevice
    <$> arbitraryReducedMaybe n -- v1beta1BasicDeviceAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceAllowMultipleAllocations :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceAttributes :: Maybe (Map.Map String V1beta1DeviceAttribute)
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceBindingConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceBindingFailureConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceBindsToNode :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceCapacity :: Maybe (Map.Map String V1beta1DeviceCapacity)
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceConsumesCounters :: Maybe [V1beta1DeviceCounterConsumption]
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceNodeAllocatableResourceMappings :: Maybe (Map.Map String V1beta1NodeAllocatableResourceMapping)
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1beta1BasicDeviceTaints :: Maybe [V1beta1DeviceTaint]
  
instance Arbitrary V1beta1CELDeviceSelector where
  arbitrary = sized genV1beta1CELDeviceSelector

genV1beta1CELDeviceSelector :: Int -> Gen V1beta1CELDeviceSelector
genV1beta1CELDeviceSelector n =
  V1beta1CELDeviceSelector
    <$> arbitrary -- v1beta1CELDeviceSelectorExpression :: Text
  
instance Arbitrary V1beta1CapacityRequestPolicy where
  arbitrary = sized genV1beta1CapacityRequestPolicy

genV1beta1CapacityRequestPolicy :: Int -> Gen V1beta1CapacityRequestPolicy
genV1beta1CapacityRequestPolicy n =
  V1beta1CapacityRequestPolicy
    <$> arbitraryReducedMaybe n -- v1beta1CapacityRequestPolicyDefault :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1beta1CapacityRequestPolicyValidRange :: Maybe V1beta1CapacityRequestPolicyRange
    <*> arbitraryReducedMaybe n -- v1beta1CapacityRequestPolicyValidValues :: Maybe [Quantity]
  
instance Arbitrary V1beta1CapacityRequestPolicyRange where
  arbitrary = sized genV1beta1CapacityRequestPolicyRange

genV1beta1CapacityRequestPolicyRange :: Int -> Gen V1beta1CapacityRequestPolicyRange
genV1beta1CapacityRequestPolicyRange n =
  V1beta1CapacityRequestPolicyRange
    <$> arbitraryReducedMaybe n -- v1beta1CapacityRequestPolicyRangeMax :: Maybe Quantity
    <*> arbitraryReduced n -- v1beta1CapacityRequestPolicyRangeMin :: Quantity
    <*> arbitraryReducedMaybe n -- v1beta1CapacityRequestPolicyRangeStep :: Maybe Quantity
  
instance Arbitrary V1beta1CapacityRequirements where
  arbitrary = sized genV1beta1CapacityRequirements

genV1beta1CapacityRequirements :: Int -> Gen V1beta1CapacityRequirements
genV1beta1CapacityRequirements n =
  V1beta1CapacityRequirements
    <$> arbitraryReducedMaybe n -- v1beta1CapacityRequirementsRequests :: Maybe (Map.Map String Quantity)
  
instance Arbitrary V1beta1ClusterTrustBundle where
  arbitrary = sized genV1beta1ClusterTrustBundle

genV1beta1ClusterTrustBundle :: Int -> Gen V1beta1ClusterTrustBundle
genV1beta1ClusterTrustBundle n =
  V1beta1ClusterTrustBundle
    <$> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1ClusterTrustBundleSpec :: V1beta1ClusterTrustBundleSpec
  
instance Arbitrary V1beta1ClusterTrustBundleList where
  arbitrary = sized genV1beta1ClusterTrustBundleList

genV1beta1ClusterTrustBundleList :: Int -> Gen V1beta1ClusterTrustBundleList
genV1beta1ClusterTrustBundleList n =
  V1beta1ClusterTrustBundleList
    <$> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1ClusterTrustBundleListItems :: [V1beta1ClusterTrustBundle]
    <*> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1ClusterTrustBundleSpec where
  arbitrary = sized genV1beta1ClusterTrustBundleSpec

genV1beta1ClusterTrustBundleSpec :: Int -> Gen V1beta1ClusterTrustBundleSpec
genV1beta1ClusterTrustBundleSpec n =
  V1beta1ClusterTrustBundleSpec
    <$> arbitraryReducedMaybe n -- v1beta1ClusterTrustBundleSpecSignerName :: Maybe Text
    <*> arbitrary -- v1beta1ClusterTrustBundleSpecTrustBundle :: Text
  
instance Arbitrary V1beta1Counter where
  arbitrary = sized genV1beta1Counter

genV1beta1Counter :: Int -> Gen V1beta1Counter
genV1beta1Counter n =
  V1beta1Counter
    <$> arbitraryReduced n -- v1beta1CounterValue :: Quantity
  
instance Arbitrary V1beta1CounterSet where
  arbitrary = sized genV1beta1CounterSet

genV1beta1CounterSet :: Int -> Gen V1beta1CounterSet
genV1beta1CounterSet n =
  V1beta1CounterSet
    <$> arbitraryReduced n -- v1beta1CounterSetCounters :: (Map.Map String V1beta1Counter)
    <*> arbitrary -- v1beta1CounterSetName :: Text
  
instance Arbitrary V1beta1Device where
  arbitrary = sized genV1beta1Device

genV1beta1Device :: Int -> Gen V1beta1Device
genV1beta1Device n =
  V1beta1Device
    <$> arbitraryReducedMaybe n -- v1beta1DeviceBasic :: Maybe V1beta1BasicDevice
    <*> arbitrary -- v1beta1DeviceName :: Text
  
instance Arbitrary V1beta1DeviceAllocationConfiguration where
  arbitrary = sized genV1beta1DeviceAllocationConfiguration

genV1beta1DeviceAllocationConfiguration :: Int -> Gen V1beta1DeviceAllocationConfiguration
genV1beta1DeviceAllocationConfiguration n =
  V1beta1DeviceAllocationConfiguration
    <$> arbitraryReducedMaybe n -- v1beta1DeviceAllocationConfigurationOpaque :: Maybe V1beta1OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAllocationConfigurationRequests :: Maybe [Text]
    <*> arbitrary -- v1beta1DeviceAllocationConfigurationSource :: Text
  
instance Arbitrary V1beta1DeviceAllocationResult where
  arbitrary = sized genV1beta1DeviceAllocationResult

genV1beta1DeviceAllocationResult :: Int -> Gen V1beta1DeviceAllocationResult
genV1beta1DeviceAllocationResult n =
  V1beta1DeviceAllocationResult
    <$> arbitraryReducedMaybe n -- v1beta1DeviceAllocationResultConfig :: Maybe [V1beta1DeviceAllocationConfiguration]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAllocationResultResults :: Maybe [V1beta1DeviceRequestAllocationResult]
  
instance Arbitrary V1beta1DeviceAttribute where
  arbitrary = sized genV1beta1DeviceAttribute

genV1beta1DeviceAttribute :: Int -> Gen V1beta1DeviceAttribute
genV1beta1DeviceAttribute n =
  V1beta1DeviceAttribute
    <$> arbitraryReducedMaybe n -- v1beta1DeviceAttributeBool :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeBools :: Maybe [Bool]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeInt :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeInts :: Maybe [Integer]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeString :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeStrings :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceAttributeVersions :: Maybe [Text]
  
instance Arbitrary V1beta1DeviceCapacity where
  arbitrary = sized genV1beta1DeviceCapacity

genV1beta1DeviceCapacity :: Int -> Gen V1beta1DeviceCapacity
genV1beta1DeviceCapacity n =
  V1beta1DeviceCapacity
    <$> arbitraryReducedMaybe n -- v1beta1DeviceCapacityRequestPolicy :: Maybe V1beta1CapacityRequestPolicy
    <*> arbitraryReduced n -- v1beta1DeviceCapacityValue :: Quantity
  
instance Arbitrary V1beta1DeviceClaim where
  arbitrary = sized genV1beta1DeviceClaim

genV1beta1DeviceClaim :: Int -> Gen V1beta1DeviceClaim
genV1beta1DeviceClaim n =
  V1beta1DeviceClaim
    <$> arbitraryReducedMaybe n -- v1beta1DeviceClaimConfig :: Maybe [V1beta1DeviceClaimConfiguration]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClaimConstraints :: Maybe [V1beta1DeviceConstraint]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClaimRequests :: Maybe [V1beta1DeviceRequest]
  
instance Arbitrary V1beta1DeviceClaimConfiguration where
  arbitrary = sized genV1beta1DeviceClaimConfiguration

genV1beta1DeviceClaimConfiguration :: Int -> Gen V1beta1DeviceClaimConfiguration
genV1beta1DeviceClaimConfiguration n =
  V1beta1DeviceClaimConfiguration
    <$> arbitraryReducedMaybe n -- v1beta1DeviceClaimConfigurationOpaque :: Maybe V1beta1OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClaimConfigurationRequests :: Maybe [Text]
  
instance Arbitrary V1beta1DeviceClass where
  arbitrary = sized genV1beta1DeviceClass

genV1beta1DeviceClass :: Int -> Gen V1beta1DeviceClass
genV1beta1DeviceClass n =
  V1beta1DeviceClass
    <$> arbitraryReducedMaybe n -- v1beta1DeviceClassApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClassKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClassMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1DeviceClassSpec :: V1beta1DeviceClassSpec
  
instance Arbitrary V1beta1DeviceClassConfiguration where
  arbitrary = sized genV1beta1DeviceClassConfiguration

genV1beta1DeviceClassConfiguration :: Int -> Gen V1beta1DeviceClassConfiguration
genV1beta1DeviceClassConfiguration n =
  V1beta1DeviceClassConfiguration
    <$> arbitraryReducedMaybe n -- v1beta1DeviceClassConfigurationOpaque :: Maybe V1beta1OpaqueDeviceConfiguration
  
instance Arbitrary V1beta1DeviceClassList where
  arbitrary = sized genV1beta1DeviceClassList

genV1beta1DeviceClassList :: Int -> Gen V1beta1DeviceClassList
genV1beta1DeviceClassList n =
  V1beta1DeviceClassList
    <$> arbitraryReducedMaybe n -- v1beta1DeviceClassListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1DeviceClassListItems :: [V1beta1DeviceClass]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClassListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClassListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1DeviceClassSpec where
  arbitrary = sized genV1beta1DeviceClassSpec

genV1beta1DeviceClassSpec :: Int -> Gen V1beta1DeviceClassSpec
genV1beta1DeviceClassSpec n =
  V1beta1DeviceClassSpec
    <$> arbitraryReducedMaybe n -- v1beta1DeviceClassSpecConfig :: Maybe [V1beta1DeviceClassConfiguration]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClassSpecExtendedResourceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceClassSpecSelectors :: Maybe [V1beta1DeviceSelector]
  
instance Arbitrary V1beta1DeviceConstraint where
  arbitrary = sized genV1beta1DeviceConstraint

genV1beta1DeviceConstraint :: Int -> Gen V1beta1DeviceConstraint
genV1beta1DeviceConstraint n =
  V1beta1DeviceConstraint
    <$> arbitraryReducedMaybe n -- v1beta1DeviceConstraintDistinctAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceConstraintMatchAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceConstraintRequests :: Maybe [Text]
  
instance Arbitrary V1beta1DeviceCounterConsumption where
  arbitrary = sized genV1beta1DeviceCounterConsumption

genV1beta1DeviceCounterConsumption :: Int -> Gen V1beta1DeviceCounterConsumption
genV1beta1DeviceCounterConsumption n =
  V1beta1DeviceCounterConsumption
    <$> arbitrary -- v1beta1DeviceCounterConsumptionCounterSet :: Text
    <*> arbitraryReduced n -- v1beta1DeviceCounterConsumptionCounters :: (Map.Map String V1beta1Counter)
  
instance Arbitrary V1beta1DeviceRequest where
  arbitrary = sized genV1beta1DeviceRequest

genV1beta1DeviceRequest :: Int -> Gen V1beta1DeviceRequest
genV1beta1DeviceRequest n =
  V1beta1DeviceRequest
    <$> arbitraryReducedMaybe n -- v1beta1DeviceRequestAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestCapacity :: Maybe V1beta1CapacityRequirements
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestCount :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestDeviceClassName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestFirstAvailable :: Maybe [V1beta1DeviceSubRequest]
    <*> arbitrary -- v1beta1DeviceRequestName :: Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestSelectors :: Maybe [V1beta1DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestTolerations :: Maybe [V1beta1DeviceToleration]
  
instance Arbitrary V1beta1DeviceRequestAllocationResult where
  arbitrary = sized genV1beta1DeviceRequestAllocationResult

genV1beta1DeviceRequestAllocationResult :: Int -> Gen V1beta1DeviceRequestAllocationResult
genV1beta1DeviceRequestAllocationResult n =
  V1beta1DeviceRequestAllocationResult
    <$> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationResultAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationResultBindingConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationResultBindingFailureConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationResultConsumedCapacity :: Maybe (Map.Map String Quantity)
    <*> arbitrary -- v1beta1DeviceRequestAllocationResultDevice :: Text
    <*> arbitrary -- v1beta1DeviceRequestAllocationResultDriver :: Text
    <*> arbitrary -- v1beta1DeviceRequestAllocationResultPool :: Text
    <*> arbitrary -- v1beta1DeviceRequestAllocationResultRequest :: Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationResultShareId :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceRequestAllocationResultTolerations :: Maybe [V1beta1DeviceToleration]
  
instance Arbitrary V1beta1DeviceSelector where
  arbitrary = sized genV1beta1DeviceSelector

genV1beta1DeviceSelector :: Int -> Gen V1beta1DeviceSelector
genV1beta1DeviceSelector n =
  V1beta1DeviceSelector
    <$> arbitraryReducedMaybe n -- v1beta1DeviceSelectorCel :: Maybe V1beta1CELDeviceSelector
  
instance Arbitrary V1beta1DeviceSubRequest where
  arbitrary = sized genV1beta1DeviceSubRequest

genV1beta1DeviceSubRequest :: Int -> Gen V1beta1DeviceSubRequest
genV1beta1DeviceSubRequest n =
  V1beta1DeviceSubRequest
    <$> arbitraryReducedMaybe n -- v1beta1DeviceSubRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceSubRequestCapacity :: Maybe V1beta1CapacityRequirements
    <*> arbitraryReducedMaybe n -- v1beta1DeviceSubRequestCount :: Maybe Integer
    <*> arbitrary -- v1beta1DeviceSubRequestDeviceClassName :: Text
    <*> arbitrary -- v1beta1DeviceSubRequestName :: Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceSubRequestSelectors :: Maybe [V1beta1DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1beta1DeviceSubRequestTolerations :: Maybe [V1beta1DeviceToleration]
  
instance Arbitrary V1beta1DeviceTaint where
  arbitrary = sized genV1beta1DeviceTaint

genV1beta1DeviceTaint :: Int -> Gen V1beta1DeviceTaint
genV1beta1DeviceTaint n =
  V1beta1DeviceTaint
    <$> arbitrary -- v1beta1DeviceTaintEffect :: Text
    <*> arbitrary -- v1beta1DeviceTaintKey :: Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceTaintTimeAdded :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta1DeviceTaintValue :: Maybe Text
  
instance Arbitrary V1beta1DeviceToleration where
  arbitrary = sized genV1beta1DeviceToleration

genV1beta1DeviceToleration :: Int -> Gen V1beta1DeviceToleration
genV1beta1DeviceToleration n =
  V1beta1DeviceToleration
    <$> arbitraryReducedMaybe n -- v1beta1DeviceTolerationEffect :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceTolerationKey :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceTolerationOperator :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1DeviceTolerationTolerationSeconds :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1beta1DeviceTolerationValue :: Maybe Text
  
instance Arbitrary V1beta1IPAddress where
  arbitrary = sized genV1beta1IPAddress

genV1beta1IPAddress :: Int -> Gen V1beta1IPAddress
genV1beta1IPAddress n =
  V1beta1IPAddress
    <$> arbitraryReducedMaybe n -- v1beta1IPAddressApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1IPAddressKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1IPAddressMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1IPAddressSpec :: V1beta1IPAddressSpec
  
instance Arbitrary V1beta1IPAddressList where
  arbitrary = sized genV1beta1IPAddressList

genV1beta1IPAddressList :: Int -> Gen V1beta1IPAddressList
genV1beta1IPAddressList n =
  V1beta1IPAddressList
    <$> arbitraryReducedMaybe n -- v1beta1IPAddressListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1IPAddressListItems :: [V1beta1IPAddress]
    <*> arbitraryReducedMaybe n -- v1beta1IPAddressListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1IPAddressListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1IPAddressSpec where
  arbitrary = sized genV1beta1IPAddressSpec

genV1beta1IPAddressSpec :: Int -> Gen V1beta1IPAddressSpec
genV1beta1IPAddressSpec n =
  V1beta1IPAddressSpec
    <$> arbitraryReduced n -- v1beta1IPAddressSpecParentRef :: V1beta1ParentReference
  
instance Arbitrary V1beta1JSONPatch where
  arbitrary = sized genV1beta1JSONPatch

genV1beta1JSONPatch :: Int -> Gen V1beta1JSONPatch
genV1beta1JSONPatch n =
  V1beta1JSONPatch
    <$> arbitraryReducedMaybe n -- v1beta1JSONPatchExpression :: Maybe Text
  
instance Arbitrary V1beta1LeaseCandidate where
  arbitrary = sized genV1beta1LeaseCandidate

genV1beta1LeaseCandidate :: Int -> Gen V1beta1LeaseCandidate
genV1beta1LeaseCandidate n =
  V1beta1LeaseCandidate
    <$> arbitraryReducedMaybe n -- v1beta1LeaseCandidateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1LeaseCandidateSpec :: V1beta1LeaseCandidateSpec
  
instance Arbitrary V1beta1LeaseCandidateList where
  arbitrary = sized genV1beta1LeaseCandidateList

genV1beta1LeaseCandidateList :: Int -> Gen V1beta1LeaseCandidateList
genV1beta1LeaseCandidateList n =
  V1beta1LeaseCandidateList
    <$> arbitraryReducedMaybe n -- v1beta1LeaseCandidateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1LeaseCandidateListItems :: [V1beta1LeaseCandidate]
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1LeaseCandidateSpec where
  arbitrary = sized genV1beta1LeaseCandidateSpec

genV1beta1LeaseCandidateSpec :: Int -> Gen V1beta1LeaseCandidateSpec
genV1beta1LeaseCandidateSpec n =
  V1beta1LeaseCandidateSpec
    <$> arbitrary -- v1beta1LeaseCandidateSpecBinaryVersion :: Text
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateSpecEmulationVersion :: Maybe Text
    <*> arbitrary -- v1beta1LeaseCandidateSpecLeaseName :: Text
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateSpecPingTime :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateSpecRenewTime :: Maybe DateTime
    <*> arbitrary -- v1beta1LeaseCandidateSpecStrategy :: Text
...
instance Arbitrary V1beta1MutatingAdmissionPolicy where
  arbitrary = sized genV1beta1MutatingAdmissionPolicy

genV1beta1MutatingAdmissionPolicy :: Int -> Gen V1beta1MutatingAdmissionPolicy
genV1beta1MutatingAdmissionPolicy n =
  V1beta1MutatingAdmissionPolicy
    <$> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpec :: Maybe V1beta1MutatingAdmissionPolicySpec
  
instance Arbitrary V1beta1MutatingAdmissionPolicyBinding where
  arbitrary = sized genV1beta1MutatingAdmissionPolicyBinding

genV1beta1MutatingAdmissionPolicyBinding :: Int -> Gen V1beta1MutatingAdmissionPolicyBinding
genV1beta1MutatingAdmissionPolicyBinding n =
  V1beta1MutatingAdmissionPolicyBinding
    <$> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingSpec :: Maybe V1beta1MutatingAdmissionPolicyBindingSpec
  
instance Arbitrary V1beta1MutatingAdmissionPolicyBindingList where
  arbitrary = sized genV1beta1MutatingAdmissionPolicyBindingList

genV1beta1MutatingAdmissionPolicyBindingList :: Int -> Gen V1beta1MutatingAdmissionPolicyBindingList
genV1beta1MutatingAdmissionPolicyBindingList n =
  V1beta1MutatingAdmissionPolicyBindingList
    <$> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1MutatingAdmissionPolicyBindingListItems :: [V1beta1MutatingAdmissionPolicyBinding]
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1MutatingAdmissionPolicyBindingSpec where
  arbitrary = sized genV1beta1MutatingAdmissionPolicyBindingSpec

genV1beta1MutatingAdmissionPolicyBindingSpec :: Int -> Gen V1beta1MutatingAdmissionPolicyBindingSpec
genV1beta1MutatingAdmissionPolicyBindingSpec n =
  V1beta1MutatingAdmissionPolicyBindingSpec
    <$> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingSpecMatchResources :: Maybe V1beta1MatchResources
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingSpecParamRef :: Maybe V1beta1ParamRef
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyBindingSpecPolicyName :: Maybe Text
  
instance Arbitrary V1beta1MutatingAdmissionPolicyList where
  arbitrary = sized genV1beta1MutatingAdmissionPolicyList

genV1beta1MutatingAdmissionPolicyList :: Int -> Gen V1beta1MutatingAdmissionPolicyList
genV1beta1MutatingAdmissionPolicyList n =
  V1beta1MutatingAdmissionPolicyList
    <$> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1MutatingAdmissionPolicyListItems :: [V1beta1MutatingAdmissionPolicy]
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicyListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1MutatingAdmissionPolicySpec where
  arbitrary = sized genV1beta1MutatingAdmissionPolicySpec

genV1beta1MutatingAdmissionPolicySpec :: Int -> Gen V1beta1MutatingAdmissionPolicySpec
genV1beta1MutatingAdmissionPolicySpec n =
  V1beta1MutatingAdmissionPolicySpec
    <$> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecFailurePolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecMatchConditions :: Maybe [V1beta1MatchCondition]
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecMatchConstraints :: Maybe V1beta1MatchResources
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecMutations :: Maybe [V1beta1Mutation]
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecParamKind :: Maybe V1beta1ParamKind
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecReinvocationPolicy :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1MutatingAdmissionPolicySpecVariables :: Maybe [V1beta1Variable]
  
instance Arbitrary V1beta1Mutation where
  arbitrary = sized genV1beta1Mutation

genV1beta1Mutation :: Int -> Gen V1beta1Mutation
genV1beta1Mutation n =
  V1beta1Mutation
    <$> arbitraryReducedMaybe n -- v1beta1MutationApplyConfiguration :: Maybe V1beta1ApplyConfiguration
    <*> arbitraryReducedMaybe n -- v1beta1MutationJsonPatch :: Maybe V1beta1JSONPatch
    <*> arbitrary -- v1beta1MutationPatchType :: Text
...
instance Arbitrary V1beta1NetworkDeviceData where
  arbitrary = sized genV1beta1NetworkDeviceData

genV1beta1NetworkDeviceData :: Int -> Gen V1beta1NetworkDeviceData
genV1beta1NetworkDeviceData n =
  V1beta1NetworkDeviceData
    <$> arbitraryReducedMaybe n -- v1beta1NetworkDeviceDataHardwareAddress :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1NetworkDeviceDataInterfaceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1NetworkDeviceDataIps :: Maybe [Text]
  
instance Arbitrary V1beta1NodeAllocatableResourceMapping where
  arbitrary = sized genV1beta1NodeAllocatableResourceMapping

genV1beta1NodeAllocatableResourceMapping :: Int -> Gen V1beta1NodeAllocatableResourceMapping
genV1beta1NodeAllocatableResourceMapping n =
  V1beta1NodeAllocatableResourceMapping
    <$> arbitraryReducedMaybe n -- v1beta1NodeAllocatableResourceMappingAllocationMultiplier :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1beta1NodeAllocatableResourceMappingCapacityKey :: Maybe Text
  
instance Arbitrary V1beta1OpaqueDeviceConfiguration where
  arbitrary = sized genV1beta1OpaqueDeviceConfiguration

genV1beta1OpaqueDeviceConfiguration :: Int -> Gen V1beta1OpaqueDeviceConfiguration
genV1beta1OpaqueDeviceConfiguration n =
  V1beta1OpaqueDeviceConfiguration
    <$> arbitrary -- v1beta1OpaqueDeviceConfigurationDriver :: Text
    <*> arbitraryReduced n -- v1beta1OpaqueDeviceConfigurationParameters :: A.Value
...
instance Arbitrary V1beta1ParentReference where
  arbitrary = sized genV1beta1ParentReference

genV1beta1ParentReference :: Int -> Gen V1beta1ParentReference
genV1beta1ParentReference n =
  V1beta1ParentReference
    <$> arbitraryReducedMaybe n -- v1beta1ParentReferenceGroup :: Maybe Text
    <*> arbitrary -- v1beta1ParentReferenceName :: Text
    <*> arbitraryReducedMaybe n -- v1beta1ParentReferenceNamespace :: Maybe Text
    <*> arbitrary -- v1beta1ParentReferenceResource :: Text
  
instance Arbitrary V1beta1PodCertificateRequest where
  arbitrary = sized genV1beta1PodCertificateRequest

genV1beta1PodCertificateRequest :: Int -> Gen V1beta1PodCertificateRequest
genV1beta1PodCertificateRequest n =
  V1beta1PodCertificateRequest
    <$> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1PodCertificateRequestSpec :: V1beta1PodCertificateRequestSpec
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestStatus :: Maybe V1beta1PodCertificateRequestStatus
  
instance Arbitrary V1beta1PodCertificateRequestList where
  arbitrary = sized genV1beta1PodCertificateRequestList

genV1beta1PodCertificateRequestList :: Int -> Gen V1beta1PodCertificateRequestList
genV1beta1PodCertificateRequestList n =
  V1beta1PodCertificateRequestList
    <$> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1PodCertificateRequestListItems :: [V1beta1PodCertificateRequest]
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1PodCertificateRequestSpec where
  arbitrary = sized genV1beta1PodCertificateRequestSpec

genV1beta1PodCertificateRequestSpec :: Int -> Gen V1beta1PodCertificateRequestSpec
genV1beta1PodCertificateRequestSpec n =
  V1beta1PodCertificateRequestSpec
    <$> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestSpecMaxExpirationSeconds :: Maybe Int
    <*> arbitrary -- v1beta1PodCertificateRequestSpecNodeName :: Text
    <*> arbitrary -- v1beta1PodCertificateRequestSpecNodeUid :: Text
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestSpecPkixPublicKey :: Maybe ByteArray
    <*> arbitrary -- v1beta1PodCertificateRequestSpecPodName :: Text
    <*> arbitrary -- v1beta1PodCertificateRequestSpecPodUid :: Text
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestSpecProofOfPossession :: Maybe ByteArray
    <*> arbitrary -- v1beta1PodCertificateRequestSpecServiceAccountName :: Text
    <*> arbitrary -- v1beta1PodCertificateRequestSpecServiceAccountUid :: Text
    <*> arbitrary -- v1beta1PodCertificateRequestSpecSignerName :: Text
    <*> arbitraryReduced n -- v1beta1PodCertificateRequestSpecStubPkcs10Request :: ByteArray
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestSpecUnverifiedUserAnnotations :: Maybe (Map.Map String Text)
  
instance Arbitrary V1beta1PodCertificateRequestStatus where
  arbitrary = sized genV1beta1PodCertificateRequestStatus

genV1beta1PodCertificateRequestStatus :: Int -> Gen V1beta1PodCertificateRequestStatus
genV1beta1PodCertificateRequestStatus n =
  V1beta1PodCertificateRequestStatus
    <$> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestStatusBeginRefreshAt :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestStatusCertificateChain :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestStatusNotAfter :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta1PodCertificateRequestStatusNotBefore :: Maybe DateTime
  
instance Arbitrary V1beta1ResourceClaim where
  arbitrary = sized genV1beta1ResourceClaim

genV1beta1ResourceClaim :: Int -> Gen V1beta1ResourceClaim
genV1beta1ResourceClaim n =
  V1beta1ResourceClaim
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1ResourceClaimSpec :: V1beta1ResourceClaimSpec
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimStatus :: Maybe V1beta1ResourceClaimStatus
  
instance Arbitrary V1beta1ResourceClaimConsumerReference where
  arbitrary = sized genV1beta1ResourceClaimConsumerReference

genV1beta1ResourceClaimConsumerReference :: Int -> Gen V1beta1ResourceClaimConsumerReference
genV1beta1ResourceClaimConsumerReference n =
  V1beta1ResourceClaimConsumerReference
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimConsumerReferenceApiGroup :: Maybe Text
    <*> arbitrary -- v1beta1ResourceClaimConsumerReferenceName :: Text
    <*> arbitrary -- v1beta1ResourceClaimConsumerReferenceResource :: Text
    <*> arbitrary -- v1beta1ResourceClaimConsumerReferenceUid :: Text
  
instance Arbitrary V1beta1ResourceClaimList where
  arbitrary = sized genV1beta1ResourceClaimList

genV1beta1ResourceClaimList :: Int -> Gen V1beta1ResourceClaimList
genV1beta1ResourceClaimList n =
  V1beta1ResourceClaimList
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1ResourceClaimListItems :: [V1beta1ResourceClaim]
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1ResourceClaimSpec where
  arbitrary = sized genV1beta1ResourceClaimSpec

genV1beta1ResourceClaimSpec :: Int -> Gen V1beta1ResourceClaimSpec
genV1beta1ResourceClaimSpec n =
  V1beta1ResourceClaimSpec
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimSpecDevices :: Maybe V1beta1DeviceClaim
  
instance Arbitrary V1beta1ResourceClaimStatus where
  arbitrary = sized genV1beta1ResourceClaimStatus

genV1beta1ResourceClaimStatus :: Int -> Gen V1beta1ResourceClaimStatus
genV1beta1ResourceClaimStatus n =
  V1beta1ResourceClaimStatus
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimStatusAllocation :: Maybe V1beta1AllocationResult
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimStatusDevices :: Maybe [V1beta1AllocatedDeviceStatus]
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimStatusReservedFor :: Maybe [V1beta1ResourceClaimConsumerReference]
  
instance Arbitrary V1beta1ResourceClaimTemplate where
  arbitrary = sized genV1beta1ResourceClaimTemplate

genV1beta1ResourceClaimTemplate :: Int -> Gen V1beta1ResourceClaimTemplate
genV1beta1ResourceClaimTemplate n =
  V1beta1ResourceClaimTemplate
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1ResourceClaimTemplateSpec :: V1beta1ResourceClaimTemplateSpec
  
instance Arbitrary V1beta1ResourceClaimTemplateList where
  arbitrary = sized genV1beta1ResourceClaimTemplateList

genV1beta1ResourceClaimTemplateList :: Int -> Gen V1beta1ResourceClaimTemplateList
genV1beta1ResourceClaimTemplateList n =
  V1beta1ResourceClaimTemplateList
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1ResourceClaimTemplateListItems :: [V1beta1ResourceClaimTemplate]
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1ResourceClaimTemplateSpec where
  arbitrary = sized genV1beta1ResourceClaimTemplateSpec

genV1beta1ResourceClaimTemplateSpec :: Int -> Gen V1beta1ResourceClaimTemplateSpec
genV1beta1ResourceClaimTemplateSpec n =
  V1beta1ResourceClaimTemplateSpec
    <$> arbitraryReducedMaybe n -- v1beta1ResourceClaimTemplateSpecMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1ResourceClaimTemplateSpecSpec :: V1beta1ResourceClaimSpec
  
instance Arbitrary V1beta1ResourcePool where
  arbitrary = sized genV1beta1ResourcePool

genV1beta1ResourcePool :: Int -> Gen V1beta1ResourcePool
genV1beta1ResourcePool n =
  V1beta1ResourcePool
    <$> arbitrary -- v1beta1ResourcePoolGeneration :: Integer
    <*> arbitrary -- v1beta1ResourcePoolName :: Text
    <*> arbitrary -- v1beta1ResourcePoolResourceSliceCount :: Integer
  
instance Arbitrary V1beta1ResourceSlice where
  arbitrary = sized genV1beta1ResourceSlice

genV1beta1ResourceSlice :: Int -> Gen V1beta1ResourceSlice
genV1beta1ResourceSlice n =
  V1beta1ResourceSlice
    <$> arbitraryReducedMaybe n -- v1beta1ResourceSliceApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta1ResourceSliceSpec :: V1beta1ResourceSliceSpec
  
instance Arbitrary V1beta1ResourceSliceList where
  arbitrary = sized genV1beta1ResourceSliceList

genV1beta1ResourceSliceList :: Int -> Gen V1beta1ResourceSliceList
genV1beta1ResourceSliceList n =
  V1beta1ResourceSliceList
    <$> arbitraryReducedMaybe n -- v1beta1ResourceSliceListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1ResourceSliceListItems :: [V1beta1ResourceSlice]
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1ResourceSliceSpec where
  arbitrary = sized genV1beta1ResourceSliceSpec

genV1beta1ResourceSliceSpec :: Int -> Gen V1beta1ResourceSliceSpec
genV1beta1ResourceSliceSpec n =
  V1beta1ResourceSliceSpec
    <$> arbitraryReducedMaybe n -- v1beta1ResourceSliceSpecAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceSpecDevices :: Maybe [V1beta1Device]
    <*> arbitrary -- v1beta1ResourceSliceSpecDriver :: Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceSpecNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceSpecNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceSpecPerDeviceNodeSelection :: Maybe Bool
    <*> arbitraryReduced n -- v1beta1ResourceSliceSpecPool :: V1beta1ResourcePool
    <*> arbitraryReducedMaybe n -- v1beta1ResourceSliceSpecSharedCounters :: Maybe [V1beta1CounterSet]
  
instance Arbitrary V1beta1ServiceCIDR where
  arbitrary = sized genV1beta1ServiceCIDR

genV1beta1ServiceCIDR :: Int -> Gen V1beta1ServiceCIDR
genV1beta1ServiceCIDR n =
  V1beta1ServiceCIDR
    <$> arbitraryReducedMaybe n -- v1beta1ServiceCIDRApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ServiceCIDRKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ServiceCIDRMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1beta1ServiceCIDRSpec :: Maybe V1beta1ServiceCIDRSpec
    <*> arbitraryReducedMaybe n -- v1beta1ServiceCIDRStatus :: Maybe V1beta1ServiceCIDRStatus
  
instance Arbitrary V1beta1ServiceCIDRList where
  arbitrary = sized genV1beta1ServiceCIDRList

genV1beta1ServiceCIDRList :: Int -> Gen V1beta1ServiceCIDRList
genV1beta1ServiceCIDRList n =
  V1beta1ServiceCIDRList
    <$> arbitraryReducedMaybe n -- v1beta1ServiceCIDRListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1ServiceCIDRListItems :: [V1beta1ServiceCIDR]
    <*> arbitraryReducedMaybe n -- v1beta1ServiceCIDRListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1ServiceCIDRListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1ServiceCIDRSpec where
  arbitrary = sized genV1beta1ServiceCIDRSpec

genV1beta1ServiceCIDRSpec :: Int -> Gen V1beta1ServiceCIDRSpec
genV1beta1ServiceCIDRSpec n =
  V1beta1ServiceCIDRSpec
    <$> arbitraryReducedMaybe n -- v1beta1ServiceCIDRSpecCidrs :: Maybe [Text]
  
instance Arbitrary V1beta1ServiceCIDRStatus where
  arbitrary = sized genV1beta1ServiceCIDRStatus

genV1beta1ServiceCIDRStatus :: Int -> Gen V1beta1ServiceCIDRStatus
genV1beta1ServiceCIDRStatus n =
  V1beta1ServiceCIDRStatus
    <$> arbitraryReducedMaybe n -- v1beta1ServiceCIDRStatusConditions :: Maybe [V1Condition]
  
instance Arbitrary V1beta1StorageVersionMigration where
  arbitrary = sized genV1beta1StorageVersionMigration

genV1beta1StorageVersionMigration :: Int -> Gen V1beta1StorageVersionMigration
genV1beta1StorageVersionMigration n =
  V1beta1StorageVersionMigration
    <$> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationSpec :: Maybe V1beta1StorageVersionMigrationSpec
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationStatus :: Maybe V1beta1StorageVersionMigrationStatus
  
instance Arbitrary V1beta1StorageVersionMigrationList where
  arbitrary = sized genV1beta1StorageVersionMigrationList

genV1beta1StorageVersionMigrationList :: Int -> Gen V1beta1StorageVersionMigrationList
genV1beta1StorageVersionMigrationList n =
  V1beta1StorageVersionMigrationList
    <$> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1StorageVersionMigrationListItems :: [V1beta1StorageVersionMigration]
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta1StorageVersionMigrationSpec where
  arbitrary = sized genV1beta1StorageVersionMigrationSpec

genV1beta1StorageVersionMigrationSpec :: Int -> Gen V1beta1StorageVersionMigrationSpec
genV1beta1StorageVersionMigrationSpec n =
  V1beta1StorageVersionMigrationSpec
    <$> arbitraryReduced n -- v1beta1StorageVersionMigrationSpecResource :: V1GroupResource
  
instance Arbitrary V1beta1StorageVersionMigrationStatus where
  arbitrary = sized genV1beta1StorageVersionMigrationStatus

genV1beta1StorageVersionMigrationStatus :: Int -> Gen V1beta1StorageVersionMigrationStatus
genV1beta1StorageVersionMigrationStatus n =
  V1beta1StorageVersionMigrationStatus
    <$> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybe n -- v1beta1StorageVersionMigrationStatusResourceVersion :: Maybe Text
...
instance Arbitrary V1beta1VolumeAttributesClass where
  arbitrary = sized genV1beta1VolumeAttributesClass

genV1beta1VolumeAttributesClass :: Int -> Gen V1beta1VolumeAttributesClass
genV1beta1VolumeAttributesClass n =
  V1beta1VolumeAttributesClass
    <$> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassApiVersion :: Maybe Text
    <*> arbitrary -- v1beta1VolumeAttributesClassDriverName :: Text
    <*> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassParameters :: Maybe (Map.Map String Text)
  
instance Arbitrary V1beta1VolumeAttributesClassList where
  arbitrary = sized genV1beta1VolumeAttributesClassList

genV1beta1VolumeAttributesClassList :: Int -> Gen V1beta1VolumeAttributesClassList
genV1beta1VolumeAttributesClassList n =
  V1beta1VolumeAttributesClassList
    <$> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta1VolumeAttributesClassListItems :: [V1beta1VolumeAttributesClass]
    <*> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta1VolumeAttributesClassListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta2AllocatedDeviceStatus where
  arbitrary = sized genV1beta2AllocatedDeviceStatus

genV1beta2AllocatedDeviceStatus :: Int -> Gen V1beta2AllocatedDeviceStatus
genV1beta2AllocatedDeviceStatus n =
  V1beta2AllocatedDeviceStatus
    <$> arbitraryReducedMaybe n -- v1beta2AllocatedDeviceStatusConditions :: Maybe [V1Condition]
    <*> arbitraryReducedMaybeValue n -- v1beta2AllocatedDeviceStatusData :: Maybe A.Value
    <*> arbitrary -- v1beta2AllocatedDeviceStatusDevice :: Text
    <*> arbitrary -- v1beta2AllocatedDeviceStatusDriver :: Text
    <*> arbitraryReducedMaybe n -- v1beta2AllocatedDeviceStatusNetworkData :: Maybe V1beta2NetworkDeviceData
    <*> arbitrary -- v1beta2AllocatedDeviceStatusPool :: Text
    <*> arbitraryReducedMaybe n -- v1beta2AllocatedDeviceStatusShareId :: Maybe Text
  
instance Arbitrary V1beta2AllocationResult where
  arbitrary = sized genV1beta2AllocationResult

genV1beta2AllocationResult :: Int -> Gen V1beta2AllocationResult
genV1beta2AllocationResult n =
  V1beta2AllocationResult
    <$> arbitraryReducedMaybe n -- v1beta2AllocationResultAllocationTimestamp :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta2AllocationResultDevices :: Maybe V1beta2DeviceAllocationResult
    <*> arbitraryReducedMaybe n -- v1beta2AllocationResultNodeSelector :: Maybe V1NodeSelector
  
instance Arbitrary V1beta2CELDeviceSelector where
  arbitrary = sized genV1beta2CELDeviceSelector

genV1beta2CELDeviceSelector :: Int -> Gen V1beta2CELDeviceSelector
genV1beta2CELDeviceSelector n =
  V1beta2CELDeviceSelector
    <$> arbitrary -- v1beta2CELDeviceSelectorExpression :: Text
  
instance Arbitrary V1beta2CapacityRequestPolicy where
  arbitrary = sized genV1beta2CapacityRequestPolicy

genV1beta2CapacityRequestPolicy :: Int -> Gen V1beta2CapacityRequestPolicy
genV1beta2CapacityRequestPolicy n =
  V1beta2CapacityRequestPolicy
    <$> arbitraryReducedMaybe n -- v1beta2CapacityRequestPolicyDefault :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1beta2CapacityRequestPolicyValidRange :: Maybe V1beta2CapacityRequestPolicyRange
    <*> arbitraryReducedMaybe n -- v1beta2CapacityRequestPolicyValidValues :: Maybe [Quantity]
  
instance Arbitrary V1beta2CapacityRequestPolicyRange where
  arbitrary = sized genV1beta2CapacityRequestPolicyRange

genV1beta2CapacityRequestPolicyRange :: Int -> Gen V1beta2CapacityRequestPolicyRange
genV1beta2CapacityRequestPolicyRange n =
  V1beta2CapacityRequestPolicyRange
    <$> arbitraryReducedMaybe n -- v1beta2CapacityRequestPolicyRangeMax :: Maybe Quantity
    <*> arbitraryReduced n -- v1beta2CapacityRequestPolicyRangeMin :: Quantity
    <*> arbitraryReducedMaybe n -- v1beta2CapacityRequestPolicyRangeStep :: Maybe Quantity
  
instance Arbitrary V1beta2CapacityRequirements where
  arbitrary = sized genV1beta2CapacityRequirements

genV1beta2CapacityRequirements :: Int -> Gen V1beta2CapacityRequirements
genV1beta2CapacityRequirements n =
  V1beta2CapacityRequirements
    <$> arbitraryReducedMaybe n -- v1beta2CapacityRequirementsRequests :: Maybe (Map.Map String Quantity)
  
instance Arbitrary V1beta2Counter where
  arbitrary = sized genV1beta2Counter

genV1beta2Counter :: Int -> Gen V1beta2Counter
genV1beta2Counter n =
  V1beta2Counter
    <$> arbitraryReduced n -- v1beta2CounterValue :: Quantity
  
instance Arbitrary V1beta2CounterSet where
  arbitrary = sized genV1beta2CounterSet

genV1beta2CounterSet :: Int -> Gen V1beta2CounterSet
genV1beta2CounterSet n =
  V1beta2CounterSet
    <$> arbitraryReduced n -- v1beta2CounterSetCounters :: (Map.Map String V1beta2Counter)
    <*> arbitrary -- v1beta2CounterSetName :: Text
  
instance Arbitrary V1beta2Device where
  arbitrary = sized genV1beta2Device

genV1beta2Device :: Int -> Gen V1beta2Device
genV1beta2Device n =
  V1beta2Device
    <$> arbitraryReducedMaybe n -- v1beta2DeviceAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAllowMultipleAllocations :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributes :: Maybe (Map.Map String V1beta2DeviceAttribute)
    <*> arbitraryReducedMaybe n -- v1beta2DeviceBindingConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceBindingFailureConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceBindsToNode :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2DeviceCapacity :: Maybe (Map.Map String V1beta2DeviceCapacity)
    <*> arbitraryReducedMaybe n -- v1beta2DeviceConsumesCounters :: Maybe [V1beta2DeviceCounterConsumption]
    <*> arbitrary -- v1beta2DeviceName :: Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceNodeAllocatableResourceMappings :: Maybe (Map.Map String V1beta2NodeAllocatableResourceMapping)
    <*> arbitraryReducedMaybe n -- v1beta2DeviceNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaints :: Maybe [V1beta2DeviceTaint]
  
instance Arbitrary V1beta2DeviceAllocationConfiguration where
  arbitrary = sized genV1beta2DeviceAllocationConfiguration

genV1beta2DeviceAllocationConfiguration :: Int -> Gen V1beta2DeviceAllocationConfiguration
genV1beta2DeviceAllocationConfiguration n =
  V1beta2DeviceAllocationConfiguration
    <$> arbitraryReducedMaybe n -- v1beta2DeviceAllocationConfigurationOpaque :: Maybe V1beta2OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAllocationConfigurationRequests :: Maybe [Text]
    <*> arbitrary -- v1beta2DeviceAllocationConfigurationSource :: Text
  
instance Arbitrary V1beta2DeviceAllocationResult where
  arbitrary = sized genV1beta2DeviceAllocationResult

genV1beta2DeviceAllocationResult :: Int -> Gen V1beta2DeviceAllocationResult
genV1beta2DeviceAllocationResult n =
  V1beta2DeviceAllocationResult
    <$> arbitraryReducedMaybe n -- v1beta2DeviceAllocationResultConfig :: Maybe [V1beta2DeviceAllocationConfiguration]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAllocationResultResults :: Maybe [V1beta2DeviceRequestAllocationResult]
  
instance Arbitrary V1beta2DeviceAttribute where
  arbitrary = sized genV1beta2DeviceAttribute

genV1beta2DeviceAttribute :: Int -> Gen V1beta2DeviceAttribute
genV1beta2DeviceAttribute n =
  V1beta2DeviceAttribute
    <$> arbitraryReducedMaybe n -- v1beta2DeviceAttributeBool :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeBools :: Maybe [Bool]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeInt :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeInts :: Maybe [Integer]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeString :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeStrings :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceAttributeVersions :: Maybe [Text]
  
instance Arbitrary V1beta2DeviceCapacity where
  arbitrary = sized genV1beta2DeviceCapacity

genV1beta2DeviceCapacity :: Int -> Gen V1beta2DeviceCapacity
genV1beta2DeviceCapacity n =
  V1beta2DeviceCapacity
    <$> arbitraryReducedMaybe n -- v1beta2DeviceCapacityRequestPolicy :: Maybe V1beta2CapacityRequestPolicy
    <*> arbitraryReduced n -- v1beta2DeviceCapacityValue :: Quantity
  
instance Arbitrary V1beta2DeviceClaim where
  arbitrary = sized genV1beta2DeviceClaim

genV1beta2DeviceClaim :: Int -> Gen V1beta2DeviceClaim
genV1beta2DeviceClaim n =
  V1beta2DeviceClaim
    <$> arbitraryReducedMaybe n -- v1beta2DeviceClaimConfig :: Maybe [V1beta2DeviceClaimConfiguration]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClaimConstraints :: Maybe [V1beta2DeviceConstraint]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClaimRequests :: Maybe [V1beta2DeviceRequest]
  
instance Arbitrary V1beta2DeviceClaimConfiguration where
  arbitrary = sized genV1beta2DeviceClaimConfiguration

genV1beta2DeviceClaimConfiguration :: Int -> Gen V1beta2DeviceClaimConfiguration
genV1beta2DeviceClaimConfiguration n =
  V1beta2DeviceClaimConfiguration
    <$> arbitraryReducedMaybe n -- v1beta2DeviceClaimConfigurationOpaque :: Maybe V1beta2OpaqueDeviceConfiguration
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClaimConfigurationRequests :: Maybe [Text]
  
instance Arbitrary V1beta2DeviceClass where
  arbitrary = sized genV1beta2DeviceClass

genV1beta2DeviceClass :: Int -> Gen V1beta2DeviceClass
genV1beta2DeviceClass n =
  V1beta2DeviceClass
    <$> arbitraryReducedMaybe n -- v1beta2DeviceClassApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClassKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClassMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta2DeviceClassSpec :: V1beta2DeviceClassSpec
  
instance Arbitrary V1beta2DeviceClassConfiguration where
  arbitrary = sized genV1beta2DeviceClassConfiguration

genV1beta2DeviceClassConfiguration :: Int -> Gen V1beta2DeviceClassConfiguration
genV1beta2DeviceClassConfiguration n =
  V1beta2DeviceClassConfiguration
    <$> arbitraryReducedMaybe n -- v1beta2DeviceClassConfigurationOpaque :: Maybe V1beta2OpaqueDeviceConfiguration
  
instance Arbitrary V1beta2DeviceClassList where
  arbitrary = sized genV1beta2DeviceClassList

genV1beta2DeviceClassList :: Int -> Gen V1beta2DeviceClassList
genV1beta2DeviceClassList n =
  V1beta2DeviceClassList
    <$> arbitraryReducedMaybe n -- v1beta2DeviceClassListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta2DeviceClassListItems :: [V1beta2DeviceClass]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClassListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClassListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta2DeviceClassSpec where
  arbitrary = sized genV1beta2DeviceClassSpec

genV1beta2DeviceClassSpec :: Int -> Gen V1beta2DeviceClassSpec
genV1beta2DeviceClassSpec n =
  V1beta2DeviceClassSpec
    <$> arbitraryReducedMaybe n -- v1beta2DeviceClassSpecConfig :: Maybe [V1beta2DeviceClassConfiguration]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClassSpecExtendedResourceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceClassSpecSelectors :: Maybe [V1beta2DeviceSelector]
  
instance Arbitrary V1beta2DeviceConstraint where
  arbitrary = sized genV1beta2DeviceConstraint

genV1beta2DeviceConstraint :: Int -> Gen V1beta2DeviceConstraint
genV1beta2DeviceConstraint n =
  V1beta2DeviceConstraint
    <$> arbitraryReducedMaybe n -- v1beta2DeviceConstraintDistinctAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceConstraintMatchAttribute :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceConstraintRequests :: Maybe [Text]
  
instance Arbitrary V1beta2DeviceCounterConsumption where
  arbitrary = sized genV1beta2DeviceCounterConsumption

genV1beta2DeviceCounterConsumption :: Int -> Gen V1beta2DeviceCounterConsumption
genV1beta2DeviceCounterConsumption n =
  V1beta2DeviceCounterConsumption
    <$> arbitrary -- v1beta2DeviceCounterConsumptionCounterSet :: Text
    <*> arbitraryReduced n -- v1beta2DeviceCounterConsumptionCounters :: (Map.Map String V1beta2Counter)
  
instance Arbitrary V1beta2DeviceRequest where
  arbitrary = sized genV1beta2DeviceRequest

genV1beta2DeviceRequest :: Int -> Gen V1beta2DeviceRequest
genV1beta2DeviceRequest n =
  V1beta2DeviceRequest
    <$> arbitraryReducedMaybe n -- v1beta2DeviceRequestExactly :: Maybe V1beta2ExactDeviceRequest
    <*> arbitraryReducedMaybe n -- v1beta2DeviceRequestFirstAvailable :: Maybe [V1beta2DeviceSubRequest]
    <*> arbitrary -- v1beta2DeviceRequestName :: Text
  
instance Arbitrary V1beta2DeviceRequestAllocationResult where
  arbitrary = sized genV1beta2DeviceRequestAllocationResult

genV1beta2DeviceRequestAllocationResult :: Int -> Gen V1beta2DeviceRequestAllocationResult
genV1beta2DeviceRequestAllocationResult n =
  V1beta2DeviceRequestAllocationResult
    <$> arbitraryReducedMaybe n -- v1beta2DeviceRequestAllocationResultAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2DeviceRequestAllocationResultBindingConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceRequestAllocationResultBindingFailureConditions :: Maybe [Text]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceRequestAllocationResultConsumedCapacity :: Maybe (Map.Map String Quantity)
    <*> arbitrary -- v1beta2DeviceRequestAllocationResultDevice :: Text
    <*> arbitrary -- v1beta2DeviceRequestAllocationResultDriver :: Text
    <*> arbitrary -- v1beta2DeviceRequestAllocationResultPool :: Text
    <*> arbitrary -- v1beta2DeviceRequestAllocationResultRequest :: Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceRequestAllocationResultShareId :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceRequestAllocationResultTolerations :: Maybe [V1beta2DeviceToleration]
  
instance Arbitrary V1beta2DeviceSelector where
  arbitrary = sized genV1beta2DeviceSelector

genV1beta2DeviceSelector :: Int -> Gen V1beta2DeviceSelector
genV1beta2DeviceSelector n =
  V1beta2DeviceSelector
    <$> arbitraryReducedMaybe n -- v1beta2DeviceSelectorCel :: Maybe V1beta2CELDeviceSelector
  
instance Arbitrary V1beta2DeviceSubRequest where
  arbitrary = sized genV1beta2DeviceSubRequest

genV1beta2DeviceSubRequest :: Int -> Gen V1beta2DeviceSubRequest
genV1beta2DeviceSubRequest n =
  V1beta2DeviceSubRequest
    <$> arbitraryReducedMaybe n -- v1beta2DeviceSubRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceSubRequestCapacity :: Maybe V1beta2CapacityRequirements
    <*> arbitraryReducedMaybe n -- v1beta2DeviceSubRequestCount :: Maybe Integer
    <*> arbitrary -- v1beta2DeviceSubRequestDeviceClassName :: Text
    <*> arbitrary -- v1beta2DeviceSubRequestName :: Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceSubRequestSelectors :: Maybe [V1beta2DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceSubRequestTolerations :: Maybe [V1beta2DeviceToleration]
  
instance Arbitrary V1beta2DeviceTaint where
  arbitrary = sized genV1beta2DeviceTaint

genV1beta2DeviceTaint :: Int -> Gen V1beta2DeviceTaint
genV1beta2DeviceTaint n =
  V1beta2DeviceTaint
    <$> arbitrary -- v1beta2DeviceTaintEffect :: Text
    <*> arbitrary -- v1beta2DeviceTaintKey :: Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintTimeAdded :: Maybe DateTime
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintValue :: Maybe Text
  
instance Arbitrary V1beta2DeviceTaintRule where
  arbitrary = sized genV1beta2DeviceTaintRule

genV1beta2DeviceTaintRule :: Int -> Gen V1beta2DeviceTaintRule
genV1beta2DeviceTaintRule n =
  V1beta2DeviceTaintRule
    <$> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta2DeviceTaintRuleSpec :: V1beta2DeviceTaintRuleSpec
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleStatus :: Maybe V1beta2DeviceTaintRuleStatus
  
instance Arbitrary V1beta2DeviceTaintRuleList where
  arbitrary = sized genV1beta2DeviceTaintRuleList

genV1beta2DeviceTaintRuleList :: Int -> Gen V1beta2DeviceTaintRuleList
genV1beta2DeviceTaintRuleList n =
  V1beta2DeviceTaintRuleList
    <$> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta2DeviceTaintRuleListItems :: [V1beta2DeviceTaintRule]
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta2DeviceTaintRuleSpec where
  arbitrary = sized genV1beta2DeviceTaintRuleSpec

genV1beta2DeviceTaintRuleSpec :: Int -> Gen V1beta2DeviceTaintRuleSpec
genV1beta2DeviceTaintRuleSpec n =
  V1beta2DeviceTaintRuleSpec
    <$> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleSpecDeviceSelector :: Maybe V1beta2DeviceTaintSelector
    <*> arbitraryReduced n -- v1beta2DeviceTaintRuleSpecTaint :: V1beta2DeviceTaint
  
instance Arbitrary V1beta2DeviceTaintRuleStatus where
  arbitrary = sized genV1beta2DeviceTaintRuleStatus

genV1beta2DeviceTaintRuleStatus :: Int -> Gen V1beta2DeviceTaintRuleStatus
genV1beta2DeviceTaintRuleStatus n =
  V1beta2DeviceTaintRuleStatus
    <$> arbitraryReducedMaybe n -- v1beta2DeviceTaintRuleStatusConditions :: Maybe [V1Condition]
  
instance Arbitrary V1beta2DeviceTaintSelector where
  arbitrary = sized genV1beta2DeviceTaintSelector

genV1beta2DeviceTaintSelector :: Int -> Gen V1beta2DeviceTaintSelector
genV1beta2DeviceTaintSelector n =
  V1beta2DeviceTaintSelector
    <$> arbitraryReducedMaybe n -- v1beta2DeviceTaintSelectorDevice :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintSelectorDriver :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTaintSelectorPool :: Maybe Text
  
instance Arbitrary V1beta2DeviceToleration where
  arbitrary = sized genV1beta2DeviceToleration

genV1beta2DeviceToleration :: Int -> Gen V1beta2DeviceToleration
genV1beta2DeviceToleration n =
  V1beta2DeviceToleration
    <$> arbitraryReducedMaybe n -- v1beta2DeviceTolerationEffect :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTolerationKey :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTolerationOperator :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTolerationTolerationSeconds :: Maybe Integer
    <*> arbitraryReducedMaybe n -- v1beta2DeviceTolerationValue :: Maybe Text
  
instance Arbitrary V1beta2ExactDeviceRequest where
  arbitrary = sized genV1beta2ExactDeviceRequest

genV1beta2ExactDeviceRequest :: Int -> Gen V1beta2ExactDeviceRequest
genV1beta2ExactDeviceRequest n =
  V1beta2ExactDeviceRequest
    <$> arbitraryReducedMaybe n -- v1beta2ExactDeviceRequestAdminAccess :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2ExactDeviceRequestAllocationMode :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ExactDeviceRequestCapacity :: Maybe V1beta2CapacityRequirements
    <*> arbitraryReducedMaybe n -- v1beta2ExactDeviceRequestCount :: Maybe Integer
    <*> arbitrary -- v1beta2ExactDeviceRequestDeviceClassName :: Text
    <*> arbitraryReducedMaybe n -- v1beta2ExactDeviceRequestSelectors :: Maybe [V1beta2DeviceSelector]
    <*> arbitraryReducedMaybe n -- v1beta2ExactDeviceRequestTolerations :: Maybe [V1beta2DeviceToleration]
  
instance Arbitrary V1beta2NetworkDeviceData where
  arbitrary = sized genV1beta2NetworkDeviceData

genV1beta2NetworkDeviceData :: Int -> Gen V1beta2NetworkDeviceData
genV1beta2NetworkDeviceData n =
  V1beta2NetworkDeviceData
    <$> arbitraryReducedMaybe n -- v1beta2NetworkDeviceDataHardwareAddress :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2NetworkDeviceDataInterfaceName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2NetworkDeviceDataIps :: Maybe [Text]
  
instance Arbitrary V1beta2NodeAllocatableResourceMapping where
  arbitrary = sized genV1beta2NodeAllocatableResourceMapping

genV1beta2NodeAllocatableResourceMapping :: Int -> Gen V1beta2NodeAllocatableResourceMapping
genV1beta2NodeAllocatableResourceMapping n =
  V1beta2NodeAllocatableResourceMapping
    <$> arbitraryReducedMaybe n -- v1beta2NodeAllocatableResourceMappingAllocationMultiplier :: Maybe Quantity
    <*> arbitraryReducedMaybe n -- v1beta2NodeAllocatableResourceMappingCapacityKey :: Maybe Text
  
instance Arbitrary V1beta2OpaqueDeviceConfiguration where
  arbitrary = sized genV1beta2OpaqueDeviceConfiguration

genV1beta2OpaqueDeviceConfiguration :: Int -> Gen V1beta2OpaqueDeviceConfiguration
genV1beta2OpaqueDeviceConfiguration n =
  V1beta2OpaqueDeviceConfiguration
    <$> arbitrary -- v1beta2OpaqueDeviceConfigurationDriver :: Text
    <*> arbitraryReduced n -- v1beta2OpaqueDeviceConfigurationParameters :: A.Value
  
instance Arbitrary V1beta2ResourceClaim where
  arbitrary = sized genV1beta2ResourceClaim

genV1beta2ResourceClaim :: Int -> Gen V1beta2ResourceClaim
genV1beta2ResourceClaim n =
  V1beta2ResourceClaim
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta2ResourceClaimSpec :: V1beta2ResourceClaimSpec
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimStatus :: Maybe V1beta2ResourceClaimStatus
  
instance Arbitrary V1beta2ResourceClaimConsumerReference where
  arbitrary = sized genV1beta2ResourceClaimConsumerReference

genV1beta2ResourceClaimConsumerReference :: Int -> Gen V1beta2ResourceClaimConsumerReference
genV1beta2ResourceClaimConsumerReference n =
  V1beta2ResourceClaimConsumerReference
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimConsumerReferenceApiGroup :: Maybe Text
    <*> arbitrary -- v1beta2ResourceClaimConsumerReferenceName :: Text
    <*> arbitrary -- v1beta2ResourceClaimConsumerReferenceResource :: Text
    <*> arbitrary -- v1beta2ResourceClaimConsumerReferenceUid :: Text
  
instance Arbitrary V1beta2ResourceClaimList where
  arbitrary = sized genV1beta2ResourceClaimList

genV1beta2ResourceClaimList :: Int -> Gen V1beta2ResourceClaimList
genV1beta2ResourceClaimList n =
  V1beta2ResourceClaimList
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta2ResourceClaimListItems :: [V1beta2ResourceClaim]
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta2ResourceClaimSpec where
  arbitrary = sized genV1beta2ResourceClaimSpec

genV1beta2ResourceClaimSpec :: Int -> Gen V1beta2ResourceClaimSpec
genV1beta2ResourceClaimSpec n =
  V1beta2ResourceClaimSpec
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimSpecDevices :: Maybe V1beta2DeviceClaim
  
instance Arbitrary V1beta2ResourceClaimStatus where
  arbitrary = sized genV1beta2ResourceClaimStatus

genV1beta2ResourceClaimStatus :: Int -> Gen V1beta2ResourceClaimStatus
genV1beta2ResourceClaimStatus n =
  V1beta2ResourceClaimStatus
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimStatusAllocation :: Maybe V1beta2AllocationResult
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimStatusDevices :: Maybe [V1beta2AllocatedDeviceStatus]
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimStatusReservedFor :: Maybe [V1beta2ResourceClaimConsumerReference]
  
instance Arbitrary V1beta2ResourceClaimTemplate where
  arbitrary = sized genV1beta2ResourceClaimTemplate

genV1beta2ResourceClaimTemplate :: Int -> Gen V1beta2ResourceClaimTemplate
genV1beta2ResourceClaimTemplate n =
  V1beta2ResourceClaimTemplate
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta2ResourceClaimTemplateSpec :: V1beta2ResourceClaimTemplateSpec
  
instance Arbitrary V1beta2ResourceClaimTemplateList where
  arbitrary = sized genV1beta2ResourceClaimTemplateList

genV1beta2ResourceClaimTemplateList :: Int -> Gen V1beta2ResourceClaimTemplateList
genV1beta2ResourceClaimTemplateList n =
  V1beta2ResourceClaimTemplateList
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta2ResourceClaimTemplateListItems :: [V1beta2ResourceClaimTemplate]
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta2ResourceClaimTemplateSpec where
  arbitrary = sized genV1beta2ResourceClaimTemplateSpec

genV1beta2ResourceClaimTemplateSpec :: Int -> Gen V1beta2ResourceClaimTemplateSpec
genV1beta2ResourceClaimTemplateSpec n =
  V1beta2ResourceClaimTemplateSpec
    <$> arbitraryReducedMaybe n -- v1beta2ResourceClaimTemplateSpecMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta2ResourceClaimTemplateSpecSpec :: V1beta2ResourceClaimSpec
  
instance Arbitrary V1beta2ResourcePool where
  arbitrary = sized genV1beta2ResourcePool

genV1beta2ResourcePool :: Int -> Gen V1beta2ResourcePool
genV1beta2ResourcePool n =
  V1beta2ResourcePool
    <$> arbitrary -- v1beta2ResourcePoolGeneration :: Integer
    <*> arbitrary -- v1beta2ResourcePoolName :: Text
    <*> arbitrary -- v1beta2ResourcePoolResourceSliceCount :: Integer
  
instance Arbitrary V1beta2ResourceSlice where
  arbitrary = sized genV1beta2ResourceSlice

genV1beta2ResourceSlice :: Int -> Gen V1beta2ResourceSlice
genV1beta2ResourceSlice n =
  V1beta2ResourceSlice
    <$> arbitraryReducedMaybe n -- v1beta2ResourceSliceApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1beta2ResourceSliceSpec :: V1beta2ResourceSliceSpec
  
instance Arbitrary V1beta2ResourceSliceList where
  arbitrary = sized genV1beta2ResourceSliceList

genV1beta2ResourceSliceList :: Int -> Gen V1beta2ResourceSliceList
genV1beta2ResourceSliceList n =
  V1beta2ResourceSliceList
    <$> arbitraryReducedMaybe n -- v1beta2ResourceSliceListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1beta2ResourceSliceListItems :: [V1beta2ResourceSlice]
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1beta2ResourceSliceSpec where
  arbitrary = sized genV1beta2ResourceSliceSpec

genV1beta2ResourceSliceSpec :: Int -> Gen V1beta2ResourceSliceSpec
genV1beta2ResourceSliceSpec n =
  V1beta2ResourceSliceSpec
    <$> arbitraryReducedMaybe n -- v1beta2ResourceSliceSpecAllNodes :: Maybe Bool
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceSpecDevices :: Maybe [V1beta2Device]
    <*> arbitrary -- v1beta2ResourceSliceSpecDriver :: Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceSpecNodeName :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceSpecNodeSelector :: Maybe V1NodeSelector
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceSpecPerDeviceNodeSelection :: Maybe Bool
    <*> arbitraryReduced n -- v1beta2ResourceSliceSpecPool :: V1beta2ResourcePool
    <*> arbitraryReducedMaybe n -- v1beta2ResourceSliceSpecSharedCounters :: Maybe [V1beta2CounterSet]
...
genV2HPAScalingRules n =
  V2HPAScalingRules
    ...
    <*> arbitraryReducedMaybe n -- v2HPAScalingRulesTolerance :: Maybe Quantity
...
genV2HorizontalPodAutoscaler n =
  V2HorizontalPodAutoscaler
    ...
    <*> arbitraryReduced n -- v2HorizontalPodAutoscalerSpec :: V2HorizontalPodAutoscalerSpec
...
genVersionInfo n =
  VersionInfo
    ...
    <*> arbitraryReducedMaybe n -- versionInfoEmulationMajor :: Maybe Text
    <*> arbitraryReducedMaybe n -- versionInfoEmulationMinor :: Maybe Text
    ...
    <*> arbitraryReducedMaybe n -- versionInfoMinCompatibilityMajor :: Maybe Text
    <*> arbitraryReducedMaybe n -- versionInfoMinCompatibilityMinor :: Maybe Text
