...
-- 
createNamespacedLeaseCandidate
  :: (Consumes CreateNamespacedLeaseCandidate contentType, MimeRender contentType V1beta1LeaseCandidate)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1LeaseCandidate -- ^ "body"
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest CreateNamespacedLeaseCandidate contentType V1beta1LeaseCandidate accept
createNamespacedLeaseCandidate _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateNamespacedLeaseCandidate 
instance HasBodyParam CreateNamespacedLeaseCandidate V1beta1LeaseCandidate 
...
deleteCollectionNamespacedLeaseCandidate _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
instance HasOptionalParam DeleteCollectionNamespacedLeaseCandidate ShardSelector where
...
deleteNamespacedLeaseCandidate _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listLeaseCandidateForAllNamespaces
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListLeaseCandidateForAllNamespaces MimeNoContent V1beta1LeaseCandidateList accept
listLeaseCandidateForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1beta1/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListLeaseCandidateForAllNamespaces ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
listNamespacedLeaseCandidate
  :: Accept accept -- ^ request accept ('MimeType')
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ListNamespacedLeaseCandidate MimeNoContent V1beta1LeaseCandidateList accept
listNamespacedLeaseCandidate  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListNamespacedLeaseCandidate ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
patchNamespacedLeaseCandidate
  ...
  -> Name -- ^ "name" -  name of the LeaseCandidate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedLeaseCandidate contentType V1beta1LeaseCandidate accept
patchNamespacedLeaseCandidate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readNamespacedLeaseCandidate
  ...
  -> Name -- ^ "name" -  name of the LeaseCandidate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedLeaseCandidate MimeNoContent V1beta1LeaseCandidate accept
readNamespacedLeaseCandidate  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- 
replaceNamespacedLeaseCandidate
  :: (Consumes ReplaceNamespacedLeaseCandidate contentType, MimeRender contentType V1beta1LeaseCandidate)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1LeaseCandidate -- ^ "body"
  -> Name -- ^ "name" -  name of the LeaseCandidate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedLeaseCandidate contentType V1beta1LeaseCandidate accept
replaceNamespacedLeaseCandidate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/coordination.k8s.io/v1beta1/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedLeaseCandidate 
instance HasBodyParam ReplaceNamespacedLeaseCandidate V1beta1LeaseCandidate 
