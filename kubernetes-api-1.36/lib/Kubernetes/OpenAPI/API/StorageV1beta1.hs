...
-- 
createVolumeAttributesClass
  :: (Consumes CreateVolumeAttributesClass contentType, MimeRender contentType V1beta1VolumeAttributesClass)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1VolumeAttributesClass -- ^ "body"
  -> KubernetesRequest CreateVolumeAttributesClass contentType V1beta1VolumeAttributesClass accept
createVolumeAttributesClass _  _ body =
  _mkRequest "POST" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateVolumeAttributesClass 
instance HasBodyParam CreateVolumeAttributesClass V1beta1VolumeAttributesClass 
...
deleteCollectionVolumeAttributesClass _  _ =
  _mkRequest "DELETE" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteVolumeAttributesClass
  ...
  -> KubernetesRequest DeleteVolumeAttributesClass contentType V1beta1VolumeAttributesClass accept
deleteVolumeAttributesClass _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listVolumeAttributesClass
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListVolumeAttributesClass MimeNoContent V1beta1VolumeAttributesClassList accept
listVolumeAttributesClass  _ =
  _mkRequest "GET" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchVolumeAttributesClass
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the VolumeAttributesClass
  -> KubernetesRequest PatchVolumeAttributesClass contentType V1beta1VolumeAttributesClass accept
patchVolumeAttributesClass _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readVolumeAttributesClass
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the VolumeAttributesClass
  -> KubernetesRequest ReadVolumeAttributesClass MimeNoContent V1beta1VolumeAttributesClass accept
readVolumeAttributesClass  _ (Name name) =
  _mkRequest "GET" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- 
replaceVolumeAttributesClass
  :: (Consumes ReplaceVolumeAttributesClass contentType, MimeRender contentType V1beta1VolumeAttributesClass)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1VolumeAttributesClass -- ^ "body"
  -> Name -- ^ "name" -  name of the VolumeAttributesClass
  -> KubernetesRequest ReplaceVolumeAttributesClass contentType V1beta1VolumeAttributesClass accept
replaceVolumeAttributesClass _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/storage.k8s.io/v1beta1/volumeattributesclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceVolumeAttributesClass 
instance HasBodyParam ReplaceVolumeAttributesClass V1beta1VolumeAttributesClass 
