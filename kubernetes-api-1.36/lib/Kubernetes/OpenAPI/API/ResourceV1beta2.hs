...
{-|
Module : Kubernetes.OpenAPI.API.ResourceV1beta2
-}
...
module Kubernetes.OpenAPI.API.ResourceV1beta2 where
...
-- 
createDeviceClass
  :: (Consumes CreateDeviceClass contentType, MimeRender contentType V1beta2DeviceClass)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2DeviceClass -- ^ "body"
  -> KubernetesRequest CreateDeviceClass contentType V1beta2DeviceClass accept
createDeviceClass _  _ body =
  _mkRequest "POST" ["/apis/resource.k8s.io/v1beta2/deviceclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateDeviceClass 
instance HasBodyParam CreateDeviceClass V1beta2DeviceClass 
...
-- 
createDeviceTaintRule
  :: (Consumes CreateDeviceTaintRule contentType, MimeRender contentType V1beta2DeviceTaintRule)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2DeviceTaintRule -- ^ "body"
  -> KubernetesRequest CreateDeviceTaintRule contentType V1beta2DeviceTaintRule accept
createDeviceTaintRule _  _ body =
  _mkRequest "POST" ["/apis/resource.k8s.io/v1beta2/devicetaintrules"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateDeviceTaintRule 
instance HasBodyParam CreateDeviceTaintRule V1beta2DeviceTaintRule 
...
-- 
createNamespacedResourceClaim
  :: (Consumes CreateNamespacedResourceClaim contentType, MimeRender contentType V1beta2ResourceClaim)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceClaim -- ^ "body"
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest CreateNamespacedResourceClaim contentType V1beta2ResourceClaim accept
createNamespacedResourceClaim _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateNamespacedResourceClaim 
instance HasBodyParam CreateNamespacedResourceClaim V1beta2ResourceClaim 
...
-- 
createNamespacedResourceClaimTemplate
  :: (Consumes CreateNamespacedResourceClaimTemplate contentType, MimeRender contentType V1beta2ResourceClaimTemplate)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceClaimTemplate -- ^ "body"
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest CreateNamespacedResourceClaimTemplate contentType V1beta2ResourceClaimTemplate accept
createNamespacedResourceClaimTemplate _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateNamespacedResourceClaimTemplate 
instance HasBodyParam CreateNamespacedResourceClaimTemplate V1beta2ResourceClaimTemplate 
...
-- 
createResourceSlice
  :: (Consumes CreateResourceSlice contentType, MimeRender contentType V1beta2ResourceSlice)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceSlice -- ^ "body"
  -> KubernetesRequest CreateResourceSlice contentType V1beta2ResourceSlice accept
createResourceSlice _  _ body =
  _mkRequest "POST" ["/apis/resource.k8s.io/v1beta2/resourceslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateResourceSlice 
instance HasBodyParam CreateResourceSlice V1beta2ResourceSlice 
...
deleteCollectionDeviceClass _  _ =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/deviceclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
instance HasOptionalParam DeleteCollectionDeviceClass ShardSelector where
...
deleteCollectionDeviceTaintRule _  _ =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/devicetaintrules"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteCollectionNamespacedResourceClaim _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam DeleteCollectionNamespacedResourceClaim ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
deleteCollectionNamespacedResourceClaimTemplate _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam DeleteCollectionNamespacedResourceClaimTemplate ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
deleteCollectionResourceSlice _  _ =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/resourceslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam DeleteCollectionResourceSlice ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
deleteDeviceClass
  ...
  -> KubernetesRequest DeleteDeviceClass contentType V1beta2DeviceClass accept
deleteDeviceClass _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/deviceclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteDeviceTaintRule
  ...
  -> KubernetesRequest DeleteDeviceTaintRule contentType V1beta2DeviceTaintRule accept
deleteDeviceTaintRule _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteNamespacedResourceClaim
  ...
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest DeleteNamespacedResourceClaim contentType V1beta2ResourceClaim accept
deleteNamespacedResourceClaim _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteNamespacedResourceClaimTemplate
  ...
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest DeleteNamespacedResourceClaimTemplate contentType V1beta2ResourceClaimTemplate accept
deleteNamespacedResourceClaimTemplate _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteResourceSlice
  ...
  -> KubernetesRequest DeleteResourceSlice contentType V1beta2ResourceSlice accept
deleteResourceSlice _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/resource.k8s.io/v1beta2/resourceslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
getAPIResources  _ =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listDeviceClass
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListDeviceClass MimeNoContent V1beta2DeviceClassList accept
listDeviceClass  _ =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/deviceclasses"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListDeviceClass ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
listDeviceTaintRule
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListDeviceTaintRule MimeNoContent V1beta2DeviceTaintRuleList accept
listDeviceTaintRule  _ =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/devicetaintrules"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listNamespacedResourceClaim
  :: Accept accept -- ^ request accept ('MimeType')
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ListNamespacedResourceClaim MimeNoContent V1beta2ResourceClaimList accept
listNamespacedResourceClaim  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListNamespacedResourceClaim ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
listNamespacedResourceClaimTemplate
  :: Accept accept -- ^ request accept ('MimeType')
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ListNamespacedResourceClaimTemplate MimeNoContent V1beta2ResourceClaimTemplateList accept
listNamespacedResourceClaimTemplate  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListNamespacedResourceClaimTemplate ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
listResourceClaimForAllNamespaces
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListResourceClaimForAllNamespaces MimeNoContent V1beta2ResourceClaimList accept
listResourceClaimForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/resourceclaims"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListResourceClaimForAllNamespaces ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
listResourceClaimTemplateForAllNamespaces
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListResourceClaimTemplateForAllNamespaces MimeNoContent V1beta2ResourceClaimTemplateList accept
listResourceClaimTemplateForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/resourceclaimtemplates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListResourceClaimTemplateForAllNamespaces ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
listResourceSlice
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListResourceSlice MimeNoContent V1beta2ResourceSliceList accept
listResourceSlice  _ =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/resourceslices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListResourceSlice ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
patchDeviceClass
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the DeviceClass
  -> KubernetesRequest PatchDeviceClass contentType V1beta2DeviceClass accept
patchDeviceClass _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/deviceclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchDeviceTaintRule
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the DeviceTaintRule
  -> KubernetesRequest PatchDeviceTaintRule contentType V1beta2DeviceTaintRule accept
patchDeviceTaintRule _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchDeviceTaintRuleStatus
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the DeviceTaintRule
  -> KubernetesRequest PatchDeviceTaintRuleStatus contentType V1beta2DeviceTaintRule accept
patchDeviceTaintRuleStatus _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchNamespacedResourceClaim
  ...
  -> Name -- ^ "name" -  name of the ResourceClaim
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedResourceClaim contentType V1beta2ResourceClaim accept
patchNamespacedResourceClaim _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchNamespacedResourceClaimStatus
  ...
  -> Name -- ^ "name" -  name of the ResourceClaim
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedResourceClaimStatus contentType V1beta2ResourceClaim accept
patchNamespacedResourceClaimStatus _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchNamespacedResourceClaimTemplate
  ...
  -> Name -- ^ "name" -  name of the ResourceClaimTemplate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest PatchNamespacedResourceClaimTemplate contentType V1beta2ResourceClaimTemplate accept
patchNamespacedResourceClaimTemplate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchResourceSlice
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the ResourceSlice
  -> KubernetesRequest PatchResourceSlice contentType V1beta2ResourceSlice accept
patchResourceSlice _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/resource.k8s.io/v1beta2/resourceslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readDeviceClass
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the DeviceClass
  -> KubernetesRequest ReadDeviceClass MimeNoContent V1beta2DeviceClass accept
readDeviceClass  _ (Name name) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/deviceclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readDeviceTaintRule
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the DeviceTaintRule
  -> KubernetesRequest ReadDeviceTaintRule MimeNoContent V1beta2DeviceTaintRule accept
readDeviceTaintRule  _ (Name name) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readDeviceTaintRuleStatus
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the DeviceTaintRule
  -> KubernetesRequest ReadDeviceTaintRuleStatus MimeNoContent V1beta2DeviceTaintRule accept
readDeviceTaintRuleStatus  _ (Name name) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readNamespacedResourceClaim
  ...
  -> Name -- ^ "name" -  name of the ResourceClaim
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedResourceClaim MimeNoContent V1beta2ResourceClaim accept
readNamespacedResourceClaim  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readNamespacedResourceClaimStatus
  ...
  -> Name -- ^ "name" -  name of the ResourceClaim
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedResourceClaimStatus MimeNoContent V1beta2ResourceClaim accept
readNamespacedResourceClaimStatus  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readNamespacedResourceClaimTemplate
  ...
  -> Name -- ^ "name" -  name of the ResourceClaimTemplate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReadNamespacedResourceClaimTemplate MimeNoContent V1beta2ResourceClaimTemplate accept
readNamespacedResourceClaimTemplate  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readResourceSlice
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the ResourceSlice
  -> KubernetesRequest ReadResourceSlice MimeNoContent V1beta2ResourceSlice accept
readResourceSlice  _ (Name name) =
  _mkRequest "GET" ["/apis/resource.k8s.io/v1beta2/resourceslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- 
replaceDeviceClass
  :: (Consumes ReplaceDeviceClass contentType, MimeRender contentType V1beta2DeviceClass)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2DeviceClass -- ^ "body"
  -> Name -- ^ "name" -  name of the DeviceClass
  -> KubernetesRequest ReplaceDeviceClass contentType V1beta2DeviceClass accept
replaceDeviceClass _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/deviceclasses/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceDeviceClass 
instance HasBodyParam ReplaceDeviceClass V1beta2DeviceClass 
...
-- 
replaceDeviceTaintRule
  :: (Consumes ReplaceDeviceTaintRule contentType, MimeRender contentType V1beta2DeviceTaintRule)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2DeviceTaintRule -- ^ "body"
  -> Name -- ^ "name" -  name of the DeviceTaintRule
  -> KubernetesRequest ReplaceDeviceTaintRule contentType V1beta2DeviceTaintRule accept
replaceDeviceTaintRule _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceDeviceTaintRule 
instance HasBodyParam ReplaceDeviceTaintRule V1beta2DeviceTaintRule 
...
-- 
replaceDeviceTaintRuleStatus
  :: (Consumes ReplaceDeviceTaintRuleStatus contentType, MimeRender contentType V1beta2DeviceTaintRule)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2DeviceTaintRule -- ^ "body"
  -> Name -- ^ "name" -  name of the DeviceTaintRule
  -> KubernetesRequest ReplaceDeviceTaintRuleStatus contentType V1beta2DeviceTaintRule accept
replaceDeviceTaintRuleStatus _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/devicetaintrules/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceDeviceTaintRuleStatus 
instance HasBodyParam ReplaceDeviceTaintRuleStatus V1beta2DeviceTaintRule 
...
-- 
replaceNamespacedResourceClaim
  :: (Consumes ReplaceNamespacedResourceClaim contentType, MimeRender contentType V1beta2ResourceClaim)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceClaim -- ^ "body"
  -> Name -- ^ "name" -  name of the ResourceClaim
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedResourceClaim contentType V1beta2ResourceClaim accept
replaceNamespacedResourceClaim _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedResourceClaim 
instance HasBodyParam ReplaceNamespacedResourceClaim V1beta2ResourceClaim 
...
-- 
replaceNamespacedResourceClaimStatus
  :: (Consumes ReplaceNamespacedResourceClaimStatus contentType, MimeRender contentType V1beta2ResourceClaim)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceClaim -- ^ "body"
  -> Name -- ^ "name" -  name of the ResourceClaim
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedResourceClaimStatus contentType V1beta2ResourceClaim accept
replaceNamespacedResourceClaimStatus _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaims/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedResourceClaimStatus 
instance HasBodyParam ReplaceNamespacedResourceClaimStatus V1beta2ResourceClaim 
...
-- 
replaceNamespacedResourceClaimTemplate
  :: (Consumes ReplaceNamespacedResourceClaimTemplate contentType, MimeRender contentType V1beta2ResourceClaimTemplate)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceClaimTemplate -- ^ "body"
  -> Name -- ^ "name" -  name of the ResourceClaimTemplate
  -> Namespace -- ^ "namespace" -  object name and auth scope, such as for teams and projects
  -> KubernetesRequest ReplaceNamespacedResourceClaimTemplate contentType V1beta2ResourceClaimTemplate accept
replaceNamespacedResourceClaimTemplate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/namespaces/",toPath namespace,"/resourceclaimtemplates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceNamespacedResourceClaimTemplate 
instance HasBodyParam ReplaceNamespacedResourceClaimTemplate V1beta2ResourceClaimTemplate 
...
-- 
replaceResourceSlice
  :: (Consumes ReplaceResourceSlice contentType, MimeRender contentType V1beta2ResourceSlice)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta2ResourceSlice -- ^ "body"
  -> Name -- ^ "name" -  name of the ResourceSlice
  -> KubernetesRequest ReplaceResourceSlice contentType V1beta2ResourceSlice accept
replaceResourceSlice _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/resource.k8s.io/v1beta2/resourceslices/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceResourceSlice 
instance HasBodyParam ReplaceResourceSlice V1beta2ResourceSlice 
