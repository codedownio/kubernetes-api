...
{-|
Module : Kubernetes.OpenAPI.API.StoragemigrationV1beta1
-}
...
module Kubernetes.OpenAPI.API.StoragemigrationV1beta1 where
...
-- 
createStorageVersionMigration
  :: (Consumes CreateStorageVersionMigration contentType, MimeRender contentType V1beta1StorageVersionMigration)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1StorageVersionMigration -- ^ "body"
  -> KubernetesRequest CreateStorageVersionMigration contentType V1beta1StorageVersionMigration accept
createStorageVersionMigration _  _ body =
  _mkRequest "POST" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data CreateStorageVersionMigration 
instance HasBodyParam CreateStorageVersionMigration V1beta1StorageVersionMigration 
...
deleteCollectionStorageVersionMigration _  _ =
  _mkRequest "DELETE" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
instance HasOptionalParam DeleteCollectionStorageVersionMigration ShardSelector where
...
deleteStorageVersionMigration _  _ (Name name) =
  _mkRequest "DELETE" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
getAPIResources  _ =
  _mkRequest "GET" ["/apis/storagemigration.k8s.io/v1beta1/"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listStorageVersionMigration
  :: Accept accept -- ^ request accept ('MimeType')
  -> KubernetesRequest ListStorageVersionMigration MimeNoContent V1beta1StorageVersionMigrationList accept
listStorageVersionMigration  _ =
  _mkRequest "GET" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- | /Optional Param/ "shardSelector" - shardSelector restricts the list of returned objects using a CEL-based shard selector expression. The format uses the shardRange() function combined with || (logical OR) to specify one or more hash ranges:    shardRange(object.metadata.uid, '0x0', '0x8000000000000000')   shardRange(object.metadata.uid, '0x0', '0x8000000000000000') || shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')  Field paths use CEL-style object-rooted syntax (e.g. \"object.metadata.uid\"), NOT the fieldSelector format (\"metadata.uid\"). Currently supported paths:   - object.metadata.uid   - object.metadata.namespace  hexStart and hexEnd are single-quoted CEL string literals with a '0x' prefix, defining the inclusive lower and exclusive upper bounds over the 64-bit FNV-1a hash space. The full range is [0x0, 0x10000000000000000), where the exclusive upper bound equals 2^64.  Examples:   2-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x8000000000000000')     shard 1: shardRange(object.metadata.uid, '0x8000000000000000', '0x10000000000000000')   4-shard split:     shard 0: shardRange(object.metadata.uid, '0x0000000000000000', '0x4000000000000000')     shard 1: shardRange(object.metadata.uid, '0x4000000000000000', '0x8000000000000000')     shard 2: shardRange(object.metadata.uid, '0x8000000000000000', '0xc000000000000000')     shard 3: shardRange(object.metadata.uid, '0xc000000000000000', '0x10000000000000000')  This is an alpha field and requires enabling the ShardedListAndWatch feature gate.
instance HasOptionalParam ListStorageVersionMigration ShardSelector where
  applyOptionalParam req (ShardSelector xs) =
    req `addQuery` toQuery ("shardSelector", Just xs)
...
patchStorageVersionMigration
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the StorageVersionMigration
  -> KubernetesRequest PatchStorageVersionMigration contentType V1beta1StorageVersionMigration accept
patchStorageVersionMigration _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
patchStorageVersionMigrationStatus
  ...
  -> Body -- ^ "body"
  -> Name -- ^ "name" -  name of the StorageVersionMigration
  -> KubernetesRequest PatchStorageVersionMigrationStatus contentType V1beta1StorageVersionMigration accept
patchStorageVersionMigrationStatus _  _ body (Name name) =
  _mkRequest "PATCH" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readStorageVersionMigration
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the StorageVersionMigration
  -> KubernetesRequest ReadStorageVersionMigration MimeNoContent V1beta1StorageVersionMigration accept
readStorageVersionMigration  _ (Name name) =
  _mkRequest "GET" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
readStorageVersionMigrationStatus
  :: Accept accept -- ^ request accept ('MimeType')
  -> Name -- ^ "name" -  name of the StorageVersionMigration
  -> KubernetesRequest ReadStorageVersionMigrationStatus MimeNoContent V1beta1StorageVersionMigration accept
readStorageVersionMigrationStatus  _ (Name name) =
  _mkRequest "GET" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
-- 
replaceStorageVersionMigration
  :: (Consumes ReplaceStorageVersionMigration contentType, MimeRender contentType V1beta1StorageVersionMigration)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1StorageVersionMigration -- ^ "body"
  -> Name -- ^ "name" -  name of the StorageVersionMigration
  -> KubernetesRequest ReplaceStorageVersionMigration contentType V1beta1StorageVersionMigration accept
replaceStorageVersionMigration _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceStorageVersionMigration 
instance HasBodyParam ReplaceStorageVersionMigration V1beta1StorageVersionMigration 
...
-- 
replaceStorageVersionMigrationStatus
  :: (Consumes ReplaceStorageVersionMigrationStatus contentType, MimeRender contentType V1beta1StorageVersionMigration)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Accept accept -- ^ request accept ('MimeType')
  -> V1beta1StorageVersionMigration -- ^ "body"
  -> Name -- ^ "name" -  name of the StorageVersionMigration
  -> KubernetesRequest ReplaceStorageVersionMigrationStatus contentType V1beta1StorageVersionMigration accept
replaceStorageVersionMigrationStatus _  _ body (Name name) =
  _mkRequest "PUT" ["/apis/storagemigration.k8s.io/v1beta1/storageversionmigrations/",toPath name,"/status"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body

data ReplaceStorageVersionMigrationStatus 
instance HasBodyParam ReplaceStorageVersionMigrationStatus V1beta1StorageVersionMigration 
