...
createNamespacedLeaseCandidate _  _ body (Namespace namespace) =
  _mkRequest "POST" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates"]
...
deleteCollectionNamespacedLeaseCandidate _  _ (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
deleteNamespacedLeaseCandidate _  _ (Name name) (Namespace namespace) =
  _mkRequest "DELETE" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
getAPIResources  _ =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha2/"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listLeaseCandidateForAllNamespaces  _ =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha2/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
listNamespacedLeaseCandidate  _ (Namespace namespace) =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
patchNamespacedLeaseCandidate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PATCH" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
...
readNamespacedLeaseCandidate  _ (Name name) (Namespace namespace) =
  _mkRequest "GET" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
...
replaceNamespacedLeaseCandidate _  _ body (Name name) (Namespace namespace) =
  _mkRequest "PUT" ["/apis/coordination.k8s.io/v1alpha2/namespaces/",toPath namespace,"/leasecandidates/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyBearerToken)
    `setBodyParam` body
