...
main =
  hspec $ modifyMaxSize (const 10) $ do
    describe "JSON instances" $ do
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1WorkloadReference)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1GangSchedulingPolicy)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PodGroup)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1PodGroupPolicy)
      ...
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1TypedLocalObjectReference)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1Variable)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1Workload)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1WorkloadList)
      propMimeEq MimeJSON (Proxy :: Proxy V1alpha1WorkloadSpec)
