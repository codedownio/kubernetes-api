...
genV1IPAddress n =
  V1IPAddress
    ...
    <*> arbitraryReducedMaybe n -- v1IPAddressSpec :: Maybe V1IPAddressSpec
...
genV1PodSpec n =
  V1PodSpec
    ...
    <*> arbitraryReducedMaybe n -- v1PodSpecWorkloadRef :: Maybe V1WorkloadReference
...
instance Arbitrary V1WorkloadReference where
  arbitrary = sized genV1WorkloadReference

genV1WorkloadReference :: Int -> Gen V1WorkloadReference
genV1WorkloadReference n =
  V1WorkloadReference
    <$> arbitrary -- v1WorkloadReferenceName :: Text
    <*> arbitrary -- v1WorkloadReferencePodGroup :: Text
    <*> arbitraryReducedMaybe n -- v1WorkloadReferencePodGroupReplicaKey :: Maybe Text
...
instance Arbitrary V1alpha1GangSchedulingPolicy where
  arbitrary = sized genV1alpha1GangSchedulingPolicy

genV1alpha1GangSchedulingPolicy :: Int -> Gen V1alpha1GangSchedulingPolicy
genV1alpha1GangSchedulingPolicy n =
  V1alpha1GangSchedulingPolicy
    <$> arbitrary -- v1alpha1GangSchedulingPolicyMinCount :: Int
...
instance Arbitrary V1alpha1PodGroup where
  arbitrary = sized genV1alpha1PodGroup

genV1alpha1PodGroup :: Int -> Gen V1alpha1PodGroup
genV1alpha1PodGroup n =
  V1alpha1PodGroup
    <$> arbitrary -- v1alpha1PodGroupName :: Text
    <*> arbitraryReduced n -- v1alpha1PodGroupPolicy :: V1alpha1PodGroupPolicy
  
instance Arbitrary V1alpha1PodGroupPolicy where
  arbitrary = sized genV1alpha1PodGroupPolicy

genV1alpha1PodGroupPolicy :: Int -> Gen V1alpha1PodGroupPolicy
genV1alpha1PodGroupPolicy n =
  V1alpha1PodGroupPolicy
    <$> arbitraryReducedMaybeValue n -- v1alpha1PodGroupPolicyBasic :: Maybe A.Value
    <*> arbitraryReducedMaybe n -- v1alpha1PodGroupPolicyGang :: Maybe V1alpha1GangSchedulingPolicy
...
instance Arbitrary V1alpha1TypedLocalObjectReference where
  arbitrary = sized genV1alpha1TypedLocalObjectReference

genV1alpha1TypedLocalObjectReference :: Int -> Gen V1alpha1TypedLocalObjectReference
genV1alpha1TypedLocalObjectReference n =
  V1alpha1TypedLocalObjectReference
    <$> arbitraryReducedMaybe n -- v1alpha1TypedLocalObjectReferenceApiGroup :: Maybe Text
    <*> arbitrary -- v1alpha1TypedLocalObjectReferenceKind :: Text
    <*> arbitrary -- v1alpha1TypedLocalObjectReferenceName :: Text
...
instance Arbitrary V1alpha1Workload where
  arbitrary = sized genV1alpha1Workload

genV1alpha1Workload :: Int -> Gen V1alpha1Workload
genV1alpha1Workload n =
  V1alpha1Workload
    <$> arbitraryReducedMaybe n -- v1alpha1WorkloadApiVersion :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1WorkloadKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1WorkloadMetadata :: Maybe V1ObjectMeta
    <*> arbitraryReduced n -- v1alpha1WorkloadSpec :: V1alpha1WorkloadSpec
  
instance Arbitrary V1alpha1WorkloadList where
  arbitrary = sized genV1alpha1WorkloadList

genV1alpha1WorkloadList :: Int -> Gen V1alpha1WorkloadList
genV1alpha1WorkloadList n =
  V1alpha1WorkloadList
    <$> arbitraryReducedMaybe n -- v1alpha1WorkloadListApiVersion :: Maybe Text
    <*> arbitraryReduced n -- v1alpha1WorkloadListItems :: [V1alpha1Workload]
    <*> arbitraryReducedMaybe n -- v1alpha1WorkloadListKind :: Maybe Text
    <*> arbitraryReducedMaybe n -- v1alpha1WorkloadListMetadata :: Maybe V1ListMeta
  
instance Arbitrary V1alpha1WorkloadSpec where
  arbitrary = sized genV1alpha1WorkloadSpec

genV1alpha1WorkloadSpec :: Int -> Gen V1alpha1WorkloadSpec
genV1alpha1WorkloadSpec n =
  V1alpha1WorkloadSpec
    <$> arbitraryReducedMaybe n -- v1alpha1WorkloadSpecControllerRef :: Maybe V1alpha1TypedLocalObjectReference
    <*> arbitraryReduced n -- v1alpha1WorkloadSpecPodGroups :: [V1alpha1PodGroup]
...
genV1alpha2LeaseCandidate n =
  V1alpha2LeaseCandidate
    ...
    <*> arbitraryReducedMaybe n -- v1alpha2LeaseCandidateSpec :: Maybe V1alpha2LeaseCandidateSpec
...
genV1beta1IPAddress n =
  V1beta1IPAddress
    ...
    <*> arbitraryReducedMaybe n -- v1beta1IPAddressSpec :: Maybe V1beta1IPAddressSpec
...
genV1beta1LeaseCandidate n =
  V1beta1LeaseCandidate
    ...
    <*> arbitraryReducedMaybe n -- v1beta1LeaseCandidateSpec :: Maybe V1beta1LeaseCandidateSpec
...
genV1beta1PodCertificateRequestSpec n =
  V1beta1PodCertificateRequestSpec
    ...
    <*> arbitraryReduced n -- v1beta1PodCertificateRequestSpecPkixPublicKey :: ByteArray
    <*> arbitrary -- v1beta1PodCertificateRequestSpecPodName :: Text
    <*> arbitrary -- v1beta1PodCertificateRequestSpecPodUid :: Text
    <*> arbitraryReduced n -- v1beta1PodCertificateRequestSpecProofOfPossession :: ByteArray
